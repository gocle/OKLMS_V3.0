...
public String generateUrl(String idpUrl, String subUrl) {
    ...
    System.out.println("formatedNow : "+formatedNow+ " / generateUrl");
...
public String generateParam(java.util.Map param) {
    ...
    System.out.println("formatedNow : "+formatedNow+ " / generateParam : "+paramBuf.toString());
...
public String generateUrlWithParam(String idpUrl, String subUrl, java.util.Map param) {
    ...
    System.out.println("formatedNow : "+formatedNow+ " / generateParam : "+url + "?" + paramStr);
...
private java.net.HttpURLConnection getConnection(java.net.URL url) throws java.lang.Exception {
    ...
    System.out.println("START getConnection formatedNow : "+formatedNow);
    ...
    System.out.println("END getConnection formatedNow : "+formatedNow+ " / conn : "+conn);
...
public String httpRequest(String url, java.util.Map paramMap) {
    ...
    System.out.println("START httpRequest formatedNow : "+formatedNow);
    ...
    try {
        ...
        conn.setConnectTimeout(3000); //상대방 서버 통신 오류로 인해 접속 지연시 강제로 timeout 처리;
        conn.setReadTimeout(3000); //상대방 서버에서 응답이 오지 않는 경우 강제로 timeout 처리;
    ...
    System.out.println("END httpRequest formatedNow : "+formatedNow+ " /  result : "+result);
...
public String addContextPath(HttpServletRequest request, String path) {
    ...
    System.out.println("formatedNow : "+formatedNow+ " / addContextPath relativePath : "+relativePath);
