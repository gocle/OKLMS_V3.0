<%@page import="kr.co.gocle.oklms.commbiz.login.web.CommBizLoginController"%>
...
String menuArea = request.getParameter("menuArea");
...
if(menuArea != null ){
	if(menuArea.equals("MOBILE")) {
		relayState = "/mm/login/goLmsMobileLogin.do";
	}
}
%>
<html>
