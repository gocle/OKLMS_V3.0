...
$(function() {
	$('#lnb dt').click(function(){
		...
		$("#lnb dt.course-title a").removeClass('current');
	});

	$('#lnb dt.course-title').click(function(){
		$("#lnb dt.course-title a").addClass('current');
	});
});
...
var showPreviewPop = function(){
	...
	var vheight = parseInt($("#learning-popup .movie-zone iframe").css("height"),10);
	$("#learning-popup .learning-area").css("top","0px");
	window.location.hash = "#open";
};
var hidePreviewPop = function(){
	var vheight = parseInt($("#learning-popup .movie-zone iframe").css("height"),10);
	$(".learning-area,.popup-bg").removeClass("open");
	$("#learning-popup .learning-area").css("top","-"+(vheight+200) +"px");
