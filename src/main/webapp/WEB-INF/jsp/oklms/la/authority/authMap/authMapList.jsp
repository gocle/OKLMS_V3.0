...
<%-- 	<input type="hidden" id="pageIndex" name="pageIndex" value="${pageIndex }" />  --%>
	...
	<ul class="search-list-1">
			<li>
				<span>권한 그룹</span>
				<select id="searchAuthGroupId" name="searchAuthGroupId" >
...
<ul class="code-box">
	<li class="code-area" style="width: 40%; float:left;">
		<form:form modelAttribute="frmAuthMapAJAX">
			<table id="myInputTable" border="0" cellpadding="0" cellspacing="0" class="view-1">
				...
				<tr><th>메뉴명</th><td><input type="text" id="frm_menuTitle"       name="menuTitle"		value="${infoMap.menuTitle}" /><a class="btn adm-btn" href="javascript://" onclick="doAction('seachUperMenuPopup');" title="상위메뉴 선택 팝업 열기">찾기</a></td></tr> 					
	...
	<li style="float:left; height: auto; padding: 10px;">
