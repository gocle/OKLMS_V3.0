		...
		<form id="frmHtml" name="frmHtml" method="post" action="">
			<table border="0" cellpadding="0" cellspacing="0" class="view-1">
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a class="btn adm-btn" href="javascript://" onclick="doAction('seachUperMenuPopup');" title="상위메뉴 선택 팝업 열기">추가하위대상메뉴 찾기</a>
							<a class="btn adm-btn" href="javascript://" onclick="doAction('setRoot');" title="최상위 메뉴">최상위 메뉴</a>
						</td>
					</tr>
					<tr>
				...
				<!-- <tr>
					...
					<tr><th>메뉴 URL 패턴 간편 처리</th>
					<td>
						<input type="text" id="menuUrlPattern" style="width: 100%; margin-bottom:5px;">
						<a class="btn adm-btn" href="javascript://" onclick="doAction('setDefaultURLPattern');" title="패턴 기본값">패턴 기본값</a>
						<a class="btn adm-btn" href="javascript://" onclick="doAction('setDefaultURLFix');" title="고정 URL값">고정 URL값</a> (대소문자 구분함)
					</td>
					</tr>											 					
					...
					<tr>
						<th>강의메뉴여부<span class="pre"></span></th>
						<td>
							<input type="radio" id="lectureMenuMarkYnY" name="lectureMenuMarkYn" value="Y"><label for="lectureMenuMarkYnY">Yes</label>
							<input type="radio" id="lectureMenuMarkYnN" name="lectureMenuMarkYn" value="N" checked><label for="lectureMenuMarkYnN">No</label>
						</td>
					</tr>
					<tr>
