...
<script type="text/javascript">
	function fn_egov_select_bbsUseInfs(){
		document.boardUseInf.action = "<c:url value='/la/cop/com/selectBBSUseInfs.do'/>";
	...
	function fn_egov_regist_bbsUseInf(){
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			...
			document.boardUseInf.action = "<c:url value='/la/cop/com/insertBBSUseInf.do'/>";
			document.boardUseInf.submit();
		}
	}
	...
	function fn_egov_inqire_bbsInf(){
		var retVal;
		var url = "<c:url value='/la/commbiz/popup/openPopupWindow.do' />?requestUrl=/la/cop/bbs/SelectBBSMasterInfsPop.do&width=850&height=520";
	...
	function fn_egov_inqire_cmmnty() {
		var retVal;
		var url = "<c:url value='/la/commbiz/popup/openPopupWindow.do' />?requestUrl=/la/cop/cmy/selectCmmntyInfsByPop.do&width=850&height=360";
	...
	function fn_egov_inqire_club() {
		var retVal;
		var url = "<c:url value='/la/commbiz/popup/openPopupWindow.do' />?requestUrl=/la/cop/clb/selectClubInfsByPop.do&width=850&height=360";
		var openParam = "dialogWidth: 850px; dialogHeight: 360px; resizable: 0, scroll: 1, center: 1";
...
<div id="border" style="width:730px">
	...
	<tr>
      ...
      <a href="<c:url value='/la/cop/com/selectBBSUseInfs.do'/>?searchCondition=1" onclick="fn_egov_select_bbsUseInfs(); return false;"><spring:message code="button.list" /></a>
      </span></td>
	</tr>
	</table>
	</div>
