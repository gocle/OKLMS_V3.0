...
function fn_egov_save_PopupManage(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/la/uss/ion/pwm/registPopup.do' />";
...
<tr>
  ...
  <td class="btnBackground" nowrap><a href="<c:url value='/la/uss/ion/pwm/listPopup.do' />"><spring:message code="button.list" /></a>
  </td>
