...
<script type="text/javascript">
	function fn_egov_regist_cmmnty(){
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.community.action = "<c:url value='/la/cop/cmy/insertCmmntyInf.do'/>";
			document.community.submit();
		}
	}

	function fn_egov_select_cmmntyInfs(){
		document.community.action = "<c:url value='/la/cop/cmy/selectCmmntyInfs.do'/>";
		document.community.submit();
	}

	function fn_egov_inqire_tmplat(){
		var retVal;
		var url = "<c:url value='/la/cop/com/openPopup.do?requestUrl=/cop/tpl/selectTemplateInfsPop.do&typeFlag=CMY&width=850&height=360'/>";
	...
	function fn_egov_inqire_user(){
		var retVal;
		var url = "<c:url value='/la/cop/com/openPopup.do?requestUrl=/cop/com/selectUserList.do&width=850&height=360'/>";
		var openParam = "dialogWidth: 850px; dialogHeight: 360px; resizable: 0, scroll: 1, center: 1";
...
<div id="border" style="width:730px">
	...
	<!-- 
		...
		<td class="btnBackground" nowrap><a href="<c:url value='/la/cop/cmy/selectCmmntyInfs.do'/>"><spring:message code="button.list" /></a></td>
