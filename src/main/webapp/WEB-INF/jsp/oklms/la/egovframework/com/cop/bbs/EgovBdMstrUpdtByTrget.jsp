...
<script type="text/javascript">
	...
	function fn_egov_update_brdMstr() {
		...
		if (confirm('<spring:message code="common.update.msg" />')) {
			document.boardMaster.action = "<c:url value='/la/cop/bbs/updateBBSMasterInfByTrget.do'/>";
			document.boardMaster.submit();
		}
	}

	function fn_egov_select_brdMstrList() {
		document.boardMaster.action = "<c:url value='/la/cop/bbs/selectBdMstrListByTrget.do'/>";
		document.boardMaster.submit();
	}

	function fn_egov_delete_brdMstr(){
		if (confirm('<spring:message code="common.delete.msg" />')) {
			document.boardMaster.action = "<c:url value='/la/cop/bbs/deleteBBSMasterInfByTrget.do'/>";
			document.boardMaster.submit();
		}
	}
