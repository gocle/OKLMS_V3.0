...
<script type="text/javascript">
	function fn_egov_select_clbInfs(){
		document.club.action = "<c:url value='/la/cop/clb/selectClubInfs.do'/>";
	...
	function fn_egov_regist_clb(){
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.club.action = "<c:url value='/la/cop/clb/insertClubInf.do'/>";
			document.club.submit();
		}
	}
	...
	function fn_egov_inqire_tmplat(){
		var retVal;
		var url = "<c:url value='/la/cop/com/openPopup.do?requestUrl=/cop/tpl/selectTemplateInfsPop.do&typeFlag=CLB&width=850&height=360'/>";
	...
	function fn_egov_inqire_cmmntyUser(){
		...
		var retVal;
		var url = "<c:url value='/la/cop/com/openPopup.do?requestUrl=/cop/com/selectCmmntyUserList.do&trgetId="+cmmntyId+"&width=850&height=360'/>";
		var openParam = "dialogWidth: 850px; dialogHeight: 360px; resizable: 0, scroll: 1, center: 1";
	...
	function fn_egov_inqire_cmmnty(){
		var retVal;
		var url = "<c:url value='/la/cop/com/openPopup.do?requestUrl=/cop/cmy/selectCmmntyInfsByPop.do&width=850&height=360'/>";
		var openParam = "dialogWidth: 850px; dialogHeight: 360px; resizable: 0, scroll: 1, center: 1";
