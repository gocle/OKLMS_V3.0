...
<script type="text/javascript">
	function fn_egov_updt_clb() {
		...
		if (confirm('<spring:message code="common.update.msg" />')) {
			document.club.action = "<c:url value='/la/cop/clb/updateCmmntyClbInf.do'/>";
	...
	function fn_egov_inqire_cmmntyUser(clbId) {
		var retVal;
		var url = "<c:url value='/la/cop/com/openPopup.do?requestUrl=/cop/com/selectClubUserList.do&trgetId="+clbId+"&width=850&height=360'/>";
		var openParam = "dialogWidth: 850px; dialogHeight: 360px; resizable: 0, scroll: 1, center: 1";
