...
<script type="text/javascript">
	...
	function fn_formSave(){
		...
		var reqUrl = CONTEXT_ROOT + targetUrl + "insertTraningProcess.do";
...
<table border="0" cellpadding="0" cellspacing="0" class="view-1" style="margin:0;">
	<tbody>
		<tr>
			...
			<td>
				<input type="text" id="traningProcessName" name="traningProcessName"  value="" style="width:90%" maxlength="100" />	
			</td>      
			<th width="132px">훈련과정번호<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
	  		<td>
	  			<input type="text" id="traningProcessNo" name="traningProcessNo"  value="" style="width:40%" maxlength="30"   />	
	  		</td> 
	  		...
	  		<td>
	  			<input type="text" id="traningProcessPeriod" name="traningProcessPeriod"  value="${traningProcessVO.traningProcessPeriod}" onkeydown="onlyNumber(this);" style="width:40%" maxlength="5"   />	
	  		</td>   
		</tr>
		<tr>
			<th>실시년도</th>
			<td>
				<input type="text" id="year" name="year"  value="" maxlength="4" onkeydown="onlyNumber(this);" style="width:40%" />
			</td>
			<th>훈련시작일</th>
			<td>
				<input type="text" id="startDate" name="startDate"  value="" style="width:40%" />
			</td>      
			<th>훈련종료일</th>
			<td>
				<input type="text" id="endDate" name="endDate"  value="" style="width:40%" />
			</td>    
		</tr>
		<tr>
			<th>훈련상태</th>
			<td>
					<select id="traningStatusCd" name="traningStatusCd"  >
						...
						<option value="2">전체중탈</option>
						<option value="3">훈련중지</option>
			...
			<td colspan="3">
				<select id="traningTypeCd" name="traningTypeCd"  >
						...
						<option value="2">변경인정</option>
						<option value="3">과정연계</option>
					</select>
			</td>      
		</tr>
		...
		<tr>
			<th>NCS 자격명</th>
			<td>
				<input type="text" id="ncsLicenceName" name="ncsLicenceName"  value="" maxlength="20" style="width:40%" />
			</td>
			<th>NCS 자격수준</th>
			<td>
				<input type="text" id="ncsLicenceLevel" name="ncsLicenceLevel"  value="" maxlength="20" style="width:40%" />
			</td>      
			<th>NCS 자격버전</th>
			<td>
				<input type="text" id="ncsLicenceVersion" name="ncsLicenceVersion"  value="" maxlength="20" style="width:40%" />
			</td>    
		</tr>
		...
		<tr>
			<th>NCS 코드</th>
			<td>
				<input type="text" id="ncsCode" name="ncsCode"  value="" maxlength="20" style="width:40%" />
			</td>
			<th>NCS 명</th>
			<td>
				<input type="text" id="ncsName" name="ncsName"  value="" maxlength="20" style="width:40%" />
			</td>  
			<th>등급</th>
			<td>
				<input type="text" id="centerGrade" name="centerGrade"  value="" maxlength="20" style="width:40%" />
			</td>      
		</tr>
		...
		<tr>
			<th>OJT 훈련시간</th>
			<td>
				<input type="text" id="ojtTimeHour" name="ojtTimeHour"  onkeydown="onlyNumber(this);" maxlength="4" style="width:40%" />
			</td>
			<th>Off-JT 훈련시간</th>
			<td colspan="3">
				<input type="text" id="offTimeHour" name="offTimeHour"  onkeydown="onlyNumber(this);" maxlength="4" style="width:40%" />
			</td>  
		</tr>
			...
			<td >
				<select id="licenceId" name="licenceId" >
					...
					<c:forEach var="result" items="${resultList}" varStatus="status">
						<option value="${result.licenceId}">${result.licenceName}_${result.licenceLevel}_${result.licenceVersion}</option>
					</c:forEach>
				</select>
			</td>   
			<th>학과</th>
			<td colspan="3">
				<select id="deptNo" name="deptNo" >
					...
					<c:forEach var="result" items="${deptCodeList}" varStatus="status">
						<option value="${result.codeId}">${result.codeName}</option>
					</c:forEach>
				</select>
			</td>   
		</tr>  
		...
		<tr>
			<th>특이사항</th>
			<td colspan="5">
				<textarea  id="centerBigo" name="centerBigo" maxlength="100"  rows="" cols=""></textarea>
			</td>      
		</tr>  
