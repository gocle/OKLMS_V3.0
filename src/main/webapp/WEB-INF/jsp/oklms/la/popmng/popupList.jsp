...
<form name="frmPopmng" id="frmPopmng" method="post">
	...
	<ul class="search-list-1">
		<li><span>게시일</span> <input type="text" id="startDate" name="startDate" value="${param.startDate}" style="width: 110px;" readonly="readonly" /><img src="/images/oklms/adm/inc/calendar_btn_02_x.gif" onclick="fn_calendarClear('startDate');"/>~ 
