...
<style type="text/css">
	...
	*::after {
	...
	html, body { margin: 0px 0px; padding: 0px 0px; background-color:#222; }
	...
	label, div.content { font-size: 15px; }
	img { border: 0px; }
	div.popup-wrapper { width: 100%; background-image:url(/images/oklms/popup-bg.jpg); background-position:0 0; background-size:cover;}
	...
	div.popup-wrapper > div.content > div.text { padding: 30px 20px;}
	div.popup-wrapper > div.content > div.text span,
	div.popup-wrapper > div.content > div.text p{line-height:22px; text-align:center;  color:#fff !important;}
	div.popup-wrapper > div.close1 { /* border-top: 2px solid #b3b3b3; */ text-align: right; padding: 7px 10px 0 10px; height: 30px; background-color:#222; }
	div.popup-wrapper > div.close1 > div.left { float: left; color:#fff;}
...
<script type="text/javascript" src="<c:url value='/js/oklms/jquery.cookie.js'/>"></script>
<script type="text/javascript" src="<c:url value='/js/oklms/popupApi.js'/>"></script>
<script type="text/javascript">
		...
		<div class="close1">
			<div class="left">
				<c:if test="${data.isCloseViewSettings == 'D'}">
		       		<input type="checkbox" id="isCloseViewSettings1" name="isCloseViewSettings" value="D" />
