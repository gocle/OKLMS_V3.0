...
<input type="hidden" name="tempCompanyNo" id="tempCompanyNo" value="${companyVO.companyNo}"/>
		...
		<tr>
			...
			<th width="132px">사업자등록번호<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
	  		<td>
	  			...
	  			<!-- href="#fn_CompanyIdDuckCheck" class="btn" onclick="javascript:fn_CompanyIdDuckCheck(); return false" onkeypress="this.onclick;">중복확인</a -->
	  			※"-"빼고 넣어 주세요.
