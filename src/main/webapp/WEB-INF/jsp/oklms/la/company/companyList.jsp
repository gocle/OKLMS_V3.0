...
<!-- 회원정보 팝업용 끝 -->
<form id="frmCompany" name="frmCompany" action="<c:url value='/la/company/listCompany.do'/>" method="post">
...
<ul class="search-list-1">
	<li>
		...
		&nbsp;
		<input type="text" name="searchCompanyName" id="searchCompanyName" value="${param.searchCompanyName}" style="width:410px;" />
	</li>
</ul><!-- E : search-list-1 -->
</form>
