...
<%
 /**
  * @Class Name : /lu/egovframework/com/cop/bbs/EgovNoticeReply.jsp.jsp
...
====================================================================*/
	...
	/* if (!validateBoard(document.board)){
		...
		if (fn_egov_validateForm() && confirm('<spring:message code="common.regist.msg" />')) {	
			document.board.action = "<c:url value='/lu/cop/bbs${prefix}/${pathBbsIdStr}/replyBoardArticle.do'/>";
		...
		<h1>학습자료실-답글쓰기</h1>
			...
			<table class="table_write">
				...
				<tr>
					...
					<td class="none">
					<input type="text" id="ntceBgndeView" name="ntceBgndeView" style="width:100px;" readonly /><input type="button" class="table_delete"  onclick="fn_calendarClear('ntceBgndeView');" /> ~
					<input type="text" id="ntceEnddeView" name="ntceEnddeView" style="width:100px;" readonly /><input type="button" class="table_delete"  onclick="fn_calendarClear('ntceEnddeView');" />
			...
			<div class="btn_right">
				...
				<a href="#@" onclick="fn_egov_regist_notice();return false;"><input type="button" class="orenge" value="답글저장" /></a>
			</div>
	</div>
<!-- E : view-1 -->
</form:form>
