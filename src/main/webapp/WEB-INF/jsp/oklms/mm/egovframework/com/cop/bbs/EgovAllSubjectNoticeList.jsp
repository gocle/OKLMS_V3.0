...
<form name="frm" action ="<c:url value='/la/cop/bbs${prefix}/${pathBbsIdStr}/selectBoardList.do'/>" method="post">
			...
			<div id="contents-area">		
				...
				<div class="bbs-total mt-020">총 <b id="b_text"><%-- <c:out value="${paginationInfo.totalRecordCount }"/> --%></b> 건의 게시물이 있습니다.
				...
				<c:set var="endDate" value="${fn:replace(result.ntceEndde, '-', '')}"/>
