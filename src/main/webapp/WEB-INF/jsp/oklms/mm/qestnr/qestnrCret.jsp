...
<!--
		...
		function fn_formSave(){
			if (fn_formValidate() && confirm("저장 하시겠습니까?")) {
				var reqUrl = "/mm/qestnr/insertQestnr.do";
...
<input type="hidden" id="subClass" name="subClass" value="${qestnrVO.subClass}" />
				...
				<div id="contents-area">
						<dl class="bbs-view mt-020">
							<dt> <span><c:if test="${currProcReadVO.onlineTypeName eq '온라인'}">[ONLINE]</c:if>${currProcReadVO.subjectName} (${currProcReadVO.subClass}분반) ㅣ ${currProcReadVO.yyyy}학년도 / ${currProcReadVO.termName}</span></dt>
			
							<dd><span>제목</span>:<input type="text" id="qustnrSj" name="qustnrSj"  maxlength="497" placeholder="(ex)설문제목 입력" value="" style="width:80%;" /></dd>		
			
							<dd><span>시작일</span>:<input type="text" id="qustnrStartDate" name="qustnrStartDate"  placeholder="(ex)2016.09.01" value="" style="width:80px" readonly="readonly" /></dd>
						
							<dd><span>종료일</span>:<input type="text" id="qustnrEndDate" name="qustnrEndDate"  placeholder="(ex)2016.09.01" value="" style="width:80px" readonly="readonly" /></dd>
						
							<dd><span>설문내용</span>:<input type="text" id="qustnrPurps" name="qustnrPurps" maxlength="995" placeholder="(ex)설문내용 입력" value="" style="width:80%;" /></dd>
			
							<dt><span>설문보기</span></dt>							
							<dd>[보기1]&nbsp;&nbsp;<input type="text" id="qestnCn1" name="qestnCn1" maxlength="2047" placeholder="(ex)설문보기1 입력" value="" style="width:85%;" /></dd>					
							<dd>[보기2]&nbsp;&nbsp;<input type="text" id="qestnCn2" name="qestnCn2" maxlength="2047" placeholder="(ex)설문보기2 입력" value="" style="width:85%;" /></dd>												
							<dd>[보기3]&nbsp;&nbsp;<input type="text" id="qestnCn3" name="qestnCn3" maxlength="2047" placeholder="(ex)설문보기3 입력" value="" style="width:85%;" /></dd>												
							<dd>[보기4]&nbsp;&nbsp;<input type="text" id="qestnCn4" name="qestnCn4" maxlength="2047" placeholder="(ex)설문보기4 입력" value="" style="width:85%;" /></dd>												
							<dd>[보기5]&nbsp;&nbsp;<input type="text" id="qestnCn5" name="qestnCn5" maxlength="2047" placeholder="(ex)설문보기5 입력" value="" style="width:85%;" /></dd>	
							<dd>
