...
<script type="text/javascript" src="${contextRootJS }/js/oklms/mobileStudy.js"></script>
<script type="text/javascript">
<!--

var stdLessonId = '${onlineTraningSchVO.lessonId}';
var weekId = '${onlineTraningSchVO.weekId}';
var weekCnt = '${onlineTraningSchVO.weekCnt}';
var contentName = '${onlineTraningSchVO.contentName}';
var weekProgressRate = '${onlineTraningSchVO.weekProgressRate}';

$(document).ready(function(){
	goWeekLesson(stdLessonId,weekId,weekCnt,contentName,weekProgressRate);
});
