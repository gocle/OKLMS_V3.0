...
<div id="">
	...
	<h4 class="mt-030 mb-010"><span>${currProcReadVO.subjectName}</span> (${currProcReadVO.subClass}반) ㅣ ${currProcReadVO.yyyy}학년도 ${currProcReadVO.termName}</h4>
	...
	<div class="group-area mb-040">
		<table class="type-write">
			...
			<tr>
				<th>변경사유</th>
				<td class="left">${traningChangeReadVO.changeReason}<input type="hidden" id="weekId" name="weekId" value="${traningChangeReadVO.weekId}" /></td>				
			</tr>
			<tr>
				<th>변경자</th>
	...
	<div class="group-area">
		...
		<table class="type-2">
			...
			<tbody>
				...
				<tr <c:if test="${result.changeYn eq 'Y'}">class="highlight"</c:if>>
