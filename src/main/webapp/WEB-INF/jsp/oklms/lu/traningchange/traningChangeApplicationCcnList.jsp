...
<script type="text/javascript">
	...
	function fn_updt( ){
		...
		if(undefined == checkedVal){
			alert("훈련시간표 변경신청 목록에서 라디오버튼을 선택하여주십시오.");
			return false
		}
...
<div id="">
	...
	<div class="group-area mt-010">
		...
		<div class="btn-area mt-010">
			...
			<a href="#fn_cret" onclick="javascript:fn_cret(); return false" class="orange" onkeypress="this.onclick();">신규 변경신청</a>
			</div>
		</div>
	</div>
	...
	<div class="search-box-1">
		...
		<input type="text" id="searchStartUpdateDate" name="searchStartUpdateDate" placeholder="(ex)2017.03.20" value="${traningSchVO.searchStartUpdateDate}" readonly="readonly" /> ~ 
		<input type="text" id="searchEndUpdateDate" name="searchEndUpdateDate" placeholder="(ex)2017.03.26" value="${traningSchVO.searchEndUpdateDate}" readonly="readonly" />
