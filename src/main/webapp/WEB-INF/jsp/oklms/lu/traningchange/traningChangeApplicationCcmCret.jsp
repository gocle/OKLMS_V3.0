...
<script type="text/javascript">
	...
	function initHtml() {
		...
		retunReason = '${resultTraningChangeReadList[0].dayOfWeek}';
...
<c:if test="${!empty currProcReadVO }">
		...
		<table class="type-write">
			...
			<tr>
				...
				<td class="left">
					...
					<c:if test="${traningChangeReadVO.changeReason != '' || traningChangeReadVO.changeReason != null}">
		...
		<table class="type-2">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="number" min="0" max="10" name="changeLeadTime-${status.count}" value="${result.leadTime}" id="changeLeadTime-${status.count}" class="arrEvalScore" onchange="javascript:com.checkNumber(document.getElementById('changeLeadTime-${status.count}'));" style="width:40px; text-align:center;" />
