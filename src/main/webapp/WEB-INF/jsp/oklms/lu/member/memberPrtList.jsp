...
/* 	function press(event) {
	...
	//초기화 기업체 리스트 조회fn_showTabbtn
	function fn_searchKeywordNo(){
		$("#searchKeyword").val('');
...
<input type="hidden" name="memberType" id="memberType" value="PRT" />
	...
	<div id="">
		...
		<dd id="tab-content-14" style="display:block;">
			...
			<table class="type-2 mt-010">
				...
				<tbody>
					<c:forEach var="result" items="${resultMemberPrtList}" varStatus="status">
					<tr>
					...
					<c:if test="${fn:length(resultMemberPrtList) == 0}">
					<tr>
