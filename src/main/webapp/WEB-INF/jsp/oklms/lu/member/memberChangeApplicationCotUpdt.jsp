...
<script type="text/javascript">
	...
	function fn_delt(){
		...
		var reqUrl = CONTEXT_ROOT + targetUrl + "deleteMemberChangeApplicationCot.do";
...
<input type="hidden" id="memType" name="memType" value="COT" />
...
<div id="">
	...
	<table class="type-write mt-030">
		...
		<tbody>
			...
			<tr>
				<th>관련연구경력</th>
				<td>기관명&nbsp;&nbsp;&nbsp;<input type="text" id="relatedOrgName" name="relatedOrgName"  maxlength="" value="${MemberReadVO.relatedOrgName}" style="width:80%;" /></td>
				<th>기간</th>
			...
			<tr>
				...
				<td>
					<input type="text" id="subjectName" name="subjectName"  value="${MemberReadVO.subjectName}" disabled="disabled">
					...
					<input type="hidden" id="oldYyyy" name="oldYyyy" value="${MemberReadVO.yyyy}" />
					<input type="hidden" id="oldTerm" name="oldTerm" value="${MemberReadVO.term}" />
					<input type="hidden" id="oldSubjectCode" name="oldSubjectCode" value="${MemberReadVO.subjectCode}" />
					<input type="hidden" id="oldSubClass" name="oldSubClass" value="${MemberReadVO.subClass}" />
					<!-- <a href="#fn_subjectSearch" onclick="javascript:fn_subjectSearch(); return false" class="btn-full-gray">검색</a> -->
				</td> --%>
				<th><span class="requare">*</span>인력구분</th>
				<td colspan="3">
					<select id="memType1" name="memType1" disabled="disabled" >
						<option value="COT" selected="selected">기업현장교사</option>
					</select>
				</td>
			</tr>
		</tbody>
