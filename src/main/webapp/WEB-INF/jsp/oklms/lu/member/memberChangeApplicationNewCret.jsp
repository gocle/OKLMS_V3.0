...
<script type="text/javascript">
	...
	function fn_formSave(){
		if (fn_formValidate() && confirm("저장 하시겠습니까?")) {
			var reqUrl = CONTEXT_ROOT + targetUrl + "insertMemberChangeApplication.do";
	...
	function fn_memberIdDuckCheck(){
		...
		var reqUrl = CONTEXT_ROOT + "/lu/popup/goPopupSearchMemberIdCheck.do";
...
<div id="">
	...
	<table class="type-write mt-030">
		...
		<tbody>
			<tr>
				...
				<td>
					<input type="text" id="memId" name="memId" maxlength="" value="" placeholder="ex)4자이이상 입력" style="width:70%;" />
					<a href="#fn_memberIdDuckCheck" onclick="javascript:fn_memberIdDuckCheck( ); return false" class="btn btn-black btn-mmd2">중복확인</a>
					<br />※"비밀번호 : 1111" 자동생성
				</td>
			...
			<tr>
				...
				<td>
					<input type="text" id="memName" name="memName" maxlength="" value="" placeholder="ex)성명 입력" style="width:70%;" />
				</td>
			...
			<tr>
				...
				<td>
					...
					&nbsp;
	      			<select name="day" id="day" style="width:90px;">
						<option selected value='99'>::선택::</option>
				...
				<td>
					<input type="text" id="memRegiNo1" name="memRegiNo1" maxlength="6" value="" placeholder="ex)앞자리 6자리 입력" style="width:150px;" onkeyup="javascript:com.checkNumber(document.getElementById('memRegiNo1'));" />
					-
					<input type="password" id="memRegiNo2" name="memRegiNo2" maxlength="7" value="" placeholder="ex)뒷자리 7자리 입력" style="width:150px;" onkeyup="javascript:com.checkNumber(document.getElementById('memRegiNo2'));" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<th>관련연구경력</th>
				<td>기관명&nbsp;&nbsp;&nbsp;<input type="text" id="relatedOrgName" name="relatedOrgName"  placeholder="ex)기관명 입력" maxlength="" value="" style="width:80%;" /></td>
				<th>기간</th>
				<td><input type="number" id="relatedResearchYear" name="relatedResearchYear" min="0" max="100" style="width:130px;" />&nbsp;&nbsp;년</td>
			</tr>
			<tr>
				...
				<td>
					...
					<input type="number" id="sameSiteWorkYear" name="sameSiteWorkYear" min="0" max="100" value="" /> 년)
				</td>
	...
	<table class="type-write mt-005" style="border-top:1px solid #CCC;">
		...
		<tr>
			...
			<td>
				<input type="text" id="participateStartDate" name="participateStartDate" placeholder="ex)2017.03.01" style="width:120px" readonly="readonly" /> ~
				<input type="text" id="participateEndDate" name="participateEndDate"  placeholder="ex)2017.03.31" style="width:120px" readonly="readonly" />
			</td>
		</tr>
	</table>
	...
	<div class="btn-area mt-010">
		...
		<a href="#fn_list" onclick="javascript:fn_list(); return false" class="gray-1">목록</a>
		</div>
		<div class="float-right">
