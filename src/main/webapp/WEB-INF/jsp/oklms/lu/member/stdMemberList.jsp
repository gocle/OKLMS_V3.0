...
<form id="frmMember" name="frmMember" action="<c:url value='/lu/member/listStdMember.do'/>" method="post">
				...
				<div class="table-responsive mt-010">
					<table class="type-2">
						...
						<thead>
							<tr>
								<th rowspan="2"><input type="checkbox" id="check0" name="check0" onclick="javascript:com.checkAll('check0','memSeqs');" class="choice" /></th>
								<th rowspan="2">기업명</th>
								<th rowspan="2">학번</th>
								<th rowspan="2">분반</th>
								<th rowspan="2">사진</th>
								<th rowspan="2">성명<br />직급</th>
								<th rowspan="2">핸드폰</th>
								<th rowspan="2">이메일</th>
								
								<th colspan="4">OJT지도교수 의견</th>
								<th rowspan="2">센터전담자 의견</th>
								<!-- <th>비고</th> -->
							</tr>
							<tr>
							 	<th>현장<br />훈련</th>
