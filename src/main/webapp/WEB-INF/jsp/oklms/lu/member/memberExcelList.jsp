...
<%--
  ...
  ~  * ------   ----------      ------------------------------------
  ~  * 이진근C    2016. 11. 08 오후 1:20         Modify Draft.
  ~  *
  ~  *******************************************************************************
 --%>
  ...
  <tr>
    <td>
      <table width="100%" border="1" cellspacing="1" cellpadding="1" class="tableBorder">
        <tr align="center"><td colspan="10"><h3>회원목록</h3></td></tr>
        <tr align="center">
          ...
          <td width="10%" class="tableTitle"><h4>접속</h4></td>
        </tr>
      </table>
      <table width="100%" border="1" cellspacing="1" cellpadding="1" class="tableBorder">
       <c:forEach var="result" items="${resultList}" varStatus="status">
        <tr align="center" class="tableWhite2">
          ...
          <td width="10%">${result.loginCnt}</td>
        </tr>
        </c:forEach>
