...
<script type="text/javascript">
	...
	function fn_formValidate() {
		...
		else	if($("#memPassword1").val() != $("#memPassword1").val().replace("\`",""))
		{
		...
		if( !regExpIsPassword.test( $("#memPassword1").val()) ){
	...
	function fn_formSave(){
		if (fn_formValidate()) {
			...
			if(confirm("저장 하시겠습니까?")){
				var reqUrl =  "/lu/member/insertCompMember.do";
...
<input type="hidden" name="memberType" id="memberType" value="${memberVO.memberType}" />
<input type="hidden" id="companyId" name="companyId" value="${memberVO.companyId}" />
<input type="hidden" name="memId" id="memCheck"  />
	...
	<table class="type-write">
		<tbody>
			...
			<tr>
				...
				<td>
					<input type="text" id="loginId" name="loginId"  maxlength="20" value="" style="width:30%;" />
					<a href="#fn_CompanyIdDuckCheck" class="btn btn-black btn-mmd" onclick="memIdCheck();" onkeypress="this.onclick;">중복확인</a>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="memName" name="memName"  maxlength="10" value="" style="width:30%;" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<label for="sexdstnCd1"><input type="radio" name="sex" id="sexdstnCd1" value="M" >남</label>
					<label for="sexdstnCd2"><input type="radio" name="sex" id="sexdstnCd2" value="F" > 여</label>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="email" name="email"  maxlength="20" value="" style="width:30%;" />
					8자리 입력(예:19821024)
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="memBirth" name="memBirth" onkeydown="onlyNumber(this);" maxlength="8" value="" style="width:30%;" />
					8자리 입력(예:19821024)
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="hpNo" name="hpNo"  onkeydown="onlyNumber(this);" maxlength="11" value="" style="width:30%;" />
					※"-"빼고 넣어 주세요.
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="compTelNo" name="compTelNo"  onkeydown="onlyNumber(this);" maxlength="11"  value="" style="width:30%;" />
					※"-"빼고 넣어 주세요.
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="compJoinDay" name="compJoinDay"  maxlength="8" onkeydown="onlyNumber(this);" value="" style="width:30%;" />
					8자리 입력(예:19821024)
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="dutyNm" id="dutyNm"  maxlength="8"  value="" style="width:30%;" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="compCareerYear" id="compCareerYear"  maxlength="2"  value="" onkeydown="onlyNumber(this);" style="width:30%;" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="compLicenceNm" id="compLicenceNm"  maxlength="10"  value="" style="width:30%;" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="file" class="form_field jt_form_full_field" name="file-input" id="licenceFile"  style="width:30%;">
				</td>
			</tr>
