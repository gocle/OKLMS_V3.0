	...
	<table class="type-write mt-030">
		...
		<tbody>
			<tr>
				...
				<td>
					<input type="text" id="memId" name="memId" maxlength="" value="" placeholder="ex)변경할 담당자 검색" style="width:70%;" />
					<input type="hidden" id="memSeq" name="memSeq" />
					<a href="#fn_memberSearch" onclick="javascript:fn_memberSearch( ); return false" class="btn btn-black btn-mmd2">검색</a>
				</td>
			...
			<tr>
				<th><span class="requare">*</span>동일분야 현장경력</th>
				<td>
