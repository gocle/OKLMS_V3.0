...
<div id="">
	...
	<table class="type-write mt-040">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<input type="text" id="ntceBgndeView" name="ntceBgndeView" placeholder="2017.04.01" style="width:120px;" readonly /> ~
					<input type="text" id="ntceEnddeView" name="ntceEnddeView" placeholder="2017.04.30" style="width:120px;" readonly />
	...
	<div class="btn-area mt-010">
		<div class="float-right">
			<a href="#fn_egov_select_noticeList" onclick="javascript:fn_egov_select_noticeList(); return false" class="black ">목록</a>
			<a href="#fn_egov_regist_notice" onclick="javascript:fn_egov_regist_notice(); return false" class="black">등록</a>
		</div>
	</div><!-- E : btn-area -->
