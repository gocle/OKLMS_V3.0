...
<%-- 				<tr>
		...
		<div class="btn-area align-right mt-010">
			<a href="#!" onclick="fn_egov_select_noticeList('1');return false;" class="black">목록</a>
			...
			<c:if test="${memType == 'PRT'||memType == 'CDP'|| memType == 'COT' || memType == 'STD'}">
				<c:if test="${result.frstRegisterId == sessionUniqId && result.commnetCount == 0}">
					<a href="#!" onclick="fn_egov_delete_notice();return false;" class="black">삭제</a>
				</c:if>
				<%-- <c:if test="${result.frstRegisterId == sessionUniqId && result.commnetCount == 0}">
				...
				<c:if test="${result.frstRegisterId == sessionUniqId}">
					<a href="#!" onclick="fn_egov_moveUpdt_notice();return false;" class="black">수정</a>
				</c:if>
				
				<c:if test="${result.replyPosblAt == 'Y' && memType != 'STD'}">
					<a href="#!" onclick="fn_egov_addReply();return false;" class="black">답글작성</a>
				</c:if>
			</c:if>
