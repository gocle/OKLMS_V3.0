...
//alert("댓글저장");
	...
	if (confirm('<spring:message code="common.regist.msg" />')) {
		document.frm.action = "<c:url value='/lu/cop/bbs/${pathBbsIdStr}/insertBoardComment.do'/>";
		document.frm.submit();
	}
}
...
function fn_egov_updt_commentList() {
	...
	if (confirm('<spring:message code="common.update.msg" />')) {
		...
		document.frm.action = "<c:url value='/lu/cop/bbs/${pathBbsIdStr}/updateBoardComment.do'/>";
		document.frm.submit();
	}
}
...
function fn_egov_selectCommentForupdt(commentNo, index, bbsId) {
	...
	if(param_bbsId != null){
		document.frm.action = "<c:url value='/lu/cop/bbs/${pathBbsIdStr}/selectBoardArticle.do'/>";
	}else{
...
function fn_egov_deleteCommentList(commentNo, index) {
	...
	if (confirm('<spring:message code="common.delete.msg" />')) {
		document.frm.modified.value = "true";
		document.frm.commentNo.value = commentNo;
		document.frm.action = "<c:url value='/lu/cop/bbs/${pathBbsIdStr}/deleteBoardComment.do'/>";
		document.frm.submit();
	}
}
