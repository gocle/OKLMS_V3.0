...
<!-- S : view-1 -->
<div id="">
	<c:if test="${result.bbsId == 'BBSMSTR_000000000005' or result.bbsId == 'BBSMSTR_000000000000' }">
	<h2>공지사항</h2>
	</c:if>
	<c:if test="${result.bbsId == 'BBSMSTR_000000000007'}">
	<h2>Q&A</h2>
	</c:if>
	<c:if test="${result.bbsId == 'BBSMSTR_000000000006'}">
	<h2>학습자료실</h2>
	</c:if>
	<c:if test="${result.bbsId == 'BBSMSTR_000000000050'}">
	<h2>알림사항</h2>
	</c:if>
	<div class="group-area mb-025">
		<table class="type-2 wp100">
			...
			<tbody>
				...
				<c:if test="${result.bbsId ne 'BBSMSTR_000000000000'}">
					<tr>
						<th>카테고리</th>
						<td class="left">
						<c:if test="${result.bbsId == 'BBSMSTR_000000000005' or result.bbsId == 'BBSMSTR_000000000000'}">
				...
				<tr>
					...
					<c:choose>
						<c:when test="${!empty resultFile.atchFileId }">
		...
		<div class="btn-area mt-010">
			...
			<a href="#!" onclick="fn_egov_select_noticeList('1');return false;" class="gray-1 ">목록</a>
			</div>
