...
<table class="type-1 mb-020">
	...
	<div class="btn-area align-right mt-010">
		<a href="#!" onclick="javascript:fn_egov_select_noticeList(); return false" class="black">목록</a>
		<a href="#!" onclick="javascript:fn_egov_regist_notice(); return false" class="black">등록</a>
	</div><!-- E : btn-area -->
