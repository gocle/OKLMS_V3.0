							...
							<table  width="100%" border="1" cellspacing="1" cellpadding="1" class="tableBorder">
								...
								<c:forEach var="result" items="${resultList}" varStatus="status">
									<tr>
										...
										<td>${fn:split(result.tutInfos,'|')[1]}</td>
										<td>${fn:split(result.tutInfos,'|')[2]}</td>
										<td>${fn:split(result.tutInfos,'|')[3]}</td>
										<td>${fn:split(result.hrdInfos,'|')[1]}</td>
										<td>${fn:split(result.hrdInfos,'|')[2]}</td>
										<td>${fn:split(result.hrdInfos,'|')[3]}</td>
