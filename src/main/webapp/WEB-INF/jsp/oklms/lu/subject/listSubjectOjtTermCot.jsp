...
//         com.pageNavi( "pageNavi", totalCount , pageSize , pageIndex );
	...
	function fn_search( pageIndex ){
		...
		var reqUrl = CONTEXT_ROOT + targetUrl + "listSubjectCot.do";
...
<form id="frmMove" name="frmMove" action="<c:url value='/lu/subject/listSubjectCot.do'/>" method="post">
	<input type="hidden" id="searchPeriodType" name="searchPeriodType" value="WEEK" /> 
</form>				
			
<form id="frmSubject" name="frmSubject" action="<c:url value='/lu/subject/listSubjectCot.do'/>" method="post">
	...
	<input type="hidden" id="subjectTraningType" name="subjectTraningType" value="OJT" /> 
			...
			<div class="group-area mt-020">
					...
					<dl id="tab-type">
						...
						<!-- <dt class="tab-name-11 on"><a href="javascript:showTabbtn1();">학기단위로보기</a></dt>
						<dd id="tab-content-11" style="display:block;"> -->
							
				<div class="search-box-0"></div>
							...
							<!-- <dt class="tab-name-12"><a href="javascript:fn_searchTraningType();">주단위로 보기</a></dt>
