...
//      com.pageNavi( "pageNavi", totalCount , pageSize , pageIndex );
	...
	function fn_search( pageIndex ){
		...
		var reqUrl = CONTEXT_ROOT + targetUrl + "listSendSmsResultPrt.do";
...
<form id="frmSend" name="frmSend" action="<c:url value='/lu/send/listSendSmsResult.do'/>" method="post">
	...
	<input type="hidden" id="sendType" name="sendType" value="SMS" /> 	 
	<input type="hidden" id="sendSeq" name="sendSeq" value="" /> 
