...
<form id="frmSend" name="frmSend" action="<c:url value='/lu/send/listSend.do'/>" method="post">
	...
	<input type="hidden" id="searchMemType" name="searchMemType" value="STD" /> 
	...
	<div class="group-area mt-020">
					 ...
					 <dl id="tab-type">
						...
						<dt class="tab-name-11 on"><a href="/lu/send/listSendCcn.do">학습근로자</a></dt>
						<dd id="tab-content-11"></dd>
				
						<dt class="tab-name-12 "><a href="/lu/send/listSendCcn.do?searchMemType=COT">기업전담자</a></dt>
