	...
	<input type="hidden" id="pageIndex" name="pageIndex" value="${pageIndex }" /> 
			...
			<div class="search-box-1 mb-020">
					...
					<select name="subjectGrade" id="subjectGrade">
						...
						<option value="5" <c:if test="${sendVO.subjectGrade eq '5' }" > selected="selected"  </c:if>>5학년</option>
					</select>
					<input type="text" name="subjectName" id="subjectName" value="${sendVO.subjectName}" placeholder="교과명 검색" onkeypress="press(event);" />
					<input type="text" name="companyName" id="companyName" value="${sendVO.companyName}" placeholder="기업명" onkeypress="press(event);" />
					<input type="text" name="searchKeyword" id="searchKeyword" value="${sendVO.searchKeyword}" placeholder="학생명, 학번 검색" onkeypress="press(event);" />
