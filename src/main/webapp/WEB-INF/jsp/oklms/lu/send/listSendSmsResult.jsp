...
//      com.pageNavi( "pageNavi", totalCount , pageSize , pageIndex );
	...
	function fn_search( pageIndex ){
		...
		var reqUrl = CONTEXT_ROOT + targetUrl + "listSendSmsResult.do";
	...
	function fn_delete(){
		...
		var reqUrl = CONTEXT_ROOT + targetUrl + "deleteSendSmsResult.do";
		$("#frmSend").attr("action", reqUrl);
		$("#frmSend").submit();
	}
...
<form id="frmSend" name="frmSend" action="<c:url value='/lu/send/listSendSmsResult.do'/>" method="post">
	...
	<input type="hidden" id="sendType" name="sendType" value="EMAIL" /> 	 
			...
			<div class="search-box-1 mb-020">
				...
				<div class="group-area mb-040">
					...
					<thead>
						<tr>
							<td><input type="checkbox" id="checkbox" class="choice" /></td>
							<th>전송구분</th>
							<th>템플릿</th>
							<th>발송일</th>
							<th>예약일</th>
