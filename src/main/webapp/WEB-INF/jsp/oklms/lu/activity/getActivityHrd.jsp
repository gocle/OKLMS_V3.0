		...
		<input type="hidden" name="memSeq" id="memSeq"  /><input type="hidden" name="memSeqs" id="memSeqs" value="${activityVO.memSeqs}"  />
							...
							<div class="btn-area mt-010">
								<div class="float-left">
									<c:if test="${!empty memSeqPrev}">
										<a href="#!" onclick="javascript:fn_detail('${memSeqPrev}');" class="gray-1">&lt; 이전학생</a>							
									</c:if>
									<c:if test="${!empty memSeqNext}">
										<a href="#!" onclick="javascript:fn_detail('${memSeqNext}');" class="gray-1">다음학생 &gt;</a>
									</c:if>
								</div>
