		...
		<div id="">
			...
			<div class="group-area">
					...
					<tbody>
						<c:forEach var="resultOffJt" items="${resultOffJtSubjectInfoList}" varStatus="status">
							<c:choose>
								...
								<tr id="offSubjTr">
									...
									<td id="offSubjectYyyyTd">${resultOffJt.yyyy}년도</td>
									<td id="offSubjectTermTd">${resultOffJt.termName}</td>
						...
						<c:forEach var="resultOjt" items="${resultOjtSubjectInfoList}" varStatus="status">
							...
							<tr id="ojtSubjTr">
								...
								<td  id="ojtSubjectYyyyTd">${resultOjt.yyyy}년도</td>
								<td  id="ojtSubjectTerrmTd">${resultOjt.termName}</td>
				...
				<div class="btn-area align-right mt-010">
					...
					<a href="#fn_formSave" class="black" onclick="javascript:fn_formSave(); return false" onkeypress="this.onclick();">저장</a>
				</div><!-- E : btn-area -->
			</div>
	</div><!-- E : container -->
</form>
