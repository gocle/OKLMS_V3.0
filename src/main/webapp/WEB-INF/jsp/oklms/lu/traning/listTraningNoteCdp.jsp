...
function fn_search(){
	...
	var reqUrl = "/lu/traning/listTraningNoteCdp.do";
...
<fmt:parseNumber var = "offTimeHour" integerOnly = "true" value = "${offTimeHour}" />
					...
					<h4 class="mb-010"><span>${TraningNoteVO.subjectName} / ${TraningNoteVO.subjectCode } / ${TraningNoteVO.classId }반</span>ㅣ ${TraningNoteVO.yyyy}학년도 ${TraningNoteVO.termName} </h4>
						...
						<form name="frmTraning${status.index}" id="frmTraning${status.index}" method="post">
							...
							<div class="table-responsive mt-010">
								...
								//--> 
										...
										<tr>
											<th scope="row"><label for="review${status.index}">총평</label></th>
											<td colspan="6" class="left"><textarea name="review" id="review${status.index}" rows="5"  readonly="readonly">${resultSum[status.index].review}</textarea></td>
										</tr>
									</tbody>
								</table>
							</div>
...
<form name="frmTraningEnrichment${statustop.index}" id="frmTraningEnrichment${statustop.index}" method="post" >
								...
								<div class="mt-010 mb-020">
									<label for="traningStMin" class="hidden">날짜</label>
									<input type="text" name="studyDate" id="startDate" value="${TraningEnrichmentTimeVO.traningDate}"  style="width:120px;" />
								시작 :
								<label for="traningStHour" class="hidden">시</label>
								<select name="traningStHour"  id="traningStHour">
									...
									<label for="traningStMin" class="hidden">분</label>
									<select name="traningStMin" id="traningStMin">
								...
								종료 :
								<label for="traningEdHour" class="hidden">시</label>
								<select name="traningEdHour" id="traningEdHour">
									...
									<label for="traningEdMin" class="hidden">분</label>
									<select name="traningEdMin" id="traningEdMin">
										<option value="00"  <c:if test="${TraningEnrichmentTimeVO.traningStMin eq '00'}"> selected="selected" </c:if> >0 분</option>
										<option value="10" <c:if test="${TraningEnrichmentTimeVO.traningStMin eq '10'}">selected="selected" </c:if> >10 분</option>
										<option value="20" <c:if test="${TraningEnrichmentTimeVO.traningStMin eq '20'}">selected="selected" </c:if>>20 분</option>
										<option value="30" <c:if test="${TraningEnrichmentTimeVO.traningStMin eq '30'}">selected="selected" </c:if>>30 분</option>
	...
	<c:set var="memNames" value="" />
										...
										//--> 
												...
												<tr>
													<th scope="row"><label for="totalReview">보강총평</label></th>
