										...
										<tbody>
											...
											<tr>
												...
												<td>${resultlist.memId} 
													...
													<input type="hidden" name="memIdArr" id="memIdArr" value="${resultlist.memId}"></td>
...
<c:set var="memNames" value="" />
										<tbody  id="regularTr${statustop.index}">
											...
											<tr id="tr${status.index}">
												<td>${resultlist.memId} <input type="hidden" id="" name="traniningNoteDetailIdArr" value="${resultlist.traniningNoteDetailId}" /><input type="hidden" name="memIdArr" id="memIdArr" value="${resultlist.memId}"></td>
												<td>${resultlist.memName} <input type="hidden" name="memNmArr" id="memNmArr" value="${resultlist.memName}">  </td>
