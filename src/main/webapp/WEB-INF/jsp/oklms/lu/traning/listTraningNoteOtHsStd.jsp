				...
				<input type="hidden" id="companyId" name="companyId" value="${TraningNoteVO.companyId}" />
							...
							<div class="group-area-title">
								...
								<p style="padding-left: 100px">
									<label for="traningStHour" class="hidden">월 선택</label>
					...
					<div class="table-responsive mt-040" id="weekTimeList" style="display: none">
						<table class="type-2">
							<colgroup>
								<caption>주차 훈련일 시작시간 종료시간 능력단위 등 정보제공</caption>
								<col width="10%">
								<col width="15%">
								<col width="15%">
								<col width="15%">
...
<%-- 				<input type="hidden" id="${timeList.timeId}_traningStMin" name="traningStMin" value="00"/> 
				...
				<input type="hidden" id="${timeList.timeId}_weekCnt" name="weekCnt" value="${TraningNoteVO.weekCnt}"/> 
								<tr>
									...
									<td>
									<label for="${timeList.timeId}_traningDate" class="hidden">훈련일</label>
									<input type="text" name="traningDate" value="${timeList.traningDate}" id="${timeList.timeId}_traningDate" style="width: 85%;"> 
									</td>
									<td>
										<label for="${timeList.timeId}_traningStHour" class="hidden">시작시간</label>
									...
									<td>
										<label for="${timeList.timeId}_traningEdHour" class="hidden">종료시간</label>
									...
									<td>
										<label for="${timeList.timeId}_leadTime" class="hidden">훈련시간</label>
										<input type="text" name="leadTime" id="${timeList.timeId}_leadTime" value="${timeList.leadTime}"  maxlength="2">
									</td>
									<td>
				...
				<div class="table-responsive mt-010">
					<table class="type-2">
						...
						<tbody>
							<tr>
								<td>
									<label for="time_weekCnt" class="hidden">주차</label>
						...
						<form name="frmTraning${status.index}" id="frmTraning${status.index}" method="post">
							...
							<div class="table-responsive mt-010">
								...
								//--> 
											...
											<td>
												<label for="bigoArr" class="hidden">비고 (교육 중 특이사항 등)</label>
												<input type="text" style="width:100%;" name="bigoArr" id="bigoArr" value="${resultlist.bigo}"/>
											</td>
										...
										<tr>
											<th scope="row">총평</th>
											<td colspan="6" class="left"><textarea name="review" id="review${status.index}" rows="5" >${timeList.review}</textarea></td>
										</tr>
									</tbody>
								</table>		
							</div>
...
<form name="frmTraningEnrichment${statustop.index}" id="frmTraningEnrichment${statustop.index}" method="post" >
								...
								<select name="traningStHour" id="traningStHour">
									...
									<label for="traningStMin" class="hidden">시</label>
								...
								종료 :
									...
									<table class="type-2">
										<caption>학번 성명 훈련시간 성취도 보강비고 등 정보제공</caption>
										<colgroup>
											<col width="15%" />
											<col width="15%" />
											<col width="8%" />
...
<c:set var="memNames" value="" />
									...
									//--> 
												...
												<td class="left"><label for="bigoArr" class="hidden">보강비고 (교육 중 특이사항 등)</label><input type="text" style="width:95%;" name="bigoArr" id="bigoArr"  value="${resultlist.bigo}"/></td>
											...
											<tr>
												...
												<td colspan="5" class="left"><textarea name="review" id="totalReview" rows="6">${TraningEnrichmentTimeVO.review}</textarea></td>
											</tr>
										</tbody>
									</table>
 									<div class="btn-area align-center mt-010">
