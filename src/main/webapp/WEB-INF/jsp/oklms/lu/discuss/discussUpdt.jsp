...
<div id="">
	...
	<table class="type-write mt-010">
		<tbody>
			<tr>
				<th><span class="requare">*</span>주차</label></th>
				<td class="left">
					<select id="weekCnt" name="weekCnt" style="width: 100px;" >
						<c:forEach var="result" items="${onlineTraningSchVO}" varStatus="status">
							<option value="${result.weekCnt}" <c:if test="${discussReadVO.weekCnt eq result.weekCnt}"> selected </c:if>  >${result.weekCnt}</option>
						</c:forEach>
					</select>
					주차
				</td>
			...
			<tr>
				...
				<td><input type="text" id="title" name="title" maxlength="598" value="${discussReadVO.title}" placeholder="(ex)전체토론" /></td>
			</tr>
			<tr>
				<th><span class="requare">*</span>공개일</th>
				<td>
					<input type="text" id="startDate" name="startDate" value="${discussReadVO.startDate}" placeholder="2017.03.01" style="width:100px;" readonly="readonly"/> <!-- <a href="#!" class="text"><img src="../../../image/std/inc/icon_calendar.png"></a> -->
			...
			<tr>
				...
				<td>
					<input type="text" id="endDate" name="endDate" value="${discussReadVO.endDate}" placeholder="2017.06.30" style="width:100px" readonly="readonly" /> <!-- <a href="#!" class="text"><img src="../../../image/std/inc/icon_calendar.png"></a> -->
	...
	<div class="btn-area mt-010">
		<div class="float-right">
			...
			<a href="#fn_formSave" onclick="javascript:fn_formSave(); return false" class="black">저장</a>
		</div>
	</div><!-- E : btn-area -->
