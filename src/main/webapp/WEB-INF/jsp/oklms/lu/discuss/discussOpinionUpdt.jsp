...
<div id="">
	...
	<table class="type-write mb-010">
		<tbody>
			...
			<tr>
				<th>내용</th>
				<td class="text-area">${discussReadVO.content}</td>
			</tr>
		</tbody>
	</table>

	<h2 class="mt-040">토론 의견작성</h2>
	<table class="type-write mt-010">
		<tbody>
			<tr>
				<th><span class="requare">*</span>제목</th>
				<td><input type="text" id="title" name="title" maxlength="598" value="${discussOpinionReadVO.title}" placeholder="전체토론의견" /></td>
			</tr>
			<tr>
	...
	<div class="btn-area mt-010">
		<div class="float-right">
			<a href="#fn_list" onclick="javascript:fn_list(); return false" class="black">목록</a>
