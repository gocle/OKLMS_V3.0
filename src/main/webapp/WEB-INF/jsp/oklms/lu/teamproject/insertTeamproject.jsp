...
<input type="hidden" name="totStdCnt"  id="totStdCnt" value="${currProcVO.count}" />
					...
					<div class="group-area">
						<table class="type-write">
							...
							<tbody>
								...
								<tr>
									<th>프로젝트 기간</th>
									<td>
										<input type="text" name="projectStartDate" id="projectStartDate" value="" style="width:100px" />
										  ~ 
										<input type="text" name="projectEndDate" id="projectEndDate"  value="" style="width:100px" />
									</td>
									<th>과제제출 기간</th>
									<td>
										<input type="text" name="submitStartDate" id="submitStartDate" value="" style="width:100px" />
										  ~ 
										<input type="text" name="submitEndDate" id="submitEndDate"  value="" style="width:100px" />
									</td>
								</tr>
								<tr>
									<th>제출구분</th>
								...
								<tr>
									...
									<th>배점</th>
									<td><input type="number" name="score" id="score" value="0"  min="0" max="9" style=" text-align:right;"  /> 점
									</td>
								</tr>
								<tr>
									<th>내용</th>
								...
								<tr>
									...
									<td colspan="3">
										...
										<input type="text" name="teamCnt" id="teamCnt" value="" style="width:50px" /> 팀 
						...
						<div class="btn-area align-right mt-010">
							<a href="/lu/teamproject/listTeamproject.do" class="black">취소</a>
							<a href="#" onclick="javascript:fn_formSave();" class="black">등록</a>
						</div><!-- E : btn-area -->
