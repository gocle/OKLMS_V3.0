...
<script type="text/javascript">
	...
	function initHtml() {
		...
		//https://kut90.koreatech.ac.kr/oz/NCS/NC0215R.jsp?I_ESTBL_YY=${planEvalVO.yyyy}&I_ESTBL_SEMSTR_CD=${planEvalVO.tmpTerm}&I_COURSE_NO=${planEvalVO.subjectCode}&I_PARTITN_CLAS_SE_CD=${planEvalVO.subClass}
		var ls_url = "https://kut90.koreatech.ac.kr/oz/NCS/NC0215R.jsp?I_ESTBL_YY="+ls_estbl_yy+"&I_ESTBL_SEMSTR_CD="+ls_estbl_semstr_cd+"&I_COURSE_NO="+ls_course_no+"&I_PARTITN_CLAS_SE_CD="+ls_partitn_clas_se_cd;
	...
	function fn_goCompnayReport ( param1, param2, param3 , param4){
...
<div id="">
	...
	<dl id="tab-type-2">
		...
		<div class="search-box-1 mt-020">
			...
			<a href="#learner-wrap_area" rel="modal:open">분반검색</a>
		</div><!-- E : search-box-1 -->
						...
						<ul id="learner-wrap" >
							<li id="wrap">
								...
								<div id="scroller">
									...
									<c:forEach var="result" items="${listOjtClassName}" varStatus="status">
									<li <c:if test="${result.companyId eq planEvalVO.companyId and result.subjectClass eq planEvalVO.subClass}"> class="current" </c:if>>
										<a href="#!" onclick="javascript:fn_goCompnayReport('${result.subjectClass}','${result.companyId }','${status.count }','${result.companyName }'); return false">${result.subjectClass}분반_${result.companyName }</a>
									</li>
									</c:forEach>							 	
									</ul>
								</div>
