...
<div id="">
	<h2>토론</h2>
	<h4 class="mb-010"><span><c:if test="${currProcReadVO.onlineTypeName eq '온라인'}">[ONLINE]</c:if>${currProcReadVO.subjectName} / ${currProcReadVO.subjectCode }</span> ㅣ ${currProcReadVO.yyyy}학년도 / ${currProcReadVO.termName}</h4>
	...
	<table class="type-write">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" id="title" name="title" maxlength="598" placeholder="(ex)전체토론" style="width:98%;" /></td>
			</tr>
			<tr>
				<th><span class="requare">*</span>공개일</th>
				<td>
					<input type="text" id="startDate" name="startDate" placeholder="(ex)2017.03.01" style="width:10%" readonly="readonly"/> <!-- <a href="#!" class="text"><img src="../../../image/std/inc/icon_calendar.png"></a> -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<tr>
				...
				<td>
					<input type="text" id="endDate" name="endDate" placeholder="(ex)2017.06.30" style="width:10%" readonly="readonly" /> <!-- <a href="#!" class="text"><img src="../../../image/std/inc/icon_calendar.png"></a> -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<tr>  
				...
				<td><input type="text" id="evalScore" name="evalScore" placeholder="(ex)10" onchange="javascript:com.checkNumber(document.getElementById('evalScore'));" style="width:30px; text-align:right;" /> 점</td>
			</tr>
			<tr>
				<th>점수공개</th>
			...
			<tr>
				...
				<td><textarea id="content" name="content" rows="5" placeholder="(ex)토론내용"></textarea></td>
			</tr>
			<tr>
				<th>첨부파일</th>
				<td class="left">
