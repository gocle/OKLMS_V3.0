...
<%
 ...
 //System.out.println("============== planEvalVO.getTerm() : "+planEvalVO.getTerm());
...
/* String memId = CommonUtil.AESenc("2011180015");
String ls_estbl_yy = CommonUtil.AESenc("2016");
String ls_estbl_semstr_cd =  CommonUtil.AESenc("102");
String ls_course_no =  CommonUtil.AESenc("SME480");
String ls_partitn_clas_se_cd =  CommonUtil.AESenc("01"); */
...
<div id="">
	...
	<div class="align-center mb-040">
		<c:if test="${memId != ''}">
			<iframe id="myframe" src="" width="100%" height="900px"></iframe>
		</c:if>
	</div><!-- E : btn-area -->
