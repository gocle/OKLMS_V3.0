...
<script type="text/javascript">
	...
	function fn_save(){
		...
		var reqUrl =  "/lu/eval/insertInsideEval.do";
					...
					<div class="group-area mt-020">
						...
						<table class="type-write mt-020">						
							<tbody>
								...
								<tr>
									<th>학생명</th>
									<td>
										<input type="text" id="stdMemName" name="stdMemName" value="" style="width: 120px;"  readonly="readonly">
										...
										<input type="hidden" id="stdMemSeq" name="stdMemSeq" value=""/>
									</td>
								</tr>	
								<tr>  
									<th>성적</th>
									<td><input type="text" id="score"  name="score" onkeydown="onlyNumber(this);"  value="" class="" maxlength="3" placeholder="ex) 1~100점 내로 입력하세요." style="width: 240px;"></td>
								</tr>	
								<tr>
									<th>첨부파일</th>
								...
								<tr>
									<th>첨부파일</th>
									<td><input type="file" id="atchFiles3" name="atchFiles3"></td>
								</tr>				
							</tbody>
						</table>
						...
						<div class="btn-area  mt-010">
							<div class="float-right">
								<a href="#!" onclick="fn_save();" class="black">임시저장</a>
								<a href="#!" onclick="fn_approval_save();" class="yellow">등록 및 승인요청</a>
