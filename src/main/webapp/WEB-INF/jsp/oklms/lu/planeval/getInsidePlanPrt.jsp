					...
					<div class="group-area mt-020">
						...
						<table class="type-write mt-020">						
							<tbody>
								...
								<tr>  
									<th>성적</th>
									<td><input type="text" id="score" name="score" value="${result.score}" class="" maxlength="1" placeholder="ex) 1~10점 내로 입력하세요." style="width: 240px;"></td>
								</tr>	
								<tr>
									<th>첨부파일</th>
									<td>
									...
									<c:if test="${empty resultFile}">				
										<input type="text" id="atchFiles" name="atchFiles">
									</c:if>	
									</td>
								</tr>				
							</tbody>
