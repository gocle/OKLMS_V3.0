...
<script type="text/javascript">
	...
	function fn_save(){
		...
		var reqUrl =  "/lu/eval/updateInsideEvalStd.do";
	...
	function fn_delete(){
		if(confirm("삭제 하시겠습니까?")){
			if(doubleSubmitCheck()) return;
			var reqUrl =  "/lu/eval/deleteInsideEvalStd.do";
			$("#frmEvalPlan").attr("action", reqUrl);
			$("#frmEvalPlan").attr("target", "_self");
			$("#frmEvalPlan").submit();
		}
	...
	function fn_statusl(){
		if(confirm("승인요청 하시겠습니까?")){
			if(doubleSubmitCheck()) return;
			$("#status").val("1");
			var reqUrl =  "/lu/eval/saveInsideEvalStd.do";
			$("#frmEvalPlan").attr("enctype", "multipart/form-data" );
			$("#frmEvalPlan").attr("action", reqUrl);
			$("#frmEvalPlan").attr("target", "_self");
			$("#frmEvalPlan").submit();
							...
							<tbody>
								...
								<tr>
									...
									<c:if test="${!empty resultFile}">
											...
											<a href="javascript:com.deleteFile('${resultFile.atchFileId}|${resultFile.fileSn}', '/lu/eval/getInsideEvalStd.do?insideEvalId=${ result.insideEvalId}');"  class="btn-del">[삭제]</a><br />
									</c:if>					
									<c:if test="${empty resultFile}">				
								...
								<tr>
									...
									<c:if test="${!empty resultFile1}">
											...
											<a href="javascript:com.deleteFile('${resultFile1.atchFileId}|${resultFile1.fileSn}', '/lu/eval/getInsideEvalStd.do?insideEvalId=${ result.insideEvalId}');"  class="btn-del">[삭제]</a><br />
									</c:if>					
									<c:if test="${empty resultFile1}">				
								...
								<tr>
									...
									<c:if test="${!empty resultFile2}">
											...
											<a href="javascript:com.deleteFile('${resultFile2.atchFileId}|${resultFile2.fileSn}', '/lu/eval/getInsideEvalStd.do?insideEvalId=${ result.insideEvalId}');"  class="btn-del">[삭제]</a><br />
									</c:if>					
									<c:if test="${empty resultFile2}">				
								...
								<tr>
									...
									<c:if test="${!empty resultFile3}">
											...
											<a href="javascript:com.deleteFile('${resultFile3.atchFileId}|${resultFile3.fileSn}', '/lu/eval/getInsideEvalStd.do?insideEvalId=${ result.insideEvalId}');"  class="btn-del">[삭제]</a><br />
									</c:if>					
									<c:if test="${empty resultFile3}">				
