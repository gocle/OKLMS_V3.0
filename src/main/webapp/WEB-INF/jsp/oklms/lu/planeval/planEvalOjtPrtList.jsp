...
<input type="text" id="test1" name="test1" value="${resultNcsEvalPlanInfoList[0].applyApprovalYn}" style="display: none;" />
<input type="text" id="test2" name="test2" value="${resultNcsEvalPlanInfoList[0].status}" style="display: none;" />
