...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		/*
		$(document).on("click","input[name=check0]",function(){
			if($(this).is(":checked")){
				$("input[name='firstCheck']").each(function(){
	...
	/* 승인신청 업데이트 */
	function fn_updateAppYn( ){
		reqUrl = "/lu/evalPlan/updateNcsEvalPlanFirstAppYn.do";
	...
	<dl id="tab-type-2">
		...
		<dd id="tab-content-11" style="display:block;">
			...
			<table class="type-2 mt-010">
				...
				<thead>
					<tr>
						<th>선택<!-- <br/><input type="checkbox" id="check0" name="check0" class="choice"  /> --></th>
						<th>구분</th>
						<th>영역 (능력단위요소)</th>
						<th>평가내용 (수행준거)</th>
						<th>평가방법</th>
...
<!-- 							<input type="text" id="fileName-3" style="width:50%;" readonly="readonly">
			...
			<div class="btn-area align-right mt-010">
				<span class="float-left">※ 평가계획을 등록할 <font color="blue">"구분"</font> 및 <font color="blue"> "평가방법"</font>을 체크박스에서 선택후 <font color="blue">"평가계획 목록 표시 버튼"</font>을 클릭한다음 <font color="blue">"저장버튼"</font>을 클릭하여주십시오. <font color="blue">"승인신청"</font> 버튼 <font color="blue">"활성화시"</font> 클릭후 담당교수에게 <font color="blue">"승인"</font> 받으세요.</span>
			...
			<div class="btn-area align-right mt-010">
				<c:if test="${resultNcsEvalPlanInfoList[0].stdScoreCnt > 0 && resultNcsEvalPlanInfoList[0].applyApprovalYn eq 'N'}">
					<a href="#!" class="orange" onclick="javascript:fn_updateAppYn(); return false">승인신청</a>
				</c:if>
			</div><!-- E : btn-area -->
		...
		<dt class="tab-name-13"><a href="#!"  onclick="javascript:fn_goTab('03'); return false">평가결과 조회</a></dt>
	</dl>
