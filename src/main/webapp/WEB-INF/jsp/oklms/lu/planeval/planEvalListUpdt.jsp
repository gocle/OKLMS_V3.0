...
<div id="">
	...
	<dl id="tab-type-2">
		<dt class="tab-name-11 on"><a href="#!"  onclick="javascript:fn_goTab('01'); return false">평가계획 수정</a></dt>
		<dd id="tab-content-11" style="display:block;">
			...
			<table class="type-2 mt-010">
				...
				<tbody>
					<tr>
						<td>
							<select id="evDivCd" name="evDivCd" onchange="" style="width:120px;" disabled="disabled">
								<c:forEach var="evalPlanCd" items="${evalPlanCode}" varStatus="status">
									<option value="${evalPlanCd.codeId}" <c:if test="${evalPlanCd.codeId eq planEvalVO.evDivCd}">selected="selected"</c:if> >${evalPlanCd.codeName}</option>
								</c:forEach>
							</select>
						</td>
						...
						<td class="left">
							<!-- <a href="#!" class="text-file">기말고사 시험문항_01.hwp</a> <a href="#!" class="btn-del">첨부파일 삭제</a><br />
							<a href="#!" class="text-file">기말고사 시험문항_02.hwp</a> <a href="#!" class="btn-del">첨부파일 삭제</a> -->

							<a href="#!" class="text-file">개발중.hwp</a> <a href="#!" class="btn-del">첨부파일 삭제</a><br />
						</td>
					</tr>
					<tr>
						<td>
							<input type="text" id="evDivDate" name="evDivDate" placeholder="(ex)2017.03.01" value="${resultNcsEvalPlanInfoList[0].evDivDate}" style="width:85px;" readonly="readonly" />
						</td>
						<td class="left">
			...
			<table class="type-2 mt-040">
				...
				<tr>
					...
					<td class="left">
						<a href="#!" class="text-file">${result.evDivName} 시험문항_01.hwp</a> <a href="#!" class="btn-del">첨부파일 삭제</a><br />
						<a href="#!" class="text-file">${result.evDivName} 시험문항_02.hwp</a> <a href="#!" class="btn-del">첨부파일 삭제</a>
					</td>
					<td>
					<c:choose>
