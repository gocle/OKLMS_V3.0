...
<script type="text/javascript">
	...
	function fn_search(  param1 ){
		var reqUrl = "/lu/eval/listInsideEval.do";
					...
					<dd id="tab-content-11" style="display:block;"> -->
								...
								<table class="type-2">
									...
									<c:forEach var="result" items="${resultList}" varStatus="status">
										<tr>
											...
											<td><a href="/lu/eval/getInsideEval.do?insideEvalId=${result.insideEvalId}" style="text-decoration:underline;">${result.stdMemName}</a></td>
						...
						<div class="btn-area  mt-010">
							<div class="float-right">
								<a href="/lu/eval/insertInsideEvalPage.do" class="orange">등록</a>
							</div>
						</div>
					<!--
					</dd>
