...
<div id="pop-wrapper" class="min-w500">
	...
	<h2>설문</h2>
<h4 class="mb-010"><span><c:if test="${currProcReadVO.onlineTypeName eq '온라인'}">[ONLINE]</c:if>${currProcReadVO.subjectName} (${currProcReadVO.subClass}분반)</span> ㅣ ${currProcReadVO.yyyy}학년도 / ${currProcReadVO.termName}</h4>
				...
				<td>
						<dl class="poll-result">
							...
							<dd class="pb-025">
								...
								<ul>
									<li class="case-5" style="width:${readQestnrItemVO.qestnAnswerPercent6}%;"><i><b>${readQestnrItemVO.qestnAnswerPercent6}</b> %</i></li>
								</ul>
							</dd>
							</c:if>
							...
							<dd class="pb-025">
								...
								<ul>
									<li class="case-5" style="width:${readQestnrItemVO.qestnAnswerPercent7}%;"><i><b>${readQestnrItemVO.qestnAnswerPercent7}</b> %</i></li>
								</ul>
							</dd>
							</c:if>
							...
							<dd class="pb-025">
								...
								<ul>
									<li class="case-5" style="width:${readQestnrItemVO.qestnAnswerPercent8}%;"><i><b>${readQestnrItemVO.qestnAnswerPercent8}</b> %</i></li>
								</ul>
							</dd>
							</c:if>
							...
							<dd class="pb-025">
								...
								<ul>
									<li class="case-5" style="width:${readQestnrItemVO.qestnAnswerPercent9}%;"><i><b>${readQestnrItemVO.qestnAnswerPercent9}</b> %</i></li>
								</ul>
							</dd>
							</c:if>
