...
<script type="text/javascript">
	...
	function excelDownload(){
	    var reqUrl = "/lu/qestnr/popupQestnrEtcAnswerCnExcelDownload.do";	
...
<input type="hidden" id="qustnrQesitmId" name="qustnrQesitmId" value="${qestnrVO.qustnrQesitmId}" />
...
<div id="pop-wrapper" class="min-w500">
	...
	<div class="poll-etc">
		<ul>
			<c:forEach var="result" items="${resultList}" varStatus="status">
				<li><span>[ ${result.memId}-${result.memName} / ${result.insertDate} ]</span>[${result.qestnCn}]${result.etcAnswerCn}</li>
			</c:forEach>	
	...
	<div class="btn-area align-right mt-010">
		...
		<a href="#!" onclick="javascript:excelDownload(); return false" class="gray-1">엑셀다운로드</a>
