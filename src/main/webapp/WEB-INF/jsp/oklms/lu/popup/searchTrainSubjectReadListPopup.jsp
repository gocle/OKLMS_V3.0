...
<script type="text/javascript">
	...
	function fn_mapping_delete(yyyy,term,subjectCode,subClass,memSeq,tId){
		...
		$("#memSeq").val(memSeq);
		var param = $("#frmMember").serializeArray();
		var reqUrl = "/lu/popup/deleteCotMapping.json";
...
<!-- 팝업 사이즈 : 가로 최소 650px 이상 설정 -->
		<div id="pop-wrapper" class="min-w650">
			...
			<h1>(${memName}) 기업현장 교사에 매핑된 교과목 목록</h1>
			...
			<table class="type-2">
				...
				<thead>
					...
					<tr id="tr_${status.count}">
						...
						<td><a class="btn-full-blue" href="#fn_mapping_delete" onclick="fn_mapping_delete('${result.yyyy}','${result.term}','${result.subjectCode}','${result.subClass}','${result.memSeq}','tr_${status.count}')">삭제</a></td>
					</tr>
					</c:forEach>
