...
<div id="">
	<h2>평가결과서(${memId}-${memName})</h2>

	<div class="align-center mb-040">
		<c:if test="${memId != ''}">
			<iframe id="myframe" name="myframe" src="https://kut90.koreatech.ac.kr/oz/NCS/NC0213R.jsp?I_ESTBL_YY=${planEvalVO.yyyy}&I_ESTBL_SEMSTR_CD=${planEvalVO.tmpTerm}&I_COURSE_NO=${planEvalVO.subjectCode}&I_PARTITN_CLAS_SE_CD=${planEvalVO.subClass}&I_STUD_ID=${memId}" width="100%" height="900px"></iframe>
		</c:if>
	</div><!-- E : btn-area -->
