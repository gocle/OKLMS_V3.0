...
<!-- 팝업 사이즈 : 가로 최소 650px 이상 설정 -->
					...
					<dl class="attach-file">
						...
						<dd>
							<input type="text" id="fileName-1" style="width:220px;" readonly="readonly">
							<p class="file-find">
								<a href="#@" class="checkfile">찾아보기</a>
								<input type="file" id="atchFiles" name="atchFiles" class="file_input_hidden" onchange="javascript: document.getElementById('fileName-1').value = this.value" />
							</p>
						</dd>
						<dd id="fileList">
					...
					<div class="btn-area align-right mt-010">
						<a href="#fn_saveFile" onclick="fn_saveFile();" class="gray-3">저장</a>
