...
<script type="text/javascript">
	...
	function addTree(data, rowId){
		...
		for (var i = 0; i < jsonData.body.list.length; i++) {
		    ...
		    var chkVal = "CMS|"+list.title+"|"+rowId+"|"+list.lesson_id+"|"+list.id+"|"+registered_from_device_type_code+"|"+required_learning_time_in_seconds+"|"+jsonLessonData;
...
<!-- 팝업 사이즈 : 가로 최소 650px 이상 설정 -->
		<div id="pop-wrapper" class="min-w650">
			...
			<dl id="tab-type">
				...
				<dt class="tab-name-13"><a href="javascript:showTabbtn3();fn_search(3);">기존 과정</a></dt>
				<dd id="tab-content-13">
					<div class="search-box-1 mt-020 mb-010">
						...
						<select name="subjectType" id="subjectType">
									...
									<option value="NORMAL">학부</option>
									<option value="HSKILL">고숙련</option>
								</select>
						<input type="text" name="searchText" value="${param.searchText}" placeholder="교과명 검색" style="width:20%"/>
						<a href="#!" onclick="fn_search(3)">검색</a>
					</div><!-- E : search-box-1 -->
					...
					<ul class="page-num-btn mt-015">
						...
						<li class="page-btn-area">
							<a href="javascript:alert('추가할 콘텐츠가 없습니다.')" class="orange">목록에 추가</a><a href="#" onclick="window.self.close();" class="gray-3">닫기</a>
						</li>
					</ul><!-- E : page-num-btn -->
				</dd> 
			</dl>
