...
<h2>설문 참여</h2>
			...
			<tr>
				...
				<td>
					<dl class="poll-result">
						<dt>${fn:replace(readQestnrInfoVO.qustnrPurps,crcn,br) }</dt>
						...
						<c:if test="${!empty readQestnrItemVO.qestnCn2}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="2" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>> ${readQestnrItemVO.qestnCn2}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn3}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="3" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>> ${readQestnrItemVO.qestnCn3}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn4}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="4" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>> ${readQestnrItemVO.qestnCn4}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn5}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="5" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>> ${readQestnrItemVO.qestnCn5}</dd></c:if>
						
						<c:if test="${!empty readQestnrItemVO.qestnCn6}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="6" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>> ${readQestnrItemVO.qestnCn6}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn7}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="7" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>> ${readQestnrItemVO.qestnCn7}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn8}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="8" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>> ${readQestnrItemVO.qestnCn8}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn9}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="9" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>> ${readQestnrItemVO.qestnCn9}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn10}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="10" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>> ${readQestnrItemVO.qestnCn10}</dd></c:if>												
						<dd class="pb-005">
						<input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="etc" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>> 기타<br />
						</dd>
						<dd>
							<input type="text" id="etcAnswerCn" name="etcAnswerCn" maxlength="999" placeholder="(ex)의견 입력" style="width:100%;" <c:if test="${qestnrVO.joinAt eq 'Y' }">disabled="disabled" </c:if>   />
						</dd>
					</dl>
				</td>
			</tr>
	...
	<div id="answerResultId" style="display:none;">
				...
				<tr>
					...
					<td>
						<dl class="poll-result">
							...
							<c:if test="${!empty readQestnrItemVO.qestnCn6}">
							<dd class="pb-025">
								<p>${readQestnrItemVO.qestnCn6} [ ${readQestnrItemVO.qestnAnswerSn6}명 ]</p>
								<ul>
									<li class="case-1" style="width:${readQestnrItemVO.qestnAnswerPercent6}%;"><i><b>${readQestnrItemVO.qestnAnswerPercent6}</b> %</i></li>
								</ul>
							</dd>
							</c:if>
							<c:if test="${!empty readQestnrItemVO.qestnCn7}">
							<dd class="pb-025">
								<p>${readQestnrItemVO.qestnCn7} [ ${readQestnrItemVO.qestnAnswerSn7}명 ]</p>
								<ul>
									<li class="case-2" style="width:${readQestnrItemVO.qestnAnswerPercent7}%;"><i><b>${readQestnrItemVO.qestnAnswerPercent7}</b> %</i></li>
								</ul>
							</dd>
							</c:if>
							<c:if test="${!empty readQestnrItemVO.qestnCn8}">
							<dd class="pb-025">
								<p>${readQestnrItemVO.qestnCn8} [ ${readQestnrItemVO.qestnAnswerSn8}명 ]</p>
								<ul>
									<li class="case-3" style="width:${readQestnrItemVO.qestnAnswerPercent8}%;"><i><b>${readQestnrItemVO.qestnAnswerPercent8}</b> %</i></li>
								</ul>
							</dd>
							</c:if>
							<c:if test="${!empty readQestnrItemVO.qestnCn9}">
							<dd class="pb-025">
								<p>${readQestnrItemVO.qestnCn9} [ ${readQestnrItemVO.qestnAnswerSn9}명 ]</p>
								<ul>
									<li class="case-4" style="width:${readQestnrItemVO.qestnAnswerPercent9}%;"><i><b>${readQestnrItemVO.qestnAnswerPercent9}</b> %</i></li>
								</ul>
							</dd>
							</c:if>
							<c:if test="${!empty readQestnrItemVO.qestnCn10}">
							<dd class="pb-025">
								<p>${readQestnrItemVO.qestnCn10} [ ${readQestnrItemVO.qestnAnswerSn10}명 ]</p>
								<ul>
									<li class="case-5" style="width:${readQestnrItemVO.qestnAnswerPercent10}%;"><i><b>${readQestnrItemVO.qestnAnswerPercent10}</b> %</i></li>
								</ul>
							</dd>
							</c:if>
							
							<dd class="pb-025">
								<p>기타 [ ${readQestnrItemVO.qestnAnswerSn11}명 ]</p>
								<ul>
									<li class="case-9" style="width:${readQestnrItemVO.qestnAnswerPercent11}%;"><i><b>${readQestnrItemVO.qestnAnswerPercent11}</b> %</i></li>
								</ul>
							</dd>
						</dl>
					</td>
		...
		<!--div class="btn-area align-right mt-010">
			<a href="#!" onclick="javascript:fn_etcAnswerCnView(); return false" class="gray-2">의견 확인하기</a>
		</div -->
      </div>
