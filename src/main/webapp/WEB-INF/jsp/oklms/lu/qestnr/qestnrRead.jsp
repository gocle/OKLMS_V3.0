...
<h2>설문 결과보기</h2>
			...
			<tr>
				...
				<td>
					<dl class="poll-result">
						<dt> 
						${fn:replace(readQestnrInfoVO.qustnrPurps,crcn,br) }
						</dt>
						...
						<c:if test="${!empty readQestnrItemVO.qestnCn6}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="6" disabled="disabled"> ${readQestnrItemVO.qestnCn6}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn7}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="7" disabled="disabled"> ${readQestnrItemVO.qestnCn7}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn8}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="8" disabled="disabled"> ${readQestnrItemVO.qestnCn8}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn9}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="9" disabled="disabled"> ${readQestnrItemVO.qestnCn9}</dd></c:if>
						<c:if test="${!empty readQestnrItemVO.qestnCn10}"><dd class="pb-005"><input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="10" disabled="disabled"> ${readQestnrItemVO.qestnCn10}</dd></c:if>						
						<dd class="pb-005">
						<input type="radio" id="qestnAnswerSn" name="qestnAnswerSn" value="etc" disabled="disabled"> 기타<br />
						</dd>
						<dd class="pb-005">
						<input type="text" id="etcAnswerCn" name="etcAnswerCn" maxlength="999" placeholder="(ex)의견 입력" style="width:100%;" disabled="disabled" />
						</dd>						
					</dl>
				</td>
			</tr>
			
			<c:if test="${!empty readQestnrInfoVO.qustnrAnswer}">
			<tr>
				<th>설문정답</th>
				<td>${readQestnrInfoVO.qustnrAnswer}</td>
			</tr>
			</c:if>
	...
	<div class="btn-area mt-010">
		<div class="float-right">
			...
			<a href="#!" onclick="javascript:fn_etcAnswerCnView(); return false" class="black">의견 확인하기</a>
			<a href="#!" onclick="javascript:fn_print(); return false" class="black">출력</a>
		</div>
	</div>
