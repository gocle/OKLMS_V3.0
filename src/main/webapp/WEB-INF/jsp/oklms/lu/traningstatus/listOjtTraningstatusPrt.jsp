...
//         com.pageNavi( "pageNavi", totalCount , pageSize , pageIndex );
	...
	function fn_search( pageIndex ){
		...
		var reqUrl = CONTEXT_ROOT + targetUrl + "listOjtTraningstatusPrt.do";
...
<form id="frmSubject" name="frmSubject" action="<c:url value='/lu/traningstatus/listOjtTraningstatusPrt.do'/>" method="post">
