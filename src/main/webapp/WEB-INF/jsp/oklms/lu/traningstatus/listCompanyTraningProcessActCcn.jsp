...
function fn_get( yyyy,term,subjectCode,subjectClass,stdId){
								...
								<tbody>
									<c:forEach var="result" items="${resultList}" varStatus="status">
										<tr>
											...
											<a href="javascript:fn_get('${result.yyyy}','${result.term}','${result.subjectCode}','${result.subjectClass}','${result.stdId}')"><font color="blue">${result.actCnt}주차</font></a>
											</c:if>
											</td>
										</tr>
									</c:forEach> 
