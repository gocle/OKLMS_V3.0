...
String weekId = ServletRequestUtils.getStringParameter( request, "weekId", "" );
//String savePath =  EgovProperties.getProperty("Globals.fileStorePath")+"online/"+weekId+"/";
String savePath =  EgovProperties.getProperty("Globals.ContentMovieStorePath")+"online/"+weekId+"/";
String tempFileName = "";
String fileName = "";
String msg = "0";
...
try{
	...
	resultJson.put("saveFileName", tempFileName);
	resultJson.put("fileSavePath", savePath );
	resultJson.put("orgFileName", fileName); 
