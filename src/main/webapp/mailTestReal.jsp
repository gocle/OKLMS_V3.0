...
Authenticator authenticator = new MyAuthenticator("oklms", "kut!23456");
 ...
 */
 ...
 msg.setFrom(new InternetAddress("suno99@gocle.co.kr"));//보내는 사람 설정
 InternetAddress address = new InternetAddress("suno99@gocle.co.kr"); 
