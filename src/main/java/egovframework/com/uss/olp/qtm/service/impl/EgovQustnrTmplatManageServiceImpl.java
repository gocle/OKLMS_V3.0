...
public class EgovQustnrTmplatManageServiceImpl extends EgovAbstractServiceImpl implements EgovQustnrTmplatManageService{
	...
	/**
	 * 설문템플릿상세에서 삭제여부를 판단하기위한 전체 건수를(을) 조회한다.
	 * @param searchVO - 조회할 정보가 담긴 VO
	 * @return int
	 * @throws Exception
	 */
	@Override
	public int selectDelCnt(QustnrTmplatManageVO qustnrTmplatManageVO) throws Exception{
		return dao.selectDelCnt(qustnrTmplatManageVO);
	}
