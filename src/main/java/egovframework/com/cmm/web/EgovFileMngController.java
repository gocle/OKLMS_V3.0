...
public class EgovFileMngController {
     ...
     * @throws Exception
     */
    @RequestMapping("/cmm/fms/selectPlanFileInfs.do")
    public String selectPlanFileInfs(@ModelAttribute("searchVO") FileVO fileVO, @RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
	String atchFileId = (String)commandMap.get("param_atchFileId");
	String returnUrl = (String)commandMap.get("param_returnUrl");
	...
	return "egovframework/com/cmm/fms/EgovPlanFileList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cmm/fms/deletePlanFileInfs.do")
    public String deletePlanFileInfs(@ModelAttribute("searchVO") FileVO fileVO, @RequestParam("returnUrl") String returnUrl,
	    //SessionVO sessionVO,
