...
public class LoginVO extends BaseVO implements Serializable {
	...
	private Integer loginLimitMinute;
	
	private String companyName; 		  // 회사명
	
	private String newPasswordEncript; // 새 비밀번호
	private String newPasswordEncripted; // 새 비밀번호 암호화
	...
	public Integer getLoginLimitMinute() {
		return loginLimitMinute;
	}

	public void setLoginLimitMinute(Integer loginLimitMinute) {
		this.loginLimitMinute = loginLimitMinute;
	}
	...
	public String getEncryptShaPw(){
		return SecurityUtil.encryptSha256(memPasswordEncripted);
	}

	public String getNewPasswordEncript() {
		return newPasswordEncript;
	}

	public void setNewPasswordEncript(String newPasswordEncript) {
		this.newPasswordEncript = newPasswordEncript;
	}

	public String getNewPasswordEncripted() {
		return newPasswordEncripted;
	}
	
	public void setNewPasswordEncripted(String newPasswordEncripted) {
		this.newPasswordEncripted = newPasswordEncripted;
	}
