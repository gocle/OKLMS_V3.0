...
public class FileManageDAO extends EgovComAbstractDAO {
	...
	public String insertFileInfs(List<?> fileList) throws Exception {
		...
		if( AtchFileUtil.checkIsFileName(vo.getOrignlFileNm()) ){
			insert("FileManageDAO.insertFileMaster", vo);
	
			Iterator<?> iter = fileList.iterator();
			while (iter.hasNext()) {
				vo = (FileVO) iter.next();
				System.out.println("detail vo.getOrignlFileNm() : "+vo.getOrignlFileNm());
	 ...
	 * @throws Exception
	 */
	public List<FileVO> selectFileInfsIn(FileVO fvo) throws Exception{
		return (List<FileVO>) list("FileManageDAO.selectFileListAll", fvo);
	}
}
