...
//	}
	...
	public void initVariables(){
		firstPageLabel    = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"page-btn1\">처음 페이지</a>&#160;";
        previousPageLabel = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"page-btn2\">이전 페이지</a>&#160;";
        currentPageLabel  = "<a href=\"#\" class=\"num ing\">{0}</a>&#160;";
        otherPageLabel    = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \"  class=\"num\">{2}</a>&#160;";
        nextPageLabel     = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"page-btn3\">다음 페이지</a>&#160;";
        lastPageLabel     = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"page-btn4\">마지막 페이지</a>&#160;";
	}
