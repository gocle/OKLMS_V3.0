...
public interface  TodayMapper {
	 ...
	 * @throws Exception
	 */
	List<BoardVO> listQnAPrt (TodayVO todayVO) throws Exception;	
	...
	/**
	 * 
	 * 센터담당자 today 학습활동서 미제출 목록
	 * 
	 * @return
	 * @throws Exception
	 */
	List<TodayVO> listWeekActivityNoteCompany(TodayVO todayVO) throws Exception;
}
