package kr.co.gocle.oklms.lu.teamproject.vo;
...
public class TeamprojectVO extends BaseVO implements Serializable {
	...
	private int stuSubmitCnt;				// 학생 제출자수
	

	public int getStuSubmitCnt() {
		return stuSubmitCnt;
	}

	public void setStuSubmitCnt(int stuSubmitCnt) {
		this.stuSubmitCnt = stuSubmitCnt;
	}
