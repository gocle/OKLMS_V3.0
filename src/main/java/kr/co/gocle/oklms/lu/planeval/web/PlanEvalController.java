 ...
 *
 *******************************************************************************/
package kr.co.gocle.oklms.lu.planeval.web;
...
public class PlanEvalController extends BaseController{
	...
	public String listNcsEvalPlan(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, ModelMap model, HttpServletRequest request) throws Exception {
    	...
    	* 초기값 셋팅 영역
		...
		String pMemId = StringUtils.defaultString( (String)paramMap.get("pMemId") , "" );
		...
		*/
		...
		if("COT".equals(planEvalVO.getSessionMemType())){ //기업현장교사일떼.
			...
			if(tmpTerm.equals("101")){
				tmpTerm = "10";
			} else if(tmpTerm.equals("102")){
				tmpTerm = "20";
			} else if(tmpTerm.equals("103")){
				tmpTerm = "11";
			} else {
				tmpTerm = "21";
			}
			...
			if("OFF".equals(subjectTraningType)){ //OFF-JT 과정일떼
				...
				if("02".equals(tabPageGubun)){ //학습자별 OZ 레포트화면 호출
					...
					List<PlanEvalVO> listMember = planEvalService.listFistEvalPlanLessonAllMember(planEvalVO);
					...
					model.addAttribute("pMemId", pMemId);
...
/*						if("".equals(memSeq)){
		...
		if("COT".equals(planEvalVO.getSessionMemType())){
			...
			if("OJT".equals(subjectTraningType)){
				...
				//} else { //일반과정일떼 _ 기업별_분반
		        	...
		        	List<SubjectVO> listOjtClassName = subjectService.listAllOjtClassName(subjectVO);
	    			model.put("listOjtClassName", listOjtClassName);
	 ...
	 * @throws Exception
	 */									   
	@RequestMapping(value = "/lu/eval/listInsideEvalStd.do")
	public String listInsidePlanStd(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, ModelMap model, HttpServletRequest request) throws Exception {
		/*====================================================================
    	* 초기화 영역
    	======================================================================*/
	    String retMsg = "";
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
		...
		planEvalVO.setSubjectCode(subjectCode);		
		planEvalVO.setSubClass(classs);
		List<PlanEvalVO> resultList = planEvalService.listInsideEval(planEvalVO);
		model.addAttribute("resultList", resultList);
		

		returnUrl = "oklms/lu/planeval/listInsidePlanStd";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/getInsideEvalStd.do")
	public String getInsideEvalStd(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, ModelMap model, HttpServletRequest request) throws Exception {
		/*====================================================================
    	* 초기화 영역
    	======================================================================*/
	    String retMsg = "";
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
		...
		planEvalVO.setSubjectCode(subjectCode);		
		planEvalVO.setSubClass(classs);
		PlanEvalVO result = planEvalService.getInsideEval(planEvalVO);
		...
		if(result!=null){
		    ...
		    atchFileVO.setFileSn(1);
			atchFileVO.setAtchFileId(result.getAtchFileId1());
			//첨부파일
			AtchFileVO resultFile1 = atchFileService.getAtchFile(atchFileVO);
			model.addAttribute("resultFile1", resultFile1);   
			
			atchFileVO.setFileSn(1);
			atchFileVO.setAtchFileId(result.getAtchFileId2());
			//첨부파일
			AtchFileVO resultFile2 = atchFileService.getAtchFile(atchFileVO);
			model.addAttribute("resultFile2", resultFile2); 
			
			atchFileVO.setFileSn(1);
			atchFileVO.setAtchFileId(result.getAtchFileId3());
			//첨부파일
			AtchFileVO resultFile3 = atchFileService.getAtchFile(atchFileVO);
			model.addAttribute("resultFile3", resultFile3); 
		}
		
		model.addAttribute("stdMemName", loginInfo.getMemName());
		model.addAttribute("stdMemSeq", loginInfo.getMemSeq());

		returnUrl = "oklms/lu/planeval/getInsidePlanStd";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/insertInsideEvalPageStd.do")
	public String insertInsideEvalPageStd(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, ModelMap model, HttpServletRequest request) throws Exception {
		/*====================================================================
    	* 초기화 영역
    	======================================================================*/
	    String retMsg = "";
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
		...
		planEvalVO.setSubjectCode(subjectCode);		
		planEvalVO.setSubClass(classs);
		List<PlanEvalVO> resultList = planEvalService.listFistEvalPlanLessonMember(planEvalVO);
		model.addAttribute("resultList", resultList);
		
		model.addAttribute("stdMemName", loginInfo.getMemName());
		model.addAttribute("stdMemSeq", loginInfo.getMemSeq());

		returnUrl = "oklms/lu/planeval/insertInsidePlanStd";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/insertInsideEvalStd.do")
	public String insertInsideEvalStd(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, BindingResult bindingResult, ModelMap model, RedirectAttributes redirectAttributes, SessionStatus status, final MultipartHttpServletRequest multiRequest) throws Exception {
		...
		checkCnt = planEvalService.getInsideEvalCnt(planEvalVO);

		if(checkCnt > 0){
			retMsg = "이미 등록 된 평가내역이 있습니다.";
		} else {
			iResult = planEvalService.insertInsideEval(planEvalVO,multiRequest);
			if (iResult > 0) {
				retMsg = "정상적으로 처리되었습니다.";
			} else {
				retMsg = "처리에 실패 하였습니다.";
		...
		// View호출
		return "redirect:/lu/eval/listInsideEvalStd.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/updateInsideEvalPageStd.do")
	public String updateInsideEvalPageStd(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, ModelMap model, HttpServletRequest request) throws Exception {
		/*====================================================================
    	* 초기화 영역
    	======================================================================*/
	    String retMsg = "";
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
		...
		planEvalVO.setSubjectCode(subjectCode);		
		planEvalVO.setSubClass(classs);
		planEvalService.getInsideEval(planEvalVO);
		...
		model.addAttribute("planEvalVO", planEvalVO);
		returnUrl = "oklms/lu/planeval/updateInsidePlanStd";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/updateInsideEvalStd.do")
	public String updateInsideEvalStd(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, BindingResult bindingResult, ModelMap model, RedirectAttributes redirectAttributes, SessionStatus status, final MultipartHttpServletRequest multiRequest) throws Exception {
		...
		//	retMsg = "이미 등록 된 평가내역이 있습니다.";
		//} else {
			iResult = planEvalService.updateInsideEval(planEvalVO, multiRequest);
			if (iResult > 0) {
				retMsg = "정상적으로 처리되었습니다.";
			} else {
				retMsg = "처리에 실패 하였습니다.";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/saveInsideEvalStd.do")
	public String updateStatusInsideEvalStd(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, BindingResult bindingResult, ModelMap model, RedirectAttributes redirectAttributes, SessionStatus status, final MultipartHttpServletRequest multiRequest) throws Exception {
		...
		//	retMsg = "이미 등록 된 평가내역이 있습니다.";
		//} else {
			iResult = planEvalService.updateStatusInsideEval(planEvalVO,multiRequest);
			if (iResult > 0) {
				retMsg = "정상적으로 처리되었습니다.";
			} else {
				retMsg = "처리에 실패 하였습니다.";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/deleteInsideEvalStd.do")
	public String deleteInsideEvalStd(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, BindingResult bindingResult, ModelMap model, RedirectAttributes redirectAttributes, SessionStatus status) throws Exception {
		...
		iResult = planEvalService.deleteInsideEval(planEvalVO);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/listInsideEvalPrt.do")
	public String listInsideEvalPrt(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, ModelMap model, HttpServletRequest request) throws Exception {
		/*====================================================================
    	* 초기화 영역
    	======================================================================*/
	    String retMsg = "";
    	...
    	* 초기값 셋팅 영역
		...
		if(planEvalVO.getSubClass()==null||planEvalVO.getSubClass().equals("")){
			planEvalVO.setSubClass(StringUtils.defaultIfBlank( planEvalVO.getSubClass() ,(String)session.getAttribute(Globals.CLASS)));
		}
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
		...
		logger.debug("#### subjectCode : " + subjectCode );
		logger.debug("#### subjectName : " + subjectName );
		logger.debug("#### classs : " + planEvalVO.getSubClass() );
		logger.debug("################################# ");
		...
		traningNoteVO.setTerm(term);
		traningNoteVO.setSubjectCode(subjectCode);		
		...
		if(planEvalVO.getSubClass() ==null || planEvalVO.getSubClass().equals("")){			
			if(subjectNameList!=null&&subjectNameList.size()>0){
				...
				planEvalVO.setSubClass(temp.getClassId());
			}
		}
		...
		subjectVO.setTerm(term);
		subjectVO.setSubjectCode(subjectCode);		
		subjectVO.setSubjectClass(planEvalVO.getSubClass());
		...
		planEvalVO.setSubjectCode(subjectCode);		
		//planEvalVO.setSubClass(classs);
		List<PlanEvalVO> resultList = planEvalService.listInsideEvalPrt(planEvalVO);
		model.addAttribute("resultList", resultList);
		

		returnUrl = "oklms/lu/planeval/listInsidePlanPrt";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/updateInsideEvalPrt.do")
	public String updateInsideEvalPrt(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, BindingResult bindingResult, ModelMap model, RedirectAttributes redirectAttributes, SessionStatus status) throws Exception {
		...
		iResult = planEvalService.updateInsideEvalPrt(planEvalVO);
		...
		// View호출
		return "redirect:/lu/eval/listInsideEvalPrt.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/listInsideEval.do")
	public String listInsidePlan(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, ModelMap model, HttpServletRequest request) throws Exception {
		/*====================================================================
    	* 초기화 영역
    	======================================================================*/
	    String retMsg = "";
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
		...
		returnUrl = "oklms/lu/planeval/listInsidePlan";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/getInsideEval.do")
	public String getInsidePlan(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, ModelMap model, HttpServletRequest request) throws Exception {
		/*====================================================================
    	* 초기화 영역
    	======================================================================*/
	    String retMsg = "";
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
		...
		returnUrl = "oklms/lu/planeval/getInsidePlan";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/insertInsideEvalPage.do")
	public String insertInsideEvalPage(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, ModelMap model, HttpServletRequest request) throws Exception {
		/*====================================================================
    	* 초기화 영역
    	======================================================================*/
	    String retMsg = "";
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
		...
		returnUrl = "oklms/lu/planeval/insertInsidePlan";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/insertInsideEval.do")
	public String insertInsideEval(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, BindingResult bindingResult, ModelMap model, RedirectAttributes redirectAttributes, SessionStatus status, final MultipartHttpServletRequest multiRequest) throws Exception {
		...
		// View호출
		return "redirect:/lu/eval/listInsideEval.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/updateInsideEvalPage.do")
	public String updateInsideEvalPage(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, ModelMap model, HttpServletRequest request) throws Exception {
		/*====================================================================
    	* 초기화 영역
    	======================================================================*/
	    String retMsg = "";
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
		...
		model.addAttribute("planEvalVO", planEvalVO);
		returnUrl = "oklms/lu/planeval/updateInsidePlan";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/updateInsideEval.do")
	public String updateInsideEval(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, BindingResult bindingResult, ModelMap model, RedirectAttributes redirectAttributes, SessionStatus status, final MultipartHttpServletRequest multiRequest) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/saveInsideEval.do")
	public String updateStatusInsideEval(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, BindingResult bindingResult, ModelMap model, RedirectAttributes redirectAttributes, SessionStatus status, final MultipartHttpServletRequest multiRequest) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/eval/deleteInsideEval.do")
	public String deleteInsideEval(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmEvalPlan") PlanEvalVO planEvalVO, BindingResult bindingResult, ModelMap model, RedirectAttributes redirectAttributes, SessionStatus status) throws Exception {
