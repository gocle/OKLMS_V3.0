...
public class SubjectVO extends BaseVO implements Serializable{
	...
	private String departmentNo              ;   // 학과명
	...
	private String traningProcessYn;
	...
	private String reinfcTraningDate;
	private String [] reinfcTraningDates;
	private String [] weekCnts;
	private String [] traningDates;
	private String nextYyyy;
	private String nextTerm;
	private String startDate;
	private String endDate;
	private String searchStatus;
	private String searchAttendType;
	private String searchSubjectCode;
	private String actSearchStatus;
	private String noteSearchStatus;
	private String weekLen;
	private String onSceduleStr;
	private String onSceduleLen;
	
	private String mstYn;       // 구분
	...
	private String [] deptLimits;
	private String [] deptCds;
	private String [] deptYears;
	private String [] deptTransferYns;
	private String deptTransferYn;
	private String deptLimit;
	private String deptCd;
	private String deptYear;
	private String skTotal;
	...
	public String getDeptTransferNm() {
		return deptTransferNm;
	}

	public void setDeptTransferNm(String deptTransferNm) {
		this.deptTransferNm = deptTransferNm;
	}
	
	public String[] getDeptTransferYns() {
		return deptTransferYns;
	}

	public void setDeptTransferYns(String[] deptTransferYns) {
		this.deptTransferYns = deptTransferYns;
	}

	public String getDeptTransferYn() {
		return deptTransferYn;
	}

	public void setDeptTransferYn(String deptTransferYn) {
		this.deptTransferYn = deptTransferYn;
	}
	
	public String getDeptLimit() {
		return deptLimit;
	}

	public void setDeptLimit(String deptLimit) {
	...
	public String[] getDeptLimits() {
		return deptLimits;
	}

	public void setDeptLimits(String[] deptLimits) {
	...
	public String[] getDeptYears() {
		return deptYears;
	}

	public void setDeptYears(String[] deptYears) {
		this.deptYears = deptYears;
	}
	...
	public String getNcsUnit() {
		return ncsUnit;
	}

	public void setNcsUnit(String ncsUnit) {
		this.ncsUnit = ncsUnit;
	}
	...
	public String getSubjectNcsName() {
		return subjectNcsName;
	}

	public void setSubjectNcsName(String subjectNcsName) {
		this.subjectNcsName = subjectNcsName;
	}
	...
	public String getOnSceduleLen() {
		return onSceduleLen;
	}

	public void setOnSceduleLen(String onSceduleLen) {
		this.onSceduleLen = onSceduleLen;
	}
	...
	public String getOnSceduleStr() {
		return onSceduleStr;
	}

	public void setOnSceduleStr(String onSceduleStr) {
		this.onSceduleStr = onSceduleStr;
	}
	...
	public String getNoteSearchStatus() {
		return noteSearchStatus;
	}

	public void setNoteSearchStatus(String noteSearchStatus) {
		this.noteSearchStatus = noteSearchStatus;
	}
	...
	public String getSearchAttendType() {
		return searchAttendType;
	}

	public void setSearchAttendType(String searchAttendType) {
		this.searchAttendType = searchAttendType;
	}
	...
	public String[] getTraningDates() {
		return traningDates;
	}

	public void setTraningDates(String[] traningDates) {
		this.traningDates = traningDates;
	}
	...
	public String getNextYyyy() {
		return nextYyyy;
	}

	public void setNextYyyy(String nextYyyy) {
		this.nextYyyy = nextYyyy;
	}
	...
	public String getReinfcTraningDate() {
		return reinfcTraningDate;
	}

	public void setReinfcTraningDate(String reinfcTraningDate) {
		this.reinfcTraningDate = reinfcTraningDate;
	}
	...
	public String getTraningProcessYn() {
		return traningProcessYn;
	}

	public void setTraningProcessYn(String traningProcessYn) {
		this.traningProcessYn = traningProcessYn;
	}
	...
	public String[] getReinfcTraningDates() {
		return reinfcTraningDates;
	}

	public void setReinfcTraningDates(String[] reinfcTraningDates) {
