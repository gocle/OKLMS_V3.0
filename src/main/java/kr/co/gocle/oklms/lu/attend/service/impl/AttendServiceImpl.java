...
public class AttendServiceImpl extends EgovAbstractServiceImpl implements AttendService{
	...
	public AttendVO insertAttendInfo(AttendVO attendVO) throws Exception {
        ...
        //String timeId = attendMapper.getTimeId(attendVO);
        String lessonTimeId = "";
    	
        // 수강 시작 시간 정보 추가
    	lessonTimeId = lessonTimeIdGnrService.getNextStringId();
        ...
        //================== 진도율 : 기존 로우데이터에서 추출 > 로우데이터 기반으로 주차별 및 학습자별 진도율 누적
		// 주차별 진도율이 있는지 확인
		int weekProgressRateCnt = attendMapper.getWeekProgressRateCnt(attendVO);
			
		if( weekProgressRateCnt == 0 ){
			iResult += attendMapper.insertWeekProgressRate(attendVO);
		} else {
			iResult += attendMapper.updateWeekProgressRate(attendVO);
		}
		
		// LESSON 단위 진도율 업데이트 
		iResult += attendMapper.updateLessonProgressRate(attendVO);
		System.out.println("========= attendVO.getYyyy() : "+attendVO.getYyyy());
		System.out.println("========= attendVO.getTerm() : "+attendVO.getTerm());
		System.out.println("========= attendVO.getSubjectCode() : "+attendVO.getSubjectCode());
		System.out.println("========= attendVO.getSubjectClass() : "+attendVO.getSubjectClass());
		//============================================================================== 
	...
	public AttendVO updateAttend(AttendVO attendVO) throws Exception {
		...
		/*<update id="updateTime" parameterType="kr.co.gocle.oklms.lu.attend.vo.AttendVO">
		 ====== kr.co.gocle.oklms.lu.attend.service.impl.AttendMapper.updateTime ====== 
		...
		System.out.println("=========== 진도시간 업데이트");
		System.out.println("=========== vDateTime : "+attendVO.getvDateTime());
		System.out.println("=========== progressTimeId : "+attendVO.getProgressTimeId());
		System.out.println("=========== ProgressAttendId : "+attendVO.getProgressAttendId());
		System.out.println("=========== 진도시간 업데이트");
	...
	public String getWeekScheduleLessonProgress(AttendVO attendVO) throws Exception {
		String result = attendMapper.getWeekScheduleLessonProgress(attendVO);
		return result;
	}
