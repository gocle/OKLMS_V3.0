package kr.co.gocle.oklms.lu.today.service.impl;
...
public class TodayServiceImpl extends EgovAbstractServiceImpl implements TodayService {
	...
	@Override
	public List<BoardVO> listQnAPrt(TodayVO todayVO)throws Exception {
		// TODO Auto-generated method stub
		return todayMapper.listQnAPrt(todayVO);
	}
	...
	@Override
	public List<TodayVO> listWeekActivityNoteCompany(TodayVO todayVO)throws Exception {
		// TODO Auto-generated method stub
		return todayMapper.listWeekActivityNoteCompany(todayVO);
	}   
