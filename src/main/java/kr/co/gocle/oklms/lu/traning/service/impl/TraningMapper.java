...
public interface TraningMapper {
	...
	TraningVO getTraningProcessInfo(TraningVO traningVO) throws Exception;
	...
	int saveTraningProcessManage(TraningVO traningVO) throws Exception;
	 ...
	 * String
	 */
	int removeMemberCompanyId(TraningProcessMappingVO traningProcessMappingVO) throws Exception;
	 ...
	 * String
	 */
	int insertSubjWeekBatch(TraningScheduleVO traningScheduleVO) throws Exception;
	 ...
	 * String
	 */
	int insertSubjWeekTimeBatch(TraningScheduleVO traningScheduleVO) throws Exception;
	 ...
	 * String
	 */
	int getTraningScheduleUseCnt(TraningScheduleVO traningScheduleVO) throws Exception;
	 ...
	 * String
	 */
	int deletetTraningScheduleWeek(TraningScheduleVO traningScheduleVO) throws Exception;
	 ...
	 * String
	 */
	int deletetTraningScheduleWeekTime(TraningScheduleVO traningScheduleVO) throws Exception;
	 ...
	 * String
	 */
	int getTraningScheduleCnt(TraningScheduleVO traningScheduleVO) throws Exception;
	 ...
	 * String
	 */
	Integer getTraningSubjectCnt(TraningScheduleVO traningScheduleVO) throws Exception;
	 ...
	 * String
	 */
	Integer getTraningSubjectScheduleCnt(TraningScheduleVO traningScheduleVO) throws Exception;
	 ...
	 * String
	 */
	String getTraningSubjectScheduleWeekId(TraningScheduleVO traningScheduleVO) throws Exception;
	 ...
	 * String
	 */
	String getTraningSubjectWeekId(TraningScheduleVO traningScheduleVO) throws Exception;
	 ...
	 * List<TraningVO>
	 */
	List<TraningVO> listTraningPrt(TraningVO traningVO) throws Exception;
	
	List<TraningVO> listTraningCcn(TraningVO traningVO) throws Exception;
	
	List<TraningVO> listTraningSubjectPrt(TraningVO traningVO) throws Exception;
	
	
	int updateTraningPrt(TraningVO traningVO) throws Exception;
	
	int updateTraningCcn(TraningVO traningVO) throws Exception;
