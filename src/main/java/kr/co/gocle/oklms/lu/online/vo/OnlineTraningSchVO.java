...
public class OnlineTraningSchVO extends BaseVO implements Serializable{
	...
	private String cYyyy = "";
	private String cTerm = "";
	private String cSubjectCode = "";
	private String cSubjectClass = "";
	private String offTimeHour;
	private String weekMobileNotCnt = "";
	private String leadTime = "";
	private String reinfcTraningDate = "";
	private String reinfcDayWeek = "";
	private String weekFileCnt = "";
	private String onlineType = "";
	private String [] weekCnts      ;
	private String schProgressRate;
	private String schStudyMinute;
	private String actNoteApprovalCnt;
	private String traNoteApprovalCnt;
	

	private String traNoteStatus;

	public String getTraNoteStatus() {
		return traNoteStatus;
	}

	public void setTraNoteStatus(String traNoteStatus) {
		this.traNoteStatus = traNoteStatus;
	}
	
	public String getActNoteApprovalCnt() {
		return actNoteApprovalCnt;
	}

	public void setActNoteApprovalCnt(String actNoteApprovalCnt) {
		this.actNoteApprovalCnt = actNoteApprovalCnt;
	}

	public String getTraNoteApprovalCnt() {
		return traNoteApprovalCnt;
	}

	public void setTraNoteApprovalCnt(String traNoteApprovalCnt) {
		this.traNoteApprovalCnt = traNoteApprovalCnt;
	}
	
	public String getSchStudyMinute() {
		return schStudyMinute;
	}

	public void setSchStudyMinute(String schStudyMinute) {
		this.schStudyMinute = schStudyMinute;
	}

	public String getSchProgressRate() {
		return schProgressRate;
	}

	public void setSchProgressRate(String schProgressRate) {
		this.schProgressRate = schProgressRate;
	}
	...
	public String getWeekFileCnt() {
		return weekFileCnt;
	}

	public void setWeekFileCnt(String weekFileCnt) {
		this.weekFileCnt = weekFileCnt;
	}
	...
	public String getReinfcDayWeek() {
		return reinfcDayWeek;
	}

	public void setReinfcDayWeek(String reinfcDayWeek) {
		this.reinfcDayWeek = reinfcDayWeek;
	}
	...
	public String getcYyyy() {
		return cYyyy;
	}


	public void setcYyyy(String cYyyy) {
		this.cYyyy = cYyyy;
	}
	...
	public void setcSubjectCode(String cSubjectCode) {
		this.cSubjectCode = cSubjectCode;
	}


	public String getcSubjectClass() {
		return cSubjectClass;
	}


	public void setcSubjectClass(String cSubjectClass) {
		this.cSubjectClass = cSubjectClass;
	}
