...
public interface PlanEvalMapper {
	 ...
	 * int
	 */
	int insertInsideEval(PlanEvalVO planEvalVO) throws Exception;
	 ...
	 * int
	 */
	int updateInsideEval(PlanEvalVO planEvalVO) throws Exception;
	
	
	/**
	 * DB에서 네브퍙기 Data를 삭제한다.
	 * @param planEvalVO
	 * @return
	 * int
	 */
	 ...
	 * int
	 */
	int updateStatusInsideEval(PlanEvalVO planEvalVO) throws Exception;
