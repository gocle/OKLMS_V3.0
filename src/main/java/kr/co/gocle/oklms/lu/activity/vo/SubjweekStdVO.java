...
public class SubjweekStdVO  extends BaseVO implements Serializable{
	...
	private String ojtWorkName;
	private String offWorkName;
	...
	public String getOjtWorkName() {
		return ojtWorkName;
	}
	public void setOjtWorkName(String ojtWorkName) {
		this.ojtWorkName = ojtWorkName;
	}
	public String getOffWorkName() {
		return offWorkName;
	}
	public void setOffWorkName(String offWorkName) {
		this.offWorkName = offWorkName;
	}
