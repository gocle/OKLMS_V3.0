package kr.co.gocle.oklms.lu.teamproject.service.impl;
...
import kr.co.gocle.oklms.lu.teamproject.service.TeamprojectService;
import kr.co.gocle.oklms.lu.teamproject.vo.TeamprojectGroupVO;
import kr.co.gocle.oklms.lu.teamproject.vo.TeamprojectSubmitVO;
...
public class TeamprojectServiceImpl extends EgovAbstractServiceImpl implements TeamprojectService{
	...
	@Override
	public int updateTeamprojectInfo(TeamprojectVO teamprojectVO,final MultipartHttpServletRequest multiRequest) throws Exception {
		// TODO Auto-generated method stub
		...
		int data = teamprojectMapper.updateTeamprojectInfo(teamprojectVO);
		return data;
	}
	...
	public int updateTeamprojectSubmitArr(TeamprojectSubmitVO teamprojectSubmitVO, HttpServletRequest request) throws Exception {
		...
		for(int a=0 ;teamprojectSubmitVO.getArrTeamprojectSubmitId().length>a ; a++){
			...
			temp.setEvalScore(  StringUtils.defaultIfBlank(request.getParameter("arrEvalScore_"+teamprojectSubmitVO.getArrTeamprojectSubmitId()[a]), "0")  );
