package kr.co.gocle.oklms.lu.interview.vo;
...
public class InterviewVO extends BaseVO implements Serializable{
	...
	public String getNxtMonth() {
		return nxtMonth;
	}
	public void setNxtMonth(String nxtMonth) {
		this.nxtMonth = nxtMonth;
	}
