...
public interface WorkCertMapper {
	 ...
	 * @throws Exception
	 */
	int deleteWorkProof(WorkCertVO workCertVO)throws Exception;
	 ...
	 * @throws Exception
	 */
	int insertWorkCertReturnReason(WorkCertVO workCertVO)throws Exception; 
	 ...
	 * @throws Exception
	 */
	List<WorkCertVO> listWorkCertReturnReason(WorkCertVO workCertVO)throws Exception;
	...
	int updateOffWorkCertClearMember(WorkCertVO workCertVO)throws Exception;
	
	
	int updateOffWorkCertClearSendMember(WorkCertVO workCertVO)throws Exception;
	
	
	int selectWorkCertMemberStateCnt(WorkCertVO workCertVO)throws Exception;
	 ...
	 * @throws Exception
	 */
	List<WorkCertVO> listWorkMembers(WorkCertVO workCertVO)throws Exception;
	
	List<WorkCertVO> listMyDept(String sessionMemSeq)throws Exception;
