 ...
 *
 *******************************************************************************/ 
package kr.co.gocle.oklms.lu.online.web;
...
public class OnlineTraningController extends BaseController{
	...
	public String listOnlineTraning(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmTraning") OnlineTraningSchVO onlineTraningSchVO, ModelMap model,  HttpServletRequest request) throws Exception {
		...
		subjectVO.setYyyy(StringUtils.defaultIfBlank( onlineTraningSchVO.getYyyy(),(String)httpSession.getAttribute(Globals.YYYY)));
		subjectVO.setTerm(StringUtils.defaultIfBlank( onlineTraningSchVO.getTerm(),(String)httpSession.getAttribute(Globals.TERM)));
		subjectVO.setSubjectClass(StringUtils.defaultIfBlank( onlineTraningSchVO.getSubjectClass(),(String)httpSession.getAttribute(Globals.CLASS)));
		subjectVO.setSubjectCode(StringUtils.defaultIfBlank( onlineTraningSchVO.getSubjectCode(),(String)httpSession.getAttribute(Globals.SUBJECT_CODE)));

		onlineTraningSchVO.setYyyy(StringUtils.defaultIfBlank( onlineTraningSchVO.getYyyy(),(String)httpSession.getAttribute(Globals.YYYY)));
		onlineTraningSchVO.setTerm(StringUtils.defaultIfBlank( onlineTraningSchVO.getTerm(),(String)httpSession.getAttribute(Globals.TERM)));
		onlineTraningSchVO.setSubClass(StringUtils.defaultIfBlank( onlineTraningSchVO.getSubClass(),(String)httpSession.getAttribute(Globals.CLASS)));
		onlineTraningSchVO.setSubjectCode(StringUtils.defaultIfBlank( onlineTraningSchVO.getSubjectCode(),(String)httpSession.getAttribute(Globals.SUBJECT_CODE)));
		
		onlineTraningVO.setYyyy(StringUtils.defaultIfBlank( onlineTraningSchVO.getYyyy(),(String)httpSession.getAttribute(Globals.YYYY)));
		onlineTraningVO.setTerm(StringUtils.defaultIfBlank( onlineTraningSchVO.getTerm(),(String)httpSession.getAttribute(Globals.TERM)));
		onlineTraningVO.setSubjectClass(StringUtils.defaultIfBlank( onlineTraningSchVO.getSubjectClass(),(String)httpSession.getAttribute(Globals.CLASS)));
		onlineTraningVO.setSubjectCode(StringUtils.defaultIfBlank( onlineTraningSchVO.getSubjectCode(),(String)httpSession.getAttribute(Globals.SUBJECT_CODE)));
		...
		String c_yyyy = (String) paramMap.get("c_yyyy");
		String c_term = (String) paramMap.get("c_term");
		String c_subjectCode = (String) paramMap.get("c_subjectCode");
		String c_subjectClass = (String) paramMap.get("c_subjectClass");
		
		logger.debug("#### getcYyyy " + c_yyyy );
		logger.debug("#### getcTerm=" + c_term );
		logger.debug("#### getcSubjectClass=" + c_subjectCode );
		logger.debug("#### getcSubjectCode=" + c_subjectClass );
		
		if(!"".equals(c_yyyy) && !"".equals(c_term) && !"".equals(c_subjectCode) && !"".equals(c_subjectClass)){
			onlineTraningSchVO.setcYyyy(c_yyyy);
			onlineTraningSchVO.setcTerm(c_term);
			onlineTraningSchVO.setcSubjectCode(c_subjectCode);
			onlineTraningSchVO.setcSubjectClass(c_subjectClass);
		}
	...
	public String popupOnlineTraning(@RequestParam Map<String, Object> commandMap, @ModelAttribute("frmPop") CmsCourseBaseVO cmsCourseBaseVO, ModelMap model) throws Exception {
		...
		String subjectGrade = (String) commandMap.get("subjectGrade");
		String point = (String) commandMap.get("point");
		String searchKeyword = (String) commandMap.get("searchKeyword");
		
		onlineTraningSchVO.setYyyy(yyyy);
		onlineTraningSchVO.setTerm(term);
		onlineTraningSchVO.setSubjectGrade(subjectGrade);
		onlineTraningSchVO.setPoint(point);
		onlineTraningSchVO.setSearchKeyword(searchKeyword);
		
		List<OnlineTraningSchVO> onlineList = onlineTraningService.listOnlineTraningSubject(onlineTraningSchVO);
	...
	@RequestMapping(value = "/lu/online/popupOnlineTraningFile.do")
	public String popupOnlineTraningFile(@RequestParam Map<String, Object> commandMap, @ModelAttribute("frmFile") OnlineTraningWeekFileVO onlineTraningWeekFileVO, ModelMap model) throws Exception {
		
		//List<OnlineTraningWeekFileVO> resultList = onlineTraningService.listOnlineTraningWeekFile(onlineTraningWeekFileVO);
		List<OnlineTraningWeekFileVO> resultList = onlineTraningService.listOnlineTraningFile(onlineTraningWeekFileVO);
		model.addAttribute("resultList", resultList);
		
		model.addAttribute("onlineTraningWeekFileVO", onlineTraningWeekFileVO);
		// View호출
		return "oklms_popup/lu/online/popupOnlineTraningFile";
	}
	
	@RequestMapping(value = "/lu/online/popupOnlineTraningFileDown.do")
	public String popupOnlineTraningFileDown(@RequestParam Map<String, Object> commandMap, @ModelAttribute("frmFile") OnlineTraningWeekFileVO onlineTraningWeekFileVO, ModelMap model) throws Exception {
		...
		model.addAttribute("onlineTraningWeekFileVO", onlineTraningWeekFileVO);
		// View호출
		return "oklms_popup/lu/online/popupOnlineTraningFileDown";
	}
	
	
	
	@RequestMapping(value = "/lu/online/insertOnlineTraningFile.do")
	public String insertOnlineTraningFile(@ModelAttribute("frmFile") OnlineTraningWeekFileVO  onlineTraningWeekFileVO ,ModelMap model ,  RedirectAttributes redirectAttributes, final MultipartHttpServletRequest multiRequest) throws Exception {
		logger.debug("#### URL = /lu/online/insertOnlineTraningFile.do" );
		int insertCnt = 0;
		String retMsg="";
		LoginInfo loginInfo = new LoginInfo();
		loginInfo.getLoginInfo();
		loginInfo.putSessionToVo(onlineTraningWeekFileVO); // session의 정보를 VO에 추가.
		
		insertCnt = onlineTraningService.insertOnlineTraningFile(onlineTraningWeekFileVO,multiRequest);
		...
		//제출 
		return "redirect:/lu/online/popupOnlineTraningFile.do?weekId="+onlineTraningWeekFileVO.getWeekId();
	}
	
	@RequestMapping(value = "/lu/online/updateOnlineTraningFile.do")
	public String deleteOnlineTraningFile(@ModelAttribute("frmFile") OnlineTraningWeekFileVO  onlineTraningWeekFileVO ,ModelMap model ,  RedirectAttributes redirectAttributes, final MultipartHttpServletRequest multiRequest) throws Exception {
		logger.debug("#### URL = /lu/online/updateOnlineTraningFile.do" );
		int insertCnt = 0;
		String retMsg="";
		LoginInfo loginInfo = new LoginInfo();
		loginInfo.getLoginInfo();
		...
		insertCnt = onlineTraningService.updateOnlineTraningFile(onlineTraningWeekFileVO,multiRequest);
	...
	@RequestMapping(value = "/lu/online/popupOnlineTraningFileSave.json")
	public @ResponseBody Map<String, Object> popupOnlineTraningFileSave(@ModelAttribute("frmFile") OnlineTraningWeekFileVO onlineTraningWeekFileVO 
		...
		LOG.debug("#### URL = /lu/online/popupOnlineTraningFileSave.json" );
		
		int iResult = onlineTraningService.insertOnlineTraningWeekFile(onlineTraningWeekFileVO);
		
		if(iResult > 0){
			String fileSeq = onlineTraningService.getOnlineTraningWeekFileSeq(onlineTraningWeekFileVO);	
			returnMap.put("retCd", "10000");
			returnMap.put("fileSeq", fileSeq);
		} else {
			returnMap.put("retCd", "");
	...
	@RequestMapping(value = "/lu/online/popupOnlineTraningFileDelete.json")
	public @ResponseBody Map<String, Object> popupOnlineTraningFileDelete(@ModelAttribute("frmFile") OnlineTraningWeekFileVO onlineTraningWeekFileVO 
		,RedirectAttributes redirectAttributes
		,SessionStatus status
		,HttpServletRequest request
		,ModelMap model) throws Exception {
		...
		LOG.debug("#### URL = /lu/online/popupOnlineTraningFileDelete.json" );
		
		int iResult = onlineTraningService.deleteOnlineTraningWeekFile(onlineTraningWeekFileVO);
	...
	@RequestMapping(value = "/lu/online/popupOnlineTraningCmsInit.do")
	public String popupOnlineTraningCmsInit(@RequestParam Map<String, Object> commandMap, @ModelAttribute("frmPop") CmsCourseBaseVO cmsCourseBaseVO, ModelMap model) throws Exception {
		
		cmsCourseBaseVO.setOrderByCode(1);
		cmsCourseBaseVO.setAddURL("getCourseContentSummaryList");
		cmsIfxService.initCourseContentSummary(cmsCourseBaseVO);
			
		// View호출
		return "redirect:/lu/online/popupOnlineTraning.do";
	}
	...
	public @ResponseBody Map<String, Object>  insertOnlineWeekSchedule(@ModelAttribute("frmWeekSch") OnlineTraningWeekVO onlineTraningWeekVO
		...
		onlineTraningWeekVO.setYyyy(StringUtils.defaultIfBlank( onlineTraningWeekVO.getYyyy(),(String)httpSession.getAttribute(Globals.YYYY)));
		onlineTraningWeekVO.setTerm(StringUtils.defaultIfBlank( onlineTraningWeekVO.getTerm(),(String)httpSession.getAttribute(Globals.TERM)));
		onlineTraningWeekVO.setSubjectClass(StringUtils.defaultIfBlank( onlineTraningWeekVO.getSubjectClass(),(String)httpSession.getAttribute(Globals.CLASS)));
		onlineTraningWeekVO.setSubjectCode(StringUtils.defaultIfBlank( onlineTraningWeekVO.getSubjectCode(),(String)httpSession.getAttribute(Globals.SUBJECT_CODE)));
	...
	@RequestMapping(value = "/lu/online/saveOnlineTraningWeekSchedule.json")
	public @ResponseBody Map<String, Object>  saveOnlineTraningWeekSchedule(@ModelAttribute("frmWeekSch") OnlineTraningWeekVO onlineTraningWeekVO
			,RedirectAttributes redirectAttributes
			,SessionStatus status
			,HttpServletRequest request
			,ModelMap modelt) throws Exception {	
		...
		Map<String , Object> returnMap = new HashMap<String , Object>();
		LOG.debug("#### URL = /lu/online/saveOnlineTraningWeekSchedule.json" );
	...
	@RequestMapping(value = "/lu/online/updateOnlineTraningWeekSchedule.json")
	public @ResponseBody Map<String, Object>  updateOnlineTraningWeekSchedule(@ModelAttribute("frmWeekSch") OnlineTraningWeekVO onlineTraningWeekVO
			,RedirectAttributes redirectAttributes
			,SessionStatus status
			,HttpServletRequest request
			,ModelMap modelt) throws Exception {	
		...
		Map<String , Object> returnMap = new HashMap<String , Object>();
		LOG.debug("#### URL = /lu/online/updateOnlineTraningWeekSchedule.json" );
        ...
        int iResult = onlineTraningService.updateOnlineWeekSchedule(onlineTraningWeekVO);
	...
	@RequestMapping(value="/la/term/listOnlineTerm.do")
	public String listOnlineTerm(@ModelAttribute("frmStand") OnlineTraningVO onlineTraningVO, ModelMap model, HttpServletRequest request) throws Exception {
		
		logger.debug("#### URL = /la/term/listOnlineTerm.do" );
		LoginInfo loginInfo = new LoginInfo();
		loginInfo.getLoginInfo();
		loginInfo.putSessionToVo(onlineTraningVO); // session의 정보를 VO에 추가.
		
		/*if(onlineTraningVO.getYyyy()==null || onlineTraningVO.getYyyy().equals("")){
			// 현재 년도학기조회
			CommonCodeVO commonCodeVO =	commonCodeService.selectYearTerm();
			onlineTraningVO.setYyyy(StringUtils.defaultString(commonCodeVO.getYyyy(),""));				
		}*/
		
		
		OnlineTraningVO data = onlineTraningService.getTermOnStand(onlineTraningVO);
		model.addAttribute("onlineTraningVO", data);
		
		OnlineTraningWeekVO onlineTraningWeekVO = new OnlineTraningWeekVO();
		
		//if(data != null){
			onlineTraningWeekVO.setYyyy(onlineTraningVO.getYyyy());
			onlineTraningWeekVO.setTerm(onlineTraningVO.getTerm());
			onlineTraningWeekVO.setOnlineType(onlineTraningVO.getOnlineType());
			
			List <OnlineTraningWeekVO> resultList = onlineTraningService.listTermOnWeek(onlineTraningWeekVO);
			model.addAttribute("resultList", resultList);
		//}
		
		// View호출
		return "oklms/la/online/listOnlineTerm";
	}
	
	
	@RequestMapping(value="/la/term/saveOnlineTermStand.do")
	public String saveOnlineTermStand(@ModelAttribute("frmStand") OnlineTraningVO  onlineTraningVO ,ModelMap model ,  RedirectAttributes redirectAttributes , HttpServletRequest request) throws Exception {
		
		logger.debug("#### URL = /la/term/saveOnlineTermStand.do" );
		LoginInfo loginInfo = new LoginInfo();
		loginInfo.getLoginInfo();
		loginInfo.putSessionToVo(onlineTraningVO); // session의 정보를 VO에 추가.
		...
		insertCnt = onlineTraningService.saveTermOnStand(onlineTraningVO);
		...
		return "redirect:/la/term/listOnlineTerm.do?yyyy="+onlineTraningVO.getYyyy()+"&term="+onlineTraningVO.getTerm()+"&onlineType="+onlineTraningVO.getOnlineType();
	}
	
	@RequestMapping(value="/la/term/saveOnlineTermWeek.do")
	public String saveOnlineTermWeek(@ModelAttribute("frmStand") OnlineTraningWeekVO  onlineTraningWeekVO ,ModelMap model ,  RedirectAttributes redirectAttributes , HttpServletRequest request) throws Exception {
		
		logger.debug("#### URL = /la/term/saveOnlineTermWeek.do" );
		LoginInfo loginInfo = new LoginInfo();
		loginInfo.getLoginInfo();
		loginInfo.putSessionToVo(onlineTraningWeekVO); // session의 정보를 VO에 추가.
		
		int insertCnt = 0;
		String retMsg="";
		
		insertCnt = onlineTraningService.saveTermOnWeek(onlineTraningWeekVO);
		...
		return "redirect:/la/term/listOnlineTerm.do?yyyy="+onlineTraningWeekVO.getYyyy()+"&term="+onlineTraningWeekVO.getTerm()+"&onlineType="+onlineTraningWeekVO.getOnlineType();
	}
	
	@RequestMapping(value = "/la/online/mergeContent.json")
	public @ResponseBody Map<String, Object> mergeContent(@RequestParam Map<String, Object> commandMap, @ModelAttribute("frmTran") CmsCourseBaseVO cmsCourseBaseVO 
		,RedirectAttributes redirectAttributes
		,SessionStatus status
		,HttpServletRequest request
		,ModelMap model) throws Exception {
		...
		String retMsg = "";
		try {
			 onlineTraningService.mergeContent();
		   //JSONObject jsonObj = new JSONObject();
		   //jsonObj.put("result", data);
		   //retMsg = jsonObj.toString();
		 } catch (Exception e) {
