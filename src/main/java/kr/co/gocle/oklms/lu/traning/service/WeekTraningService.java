...
public interface WeekTraningService {
	...
	List<TraningNoteVO> getWeekTraningNoteSingCot(TraningNoteVO traningNoteVO) throws Exception;
	...
	int updateWeekTraningNoteCcnFile(TraningNoteVO traningNoteVO,final MultipartHttpServletRequest multiRequest) throws Exception;
	...
	List<TraningNoteVO> excelWeekTraningAttendCot(TraningNoteVO traningNoteVO) throws Exception;
	
	List<TraningNoteVO> excelWeekTraningAttendPrd(TraningNoteVO traningNoteVO) throws Exception;
}
