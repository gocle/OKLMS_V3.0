...
public class CurrProcServiceImpl extends EgovAbstractServiceImpl implements CurrProcService{
	...
	public int getSubjectCnt(CurrProcVO currProcVO) throws Exception {
  	...
  	@Override
	public int deleteCotMapping(CurrProcVO currProcVO) throws Exception {
		return currProcMapper.deleteCotMapping(currProcVO);
	}
  	...
  	@Override
	public List<CurrProcVO> listNotSubjectWeek(CurrProcVO currProcVO) throws Exception {
		List<CurrProcVO> data = currProcMapper.listNotSubjectWeek(currProcVO);
		return data;
	}
