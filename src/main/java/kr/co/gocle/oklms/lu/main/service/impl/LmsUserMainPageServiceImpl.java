...
/*    @Resource(name = "MemberStdMapper")
	...
	@Override
	public List<LmsUserMainPageVO> listLmsUserMainPageStdComplete(LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		LoginInfo loginInfo = new LoginInfo();
		loginInfo.putSessionToVo(lmsUserMainPageVO);
		// TODO Auto-generated method stub
		return lmsUserMainPageMapper.listLmsUserMainPageStdComplete(lmsUserMainPageVO);
	}
	...
	@Override
	public List<LmsUserMainPageVO> listLmsUserMainPageCcnNote(LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		// TODO Auto-generated method stub
		return lmsUserMainPageMapper.listLmsUserMainPageCcnNote(lmsUserMainPageVO);
	}
	
	@Override
	public List<LmsUserMainPageVO> listLmsUserMainPageCcnAct(LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		// TODO Auto-generated method stub
		return lmsUserMainPageMapper.listLmsUserMainPageCcnAct(lmsUserMainPageVO);
	}
	...
	@Override
	public List<LmsUserMainPageVO> listLmsUserMainPageCotTraningProcess(LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		// TODO Auto-generated method stub
		return lmsUserMainPageMapper.listLmsUserMainPageCotTraningProcess(lmsUserMainPageVO);
	}
	...
	@Override
	public List<LmsUserMainPageVO> listLmsUserMainPagePrtOffSchedule(	LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		// TODO Auto-generated method stub
		return lmsUserMainPageMapper.listLmsUserMainPagePrtOffSchedule(lmsUserMainPageVO);
	}
	
	@Override
	public List<LmsUserMainPageVO> listLmsUserMainPageCutMember(	LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		// TODO Auto-generated method stub
		return lmsUserMainPageMapper.listLmsUserMainPageCutMember(lmsUserMainPageVO);
	}
	
	
	@Override
	public int getNoteApplovalCnt(LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		int iResult = lmsUserMainPageMapper.getNoteApplovalCnt(lmsUserMainPageVO);
		return iResult;
	}
	
	@Override
	public int getActApplovalCnt(LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		int iResult = lmsUserMainPageMapper.getActApplovalCnt(lmsUserMainPageVO);
		return iResult;
	}
	...
	@Override
	public List<LmsUserMainPageVO> listSubjectCot(LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		// TODO Auto-generated method stub
		return lmsUserMainPageMapper.listSubjectCot(lmsUserMainPageVO);
	}
	
	@Override
	public List<LmsUserMainPageVO> listSubjectStd(LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		// TODO Auto-generated method stub
		return lmsUserMainPageMapper.listSubjectStd(lmsUserMainPageVO);
	}
	
	@Override
	public List<LmsUserMainPageVO> listSubjectStdOff(LmsUserMainPageVO lmsUserMainPageVO) throws Exception {
		// TODO Auto-generated method stub
		return lmsUserMainPageMapper.listSubjectStdOff(lmsUserMainPageVO);
	}
	...
	@Override
	public int getMemberAgreeYnCnt(String memSeq) throws Exception {
		int iResult = lmsUserMainPageMapper.getMemberAgreeYnCnt(memSeq);
		return iResult;
	}
	
	@Override
	public int updateMemberAgreeYn(String memSeq) throws Exception {
		int iResult = lmsUserMainPageMapper.updateMemberAgreeYn(memSeq);
		return iResult;
	}
