 ...
 *
 *******************************************************************************/
package kr.co.gocle.oklms.lu.planeval.service;
...
public interface PlanEvalService {
	...
	List<PlanEvalVO> listFistEvalPlanLessonAllMember(PlanEvalVO planEvalVO) throws Exception;
	...
	/**
	 * DB에서 1차평가 학습자별 취득점수 Data를 업데이트한다.
	 * @param planEvalVO
	 * @return
	 * int
	 */
	 ...
	 * List<PlanEvalVO>
	 */
	List<PlanEvalVO> listInsideEval(PlanEvalVO planEvalVO) throws Exception;
	
	/**
	 * DB에서 내부평가  Data를 조회한다.
	 * @param planEvalVO
	 * @return
	 * int
	 */
	int getInsideEvalCnt(PlanEvalVO planEvalVO) throws Exception;
	 ...
	 * PlanEvalVO
	 */
	PlanEvalVO getInsideEval(PlanEvalVO planEvalVO) throws Exception;
	
	/**
	 * DB에서 내부평가 Data를 추가하는 로직을 수행한다.
	 * @param planEvalVO
	 * @return
	 * int
	 */
	int insertInsideEval(PlanEvalVO planEvalVO,final MultipartHttpServletRequest multiRequest) throws Exception;
	
	
	/**
	 * DB에서 내부평가 Data를 업데이트한다.
	 * @param planEvalVO
	 * @return
	 * int
	 */
	int updateInsideEval(PlanEvalVO planEvalVO,final MultipartHttpServletRequest multiRequest) throws Exception;
	
	
	/**
	 * DB에서 내부평가 Data를 삭제한다.
	 * @param planEvalVO
	 * @return
	 * int
	 */
	int deleteInsideEval(PlanEvalVO planEvalVO) throws Exception;
	
	
	/**
	 * DB에서 내부평가 상태값 Data를 업데이트한다.
	 * @param planEvalVO
	 * @return
	 * int
	 */
	int updateStatusInsideEval(PlanEvalVO planEvalVO,final MultipartHttpServletRequest multiRequest) throws Exception;
	 ...
	 * List<PlanEvalVO>
	 */
	List<PlanEvalVO> listInsideEvalPrt(PlanEvalVO planEvalVO) throws Exception;
	 ...
	 * int
	 */
	int updateInsideEvalPrt(PlanEvalVO planEvalVO) throws Exception;
