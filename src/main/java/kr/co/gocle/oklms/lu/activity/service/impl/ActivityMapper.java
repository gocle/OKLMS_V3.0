...
public interface  ActivityMapper {
	 ...
	 * ActivityVO
	 */
	List<ActivityVO> getMyActivity(ActivityVO activityVO) throws Exception;
	
	List<ActivityVO> listOjtActivityApproval(ActivityVO activityVO) throws Exception;
	 ...
	 * String
	 */
	int saveActivity(ActivityVO activityVO) throws Exception;
	 ...
	 * String
	 */
	int approvalActivity(ActivityVO activityVO) throws Exception;
	 ...
	 * String
	 */ 
	int updateActivityHs(ActivityVO activityVO) throws Exception;
	...
	List<MemberVO>  listActivityOjtMember(MemberVO memberVO)  throws Exception;
	
	List<MemberVO>  listLessonMember(MemberVO memberVO)  throws Exception;
	...
	List<ActivityVO> listMonthActivityStd(ActivityVO activityVO) throws Exception;
	
	List<ActivityVO> listActivityCcn(ActivityVO activityVO) throws Exception;
