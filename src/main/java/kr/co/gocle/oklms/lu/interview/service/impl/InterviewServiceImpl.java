...
import kr.co.gocle.oklms.lu.interview.service.impl.InterviewMapper;
...
public class InterviewServiceImpl extends EgovAbstractServiceImpl implements InterviewService{
	...
	@Override
	public List<InterviewCompanyVO> InterviewTraningCompanys(InterviewCompanyVO interviewCompanyVO) throws Exception {
		// TODO Auto-generated method stub
		return interviewMapper.InterviewTraningCompanys(interviewCompanyVO);
	}
	...
	@Override
	public List<InterviewCompanyVO> listSearchCompanyTraning(InterviewCompanyVO interviewCompanyVO) throws Exception {
		// TODO Auto-generated method stub
		List<InterviewCompanyVO> data = interviewMapper.listSearchCompanyTraning(interviewCompanyVO);
		return data;
	}
	...
	@Override
	public String getInterviewCenterSendYn(InterviewVO interview) throws Exception {
		// TODO Auto-generated method stub
		String data = interviewMapper.getInterviewCenterSendYn(interview);
		return data;
	}
	
	@Override
	public String getInterviewCenterPreMonth(InterviewVO interview) throws Exception {
		// TODO Auto-generated method stub
		String data = interviewMapper.getInterviewCenterPreMonth(interview);
		return data;
	}
	
	@Override
	public String getInterviewCenterNxtMonth(InterviewVO interview) throws Exception {
		// TODO Auto-generated method stub
		String data = interviewMapper.getInterviewCenterNxtMonth(interview);
		return data;
	}
