package kr.co.gocle.oklms.lu.report.service;
...
public interface ReportService {
	...
	int getReportCnt(ReportVO reportVO,final MultipartHttpServletRequest multiRequest) throws Exception;
	/**
	 * 정보를 수정하는 SQL 을 호출한다.
	 * @param reportVO
	 * @return
	 ...
	 * String
	 */ 
	int updateReportWeek(ReportVO reportVO,final MultipartHttpServletRequest multiRequest) throws Exception;
	...
	List<ReportVO> listReportAllSubmit(ReportVO reportVO) throws Exception;	
	...
	int insertReportFeedBack(ReportVO reportVO,final MultipartHttpServletRequest multiRequest) throws Exception;

	int updateReportFeedBack(ReportVO reportVO,final MultipartHttpServletRequest multiRequest) throws Exception;
