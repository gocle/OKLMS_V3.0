 ...
 *
 *******************************************************************************/
package kr.co.gocle.oklms.lu.main.vo;
...
public class LmsUserMainPageVO extends BaseVO implements Serializable{
	...
	private String weekMobileNotCnt;
	private String activityCnt;
	private String reportCnt;
	private String ojtAttendCnt;
	private String traningProcessName;
	private String year;
	private String memName;
	private String memId;
	private String maxWeekNoteCnt;
	private String maxWeekActCnt;
	private String evalMStatus;
	private String evalFStatus;
	private String onProgressRate;
	private String tutHpNos; 	
	private String noteOrderValue;
	private String noteOrderType;
	private String noteSearchKeyword;
	private String actOrderValue;
	private String actOrderType;
	private String actSearchKeyword;
	private String subjectGrade;
	private String cutCnt;
	private String hpNo;
	private String searchTab;
	private String gradNm;
	private String atnDay;
	...
	public String getLteDay() {
		return lteDay;
	}

	public void setLteDay(String lteDay) {
		this.lteDay = lteDay;
	}
	...
	public String getAtnDay() {
		return atnDay;
	}

	public void setAtnDay(String atnDay) {
		this.atnDay = atnDay;
	}
	...
	public String getCutCnt() {
		return cutCnt;
	}

	public void setCutCnt(String cutCnt) {
		this.cutCnt = cutCnt;
	}
	...
	public String getNoteOrderValue() {
		return noteOrderValue;
	}

	public void setNoteOrderValue(String noteOrderValue) {
		this.noteOrderValue = noteOrderValue;
	}

	public String getNoteOrderType() {
		return noteOrderType;
	}

	public void setNoteOrderType(String noteOrderType) {
		this.noteOrderType = noteOrderType;
	}
	...
	public String getActOrderValue() {
		return actOrderValue;
	}

	public void setActOrderValue(String actOrderValue) {
		this.actOrderValue = actOrderValue;
	}

	public String getActOrderType() {
		return actOrderType;
	}

	public void setActOrderType(String actOrderType) {
		this.actOrderType = actOrderType;
	}

	public String getActSearchKeyword() {
		return actSearchKeyword;
	}

	public void setActSearchKeyword(String actSearchKeyword) {
		this.actSearchKeyword = actSearchKeyword;
	}
	
	public String getTutHpNos() {
		return tutHpNos;
	}

	public void setTutHpNos(String tutHpNos) {
		this.tutHpNos = tutHpNos;
	}

	public String getOnProgressRate() {
		return onProgressRate;
	}

	public void setOnProgressRate(String onProgressRate) {
		this.onProgressRate = onProgressRate;
	}

	public String getMaxWeekNoteCnt() {
		return maxWeekNoteCnt;
	}

	public void setMaxWeekNoteCnt(String maxWeekNoteCnt) {
		this.maxWeekNoteCnt = maxWeekNoteCnt;
	}

	public String getMaxWeekActCnt() {
		return maxWeekActCnt;
	}

	public void setMaxWeekActCnt(String maxWeekActCnt) {
		this.maxWeekActCnt = maxWeekActCnt;
	}
	
	public String getEvalMStatus() {
		return evalMStatus;
	}

	public void setEvalMStatus(String evalMStatus) {
		this.evalMStatus = evalMStatus;
	}

	public String getEvalFStatus() {
		return evalFStatus;
	}

	public void setEvalFStatus(String evalFStatus) {
		this.evalFStatus = evalFStatus;
	}
	...
	public String getOjtAttendCnt() {
		return ojtAttendCnt;
	}

	public void setOjtAttendCnt(String ojtAttendCnt) {
		this.ojtAttendCnt = ojtAttendCnt;
	}
	...
	public String getWeekMobileNotCnt() {
		return weekMobileNotCnt;
	}

	public void setWeekMobileNotCnt(String weekMobileNotCnt) {
		this.weekMobileNotCnt = weekMobileNotCnt;
	}
