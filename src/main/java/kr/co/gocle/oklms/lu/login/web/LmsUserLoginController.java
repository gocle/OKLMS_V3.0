 ...
 *
 *******************************************************************************/
package kr.co.gocle.oklms.lu.login.web;
 ...
 */
@Controller
public class LmsUserLoginController extends BaseController{
	...
	@RequestMapping(value = { "/lu/login/goLmsUserLogin.do" })
	public String goLmsUserLogin(HttpServletRequest request, @RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
    	...
    	* 초기값 셋팅 영역
    	====================================================================*/
		String reqUri = StringUtils.defaultIfBlank( (String)commandMap.get("reqUri") , "/lu/main/lmsUserMainPage.do" );
		...
		*/
		...
		returnPage = "oklms_body/lu/login/lmsUserLogin";
		return returnPage;
	}
