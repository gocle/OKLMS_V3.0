...
//import kr.co.gocle.oklms.lu.mail.service.MailService;
//import kr.co.gocle.oklms.lu.mail.vo.MailVO;
...
public class MemberStdServiceImpl extends EgovAbstractServiceImpl implements MemberStdService {
	...
	@Override
	public List<ExcelMemberStdVO> listCompanyMemberStd(ExcelMemberStdVO memberStdVO) throws Exception {
		List<ExcelMemberStdVO> data = memberStdMapper.listCompanyMemberStd(memberStdVO);
		return data;
	}
...
/*						if ("".equals(memberStdVO.getCompanyName())) {
	...
	@Override
	public int deleteMember1(ExcelMemberStdVO memberStdVO) throws Exception {
		...
		sqlResultInt = memberStdMapper.deleteMember1(memberStdVO);
	...
	@Override
	public List<MemberSearchVO> listSearchMemberId(MemberSearchVO memberVO) throws Exception {
		// TODO Auto-generated method stub
		return memberStdMapper.listSearchMemberId(memberVO);
	}
	
	@Override
	public MemberSearchVO getSearchMemberId(MemberSearchVO memberVO) throws Exception {
		// TODO Auto-generated method stub
		return memberStdMapper.getSearchMemberId(memberVO);
	}
	
	@Override
	public int updateMemberPassword(MemberSearchVO memberVO) throws Exception {
		// TODO Auto-generated method stub
		return memberStdMapper.updateMemberPassword(memberVO);
	}

	@Override
	public MemberSearchVO getMemberInfo(MemberSearchVO memberVO) throws Exception {
		// TODO Auto-generated method stub
		return memberStdMapper.getMemberInfo(memberVO);
	}
