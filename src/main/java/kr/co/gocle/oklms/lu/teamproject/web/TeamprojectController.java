package kr.co.gocle.oklms.lu.teamproject.web;
...
//		LoginVO loginVO = (LoginVO) loginInfo.getLoginInfo();
	...
	@RequestMapping(value = "/lu/teamproject/updateTeamprojectInfo.do")
	public String updateTeamprojectInfo(@ModelAttribute("frmTeamproject") TeamprojectVO teamprojectVO, ModelMap model, final MultipartHttpServletRequest multiRequest) throws Exception {

		LOG.debug("#### URL = /lu/teamproject/updateTeamprojectInfo.do");
		// 세션자동복사
		LoginInfo loginInfo = new LoginInfo();
//		LoginVO loginVO = (LoginVO) loginInfo.getLoginInfo();
		loginInfo.putSessionToVo(teamprojectVO); // session의 정보를 VO에 추가.
		teamprojectService.updateTeamprojectInfo(teamprojectVO, multiRequest);
		// View호출
		return "redirect:/lu/teamproject/listTeamproject.do";
	}
