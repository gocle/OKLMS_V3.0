package kr.co.gocle.oklms.lu.teamproject.service;
...
public interface TeamprojectService {
	 ...
	 * String
	 */ 
	int updateTeamprojectInfo(TeamprojectVO teamprojectVO,final MultipartHttpServletRequest multiRequest) throws Exception;
