...
public interface TraningService {
	 ...
	 * String
	 */
	String insertTraningBatchScheduleExcel(TraningScheduleVO traningScheduleVO, MultipartHttpServletRequest multiRequest,HttpServletRequest request) throws Exception;
	...
	int saveTraningPrt(TraningVO traningVO) throws Exception;
	...
	int saveTraningCcn(TraningVO traningVO) throws Exception;
