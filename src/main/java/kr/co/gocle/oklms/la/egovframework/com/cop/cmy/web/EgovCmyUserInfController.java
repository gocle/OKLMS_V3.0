...
public class EgovCmyUserInfController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/selectCmmntyUserList.do")
	public String selectCmmntyUserList(@ModelAttribute("searchVO") UserInfVO userVO,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/selectCmmntyMngrList.do")
	public String selectCmmntyMngrList(@ModelAttribute("searchVO") UserInfVO userVO,
			@RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/selectClubOprtrList.do")
	public String selectClubOprtrList(@ModelAttribute("searchVO") UserInfVO userVO, @RequestParam Map<String, Object> commandMap,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/selectClubUserList.do")
	public String selectClubUserList(@ModelAttribute("searchVO") UserInfVO userVO, @RequestParam Map<String, Object> commandMap,
			ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/deleteCmmntyUser.do")
	public String deleteCmmntyUser(@ModelAttribute("searchVO") UserInfVO userVO, @RequestParam Map<String, Object> commandMap,
			ModelMap model) throws Exception {
		...
		return "forward:/la/cop/com/selectCmmntyUserList.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/reRegistCmmntyUser.do")
	public String reRegisterCmmntyUser(@ModelAttribute("searchVO") UserInfVO userVO,
			@RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/registCmmntyManager.do")
	public String registCmmntyManager(@ModelAttribute("searchVO") UserInfVO userVO, @RequestParam Map<String, Object> commandMap,
			ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/deleteClbUser.do")
	public String deleteClbUser(@ModelAttribute("searchVO") UserInfVO userVO, @RequestParam Map<String, Object> commandMap,
			ModelMap model) throws Exception {
		...
		return "forward:/la/cop/com/selectClubUserList.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/reRegistClbUser.do")
	public String reRegistClbUser(@ModelAttribute("searchVO") UserInfVO userVO, @RequestParam Map<String, Object> commandMap,
			ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/registClbOprtr.do")
	public String registClbOprtr(@ModelAttribute("searchVO") UserInfVO userVO, @RequestParam Map<String, Object> commandMap,
			ModelMap model) throws Exception {
