...
public class EgovCmyBBSUseInfoManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/updateBBSUseInfByTrget.do")
	public String updateBBSUseInfByTrget(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO,
		...
		return "forward:/la/cop/com/selectCmyBBSUseInfsByTrget.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/selectCmyBBSUseInfsByTrget.do")
	public String selectBBSUseInfsByTrget(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/com/EgovBdUseInfListByTrget";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/insertBBSUseInfByTrget.do")
