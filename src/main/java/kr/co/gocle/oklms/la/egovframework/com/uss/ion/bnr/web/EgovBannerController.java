...
package kr.co.gocle.oklms.la.egovframework.com.uss.ion.bnr.web;
...
import kr.co.gocle.oklms.la.comcode.service.ComcodeService;
import kr.co.gocle.oklms.la.comcode.vo.ComcodeVO;
...
public class EgovBannerController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/la/banner/selectBanner.do")
    public String selectBannerListView() throws Exception {

        return "oklms/la/egovframework/com/uss/ion/bnr/EgovBannerList";
    }
    ...
    @RequestMapping(value="/la/banner/listBanner.do")
	public String selectBannerList(@ModelAttribute("bannerVO") BannerVO bannerVO,
                             		ModelMap model) throws Exception{

    	ComcodeVO ccVO = new ComcodeVO();
		ccVO.setSearchCodeGroup("BANNER_TYPE");
		List<ComcodeVO> ccBannerTypeList = comcodeService.listComcode(ccVO);
		model.addAttribute("ccBannerTypeList", ccBannerTypeList);
    	/** paging */
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/la/banner/getBanner.do")
	public String selectBanner(@RequestParam("bannerId") String bannerId,
    	...
    	model.addAttribute("message", egovMessageSource.getMessage("success.common.select"));
    	return "oklms/la/egovframework/com/uss/ion/bnr/EgovBannerUpdt";
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/la/banner/goInsertBanner.do")
	public String insertViewBanner(@ModelAttribute("bannerVO") BannerVO bannerVO,
    	...
    	return "oklms/la/egovframework/com/uss/ion/bnr/EgovBannerRegist";
	}
	...
	@RequestMapping(value="/la/banner/addBanner.do")
...
//	    	return "egovframework/com/uss/ion/bnr/EgovBannerUpdt";
			return "forward:/la/banner/listBanner.do";
	 ...
	 */
    @SuppressWarnings("unused")
	@RequestMapping(value="/la/banner/updateBanner.do")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/la/banner/deleteBanner.do")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/la/banner/deleteAllBanner.do")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/la/banner/getImageBanner.do")
	public String selectBannerResult(@ModelAttribute("bannerVO") BannerVO bannerVO,
		...
		return "oklms/la/egovframework/com/uss/ion/bnr/EgovBannerView";
	}
    ...
    @RequestMapping(value="/la/banner/listMainBanner.do")
	public String selectBannerMainList(@ModelAttribute("bannerVO") BannerVO bannerVO,
		...
		return "oklms/la/egovframework/com/uss/ion/bnr/EgovBannerMainList";
	}
}
