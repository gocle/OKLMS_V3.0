 ...
 *
 *******************************************************************************/ 
package kr.co.gocle.oklms.la.member.vo;
...
public class MemberVO extends BaseVO implements Serializable{
	...
	/*
	 * message.properties 명명 규칙
	 * 		- {ValidationClass}.{modelObjectName}.{field} : 인경우 Annotation의 파라미터 명을 message.propertis에서 쓰면 jsp에서는 오류가 발생함.
	 * 		- 사용자_구분자.{modelObjectName}.{field}
	 *      - modelObjectName 값은 JSP 화면에서 '<form:form commandName="{modelObjectName}">' 형태로 사용되어지는 값이다.
	 *      - 예) Size.protoBoardVO.prototypeTitle=제목을 입력하세요(messg)필드명::{0} , 최소::{2} , 최대::{1}
	...
	|                  , short, int, long and primitive type
	|				  에 대한 wrappers 해당 속성이 가질 수  
	|				  있는 최대값을 체크한다. 				
    | @DecimalMin 	| BigDecimal, BigInteger, String, byte  | 해당 속성이 가질 수 있는 최소값을 체크한다. 		@DecimalMin(value=) |
	|				  , short, int, long and primitive type 
	|				  에 대한 wrappers 						
    | @Digits 		| BigDecimal, BigInteger, String, byte  | 해당 속성이 가질 수 있는 정수부의 자리수와 소수부의 자리수를 체크한다. @Digits(integer=,fraction=) |
	|				  , short, int, long and primitive type 
	|				  에 대한 wrappers 						 
    | @Future 		| java.util.Date, java.util.Calendar 	| 해당 속성의 값이 현재일 이후인지 체크한다. 		|
    | @Max 			| BigDecimal, BigInteger, String, byte  | 해당 속성이 가질 수 있는 최대 Length를 체크한다. @Max(value)	|
	|				  , short, int, long and primitive type 
	|				  에 대한 wrappers 						 
    | @Min 			| BigDecimal, BigInteger, String, byte  | 해당 속성이 가질 수 있는 최소 Length를 체크한다. 	@Min(value) |
	|				  , short, int, long and primitive type 
	|				  에 대한 wrappers 						 
    ...
    | @Pattern 		| String 								| 해당 속성의 값이 정의된 Regular Expression에 부합하는지 체크한다. Regular Expression은 Java Regular Expression Convention(see java.util.regex.Pattern)에 맞게 정의해야 한다. @Pattern(regex=, flag=)|
    | @Size 		| String, Collection, Map and arrays 	| 해당 속성이 가질 수 있는 최대, 최소 Length를 체크한다. @Size(min=, max=) |
    | @Valid 		| any non primitive type 				| 해당 객체에 대해 Validation Check가 이루어진다. |
	*/
	/*
	 * 		prototypeTitle ==>> VO클레스 @Annotation의 message에 선언하지 않고 message.properties도 잘못 선언한 경우 : Size @Annotation 기본 영문 메시지 + {2} + {1}
		prototypeContents1 ==>> VO클레스 @Annotation의 message에 message.properties 호출 key값을 잘못 선언하고 message.properties에는 올바르게 선언한 경우.
		prototypeContents2 ==>> VO클레스 @Annotation의 message에 직접 메시지를 선언한 경우(message.properties에도 선언 함) : message.properties 선언이 우선 적용됨.
		prototypeContents3 ==>> VO클레스 @Annotation의 message에 message.properties 호출 key값을 올바르게 선언한 경우.
		prototypeContents4 ==>> VO클레스 @Annotation의 message에 직접 메시지를 선언한 경우(message.properties에는 선언 안함). 변수값 호출 방식 : VO에 선언한 message 가 적용됨.
				  제목         size must be between 1 and 100 
		  내용1     내용1을 입력하세요.(messg)(최소:1 , 최대:4,000 , 메시지:prototypeContents1) 
		  내용2     내용2을 입력하세요.(messg)(최소:1 , 최대:2,000 , 메시지:prototypeContents2) 
		  내용3     내용3을 입력하세요.(messg)(최소:1 , 최대:4,000 , 메시지:prototypeContents3) 
		  내용4     내용4을 입력하세요.(messg)(최소___:1 , 최대___:2000) / prototypeContents4 , 2,000 , 1
				  @Size(min = 1, max = 100)
		  private String prototypeTitle; // 선언하지 않은 경우 : Size @Annotation 기본 영문 메시지 + {2} + {1}
		  @Size(min = 1, max = 4000, message="{ValidationMsg.protoBoardVO.prototypeContents1}")
		  private String prototypeContents1; // @Annotation의 message에 message.properties 호출 key값을 잘못 선언하고 message.properties에는 올바르게 선언한 경우.
		  @Size(min = 1, max = 2000, message="내용2을 입력하세요.(messg)(최소_:{min} , 최대_:{max})")
		  private String prototypeContents2; // @Annotation의 message에 직접 메시지를 선언한 경우.
		
		  @Size(min = 1, max = 4000, message="{Size.protoBoardVO.prototypeContents3}")
		  private String prototypeContents3; // @Annotation의 message에 message.properties 호출 key값을 올바르게 선언한 경우.
		  @Size(min = 1, max = 2000, message="내용4을 입력하세요.(messg)(최소___:{min} , 최대___:{max}) / {0} , {1} , {2}")
		  private String prototypeContents4; // @Annotation의 message에 직접 메시지를 선언한 경우. 변수값 호출 방식
				  protoBoardVO.prototypeTitle=제목을 입력하세요(messg)(최소:{2} , 최대:{1})
		  Size.protoBoardVO.prototypeContents1=내용1을 입력하세요.(messg)(최소:{2} , 최대:{1} , 메시지:{0})
		  Size.protoBoardVO.prototypeContents2=내용2을 입력하세요.(messg)(최소:{2} , 최대:{1} , 메시지:{0})
		
		  Size.protoBoardVO.prototypeContents3=내용3을 입력하세요.(messg)(최소:{2} , 최대:{1} , 메시지:{0})
		  #Size.protoBoardVO.prototypeContents4=내용4을 입력하세요.(messg)(최소:{2} , 최대:{1} , 메시지:{0})
				  <form:form commandName="protoBoardVO">
		      <tr><td>제목</td><td><input type="text" id="prototypeTitle"       name="prototypeTitle"   value="${prototypeTitle}" />            <form:errors path="prototypeTitle" /></td>      </tr>
		      <tr><td>내용1</td><td><input type="text" id="prototypeContents1"  name="prototypeContents1"   value="${prototypeContents1}" />    <form:errors path="prototypeContents1" /></td>  </tr>
		      <tr><td>내용2</td><td><input type="text" id="prototypeContents2"  name="prototypeContents2"  value="${prototypeContents2}" />    <form:errors path="prototypeContents2" /></td>   </tr>
		
		      <tr><td>내용3</td><td><input type="text" id="prototypeContents3"  name="prototypeContents3"   value="${prototypeContents3}" />    <form:errors path="prototypeContents3" /></td>  </tr>
		      <tr><td>내용4</td><td><input type="text" id="prototypeContents4"  name="prototypeContents4"  value="${prototypeContents4}" />    <form:errors path="prototypeContents4" /></td>   </tr>
	 */
	//============================================================
	// 주민번호 삭제에 따른 추가
	@NotNull
	...
	/* 담당자변경 관련 항목 */
	private String relatedOrgName; //관련연구 기관명
...
//	private java.sql.Date searchUseExpireYmd;
	...
	private String[] memSeqss;				  //회원 고유번호  
	...
	private String nowDtInsFlag = "";
	private String deptNo = "";
	private String deptNm = "";
	
	private String [] authGroupIds;
	
	private String etcGrade1 = "";
	private String etcGrade2 = "";
	private String etcGrade3 = "";
	private String bigo1 = "";
	private String bigo2 = "";
	private String subjectClass = "";
	private String dutyNm = "";
	private String [] etcGrade1s;
	private String [] etcGrade2s;
	private String [] etcGrade3s;
	private String [] bigo1s; 
	private String [] bigo2s;
	...
	private String outEvalNcsName;
	private String outEvalPassYn;
	private String outEvalPassDate;
	private String stdTransferYn;
	private String outEvalNcsTime;
	private String stdHakStatus;
	private String stdLeaveDate;
	private String stdComplDate;
	private String stdGoyongDate;
	private String stdCompTelNo;
	private String traningProcessName;
	private String traningProcessPeriod;
	private String startDate;
	private String endDate;
	private String ojtClass;
	private String stdCompOutDate;
	private String gradDt;
	private String extDt;
	private String sknrgsSttusNm;
	private String ccnNames;
	private String outEvalNcsYn;
	private String outEvalProgressYn;
	private String offGoal;
	private String offCompl;
	private String ojtGoal;
	private String ojtCompl;
	private String ncsGoal;
	private String ncsCompl;
	private String traningProcessId;
	private String stdTraningYear;
	private String hp;
	...
	public String getOjtYn() {
		return ojtYn;
	}
	public void setOjtYn(String ojtYn) {
		this.ojtYn = ojtYn;
	}
	public String getHp() {
		return hp;
	...
	public String getStdTraningYear() {
		return stdTraningYear;
	}
	public void setStdTraningYear(String stdTraningYear) {
		this.stdTraningYear = stdTraningYear;
	}
	...
	public String getOffCompl() {
		return offCompl;
	}
	public void setOffCompl(String offCompl) {
		this.offCompl = offCompl;
	}
	public String getOjtGoal() {
		return ojtGoal;
	}
	public void setOjtGoal(String ojtGoal) {
		this.ojtGoal = ojtGoal;
	}
	public String getOjtCompl() {
		return ojtCompl;
	}
	public void setOjtCompl(String ojtCompl) {
		this.ojtCompl = ojtCompl;
	}
	public String getNcsGoal() {
		return ncsGoal;
	}
	public void setNcsGoal(String ncsGoal) {
		this.ncsGoal = ncsGoal;
	}
	public String getNcsCompl() {
		return ncsCompl;
	}
	public void setNcsCompl(String ncsCompl) {
		this.ncsCompl = ncsCompl;
	}
	...
	public String getCompAddressDtl() {
		return compAddressDtl;
	}
	public void setCompAddressDtl(String compAddressDtl) {
		this.compAddressDtl = compAddressDtl;
	}
	
	public String getOutEvalNcsYn() {
		return outEvalNcsYn;
	}
	public void setOutEvalNcsYn(String outEvalNcsYn) {
		this.outEvalNcsYn = outEvalNcsYn;
	}
	public String getOutEvalProgressYn() {
		return outEvalProgressYn;
	}
	public void setOutEvalProgressYn(String outEvalProgressYn) {
		this.outEvalProgressYn = outEvalProgressYn;
	}
	...
	public String getSknrgsSttusNm() {
		return sknrgsSttusNm;
	}
	public void setSknrgsSttusNm(String sknrgsSttusNm) {
		this.sknrgsSttusNm = sknrgsSttusNm;
	}
	
	public String getStdCompOutDate() {
		return stdCompOutDate;
	}
	public void setStdCompOutDate(String stdCompOutDate) {
		this.stdCompOutDate = stdCompOutDate;
	}
	...
	public String getStdGoyongDate() {
		return stdGoyongDate;
	}
	public void setStdGoyongDate(String stdGoyongDate) {
		this.stdGoyongDate = stdGoyongDate;
	}
	public String getStdCompTelNo() {
		return stdCompTelNo;
	}
	public void setStdCompTelNo(String stdCompTelNo) {
		this.stdCompTelNo = stdCompTelNo;
	}
	...
	public String getOutEvalNcsName() {
		return outEvalNcsName;
	}
	public void setOutEvalNcsName(String outEvalNcsName) {
		this.outEvalNcsName = outEvalNcsName;
	}
	public String getOutEvalPassYn() {
		return outEvalPassYn;
	}
	public void setOutEvalPassYn(String outEvalPassYn) {
		this.outEvalPassYn = outEvalPassYn;
	}
	public String getOutEvalPassDate() {
		return outEvalPassDate;
	}
	public void setOutEvalPassDate(String outEvalPassDate) {
		this.outEvalPassDate = outEvalPassDate;
	}
	public String getStdTransferYn() {
		return stdTransferYn;
	}
	public void setStdTransferYn(String stdTransferYn) {
		this.stdTransferYn = stdTransferYn;
	}
	public String getOutEvalNcsTime() {
		return outEvalNcsTime;
	}
	public void setOutEvalNcsTime(String outEvalNcsTime) {
		this.outEvalNcsTime = outEvalNcsTime;
	}
	public String getStdHakStatus() {
		return stdHakStatus;
	}
	public void setStdHakStatus(String stdHakStatus) {
		this.stdHakStatus = stdHakStatus;
	}
	public String getStdLeaveDate() {
		return stdLeaveDate;
	}
	public void setStdLeaveDate(String stdLeaveDate) {
		this.stdLeaveDate = stdLeaveDate;
	}
	public String getStdComplDate() {
		return stdComplDate;
	}
	public void setStdComplDate(String stdComplDate) {
		this.stdComplDate = stdComplDate;
	}
	...
	public String[] getEtcGrade1s() {
		return etcGrade1s;
	}
	public void setEtcGrade1s(String[] etcGrade1s) {
		this.etcGrade1s = etcGrade1s;
	}
	public String[] getEtcGrade2s() {
		return etcGrade2s;
	}
	public void setEtcGrade2s(String[] etcGrade2s) {
		this.etcGrade2s = etcGrade2s;
	}
	public String[] getEtcGrade3s() {
		return etcGrade3s;
	}
	public void setEtcGrade3s(String[] etcGrade3s) {
		this.etcGrade3s = etcGrade3s;
	}
	public String[] getBigo1s() {
		return bigo1s;
	}
	public void setBigo1s(String[] bigo1s) {
		this.bigo1s = bigo1s;
	}
	public String[] getBigo2s() {
		return bigo2s;
	}
	public void setBigo2s(String[] bigo2s) {
		this.bigo2s = bigo2s;
	}
	...
	public String getEtcGrade1() {
		return etcGrade1;
	}
	public void setEtcGrade1(String etcGrade1) {
		this.etcGrade1 = etcGrade1;
	}
	public String getEtcGrade2() {
		return etcGrade2;
	}
	public void setEtcGrade2(String etcGrade2) {
		this.etcGrade2 = etcGrade2;
	}
	public String getEtcGrade3() {
		return etcGrade3;
	}
	public void setEtcGrade3(String etcGrade3) {
		this.etcGrade3 = etcGrade3;
	}
	...
	public String getNowDtInsFlag() {
		return nowDtInsFlag;
	}
	public void setNowDtInsFlag(String nowDtInsFlag) {
		this.nowDtInsFlag = nowDtInsFlag;
	}
	public String getRelatedOrgName() {
		return relatedOrgName;
	}
	public void setRelatedOrgName(
			String relatedOrgName) {
	...
	public String[] getMemSeqss() {
		return memSeqss;
	}
	public void setMemSeqss(String[] memSeqss) {
		this.memSeqss = memSeqss;
	}
	...
	public String getEncryptShaPw(){
		return SecurityUtil.encryptSha256(memPasswordEncript);
	}
	
	public String getEncryptShaPwDefault(){
		return SecurityUtil.encryptSha256("1111");
	}
