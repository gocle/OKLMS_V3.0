package kr.co.gocle.oklms.la.egovframework.com.cop.clb.web;
...
public class EgovClubManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/selectClubInfs.do")
	public String selectClubInfs(@ModelAttribute("searchVO") ClubVO clubVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/addClubInf.do")
	public String addClubInf(@ModelAttribute("searchVO") ClubVO clubVO, ModelMap model) throws Exception {
		return "oklms/la/egovframework/com/cop/clb/EgovClubRegist";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/insertClubInf.do")
	public String insertClubInf(@ModelAttribute("searchVO") ClubVO clubVO, @ModelAttribute("club") Club club,
		...
		return "forward:/la/cop/clb/selectClubInfs.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/selectClubInf.do")
	public String selectClubInf(@ModelAttribute("searchVO") ClubVO clubVO, ModelMap model, HttpServletRequest request)
			throws Exception {
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubInqire";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/forUpdateClbInf.do")
	public String forUpdateClbInf(@ModelAttribute("searchVO") ClubVO clubVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubUpdt";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/updateClbInf.do")
	public String updateClbInf(@ModelAttribute("searchVO") ClubVO clubVO, @ModelAttribute("club") Club club,
			BindingResult bindingResult, SessionStatus status, ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/selectClubInfByCmmntyId.do")
	public String selectClubInfByCmmntyId(@ModelAttribute("searchVO") ClubVO clubVO,
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubListByCmmntyId";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/insertClubUserBySelf.do")
	public String insertClubUserBySelf(@ModelAttribute("clubUser") ClubUser clubUser, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubMsg";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cus/ClubMainPage.do")
	public String selectClubMainPage(@ModelAttribute("searchVO") ClubVO clubVO, @RequestParam Map<String, Object> commandMap,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cus/ClubMainContents.do")
	public String selectClubMainContents(@ModelAttribute("searchVO") ClubVO clubVO, @RequestParam Map<String, Object> commandMap,
			ModelMap model) throws Exception {
		LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		...
		return "oklms/la/egovframework/com/cop/tpl/EgovClbBaseTmplContents";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/addCmmntyClubInf.do")
	public String addCmmntyClubInf(@ModelAttribute("searchVO") ClubVO clubVO, ModelMap model) throws Exception {
		/*
		 * ClubVO vo = new ClubVO(); vo = (ClubVO)clubService.selectCmmntyInfByClbId(clubVO);
		 */

		model.addAttribute("clubVO", clubVO);

		return "oklms/la/egovframework/com/cop/clb/EgovClubRegistByTrget";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/selectCmmntyClubInf.do")
	public String selectCmmntyClubInf(@ModelAttribute("searchVO") ClubVO clubVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubInqireByTrget";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/forUpdateCmmntyClbInf.do")
	public String forUpdateCmmntyClbInf(@ModelAttribute("searchVO") ClubVO clubVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubUpdtByTrget";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cus/ClubListPortlet.do")
	public String selectClubListPortlet(@ModelAttribute("searchVO") Club club, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubListPortlet";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/selectAllClubByTrget.do")
	public String selectAllClubByTrget(@ModelAttribute("club") Club club, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubListPortletByTrget";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/selectClubInfsByPop.do")
	public String selectClubtyInfsByPop(@ModelAttribute("searchVO") ClubVO clubVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubListPop";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/deleteClubUserBySelf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cus/previewClubMainPage.do")
	public String preivewClubMainPage(@ModelAttribute("searchVO") ClubVO clubVO, @RequestParam Map<String, Object> commandMap,
			ModelMap model) throws Exception {
		LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cus/previewClubMainContents.do")
	public String previewClubMainContents(@ModelAttribute("searchVO") ClubVO clubVO,
			@RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
		LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		@SuppressWarnings("unused")
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
