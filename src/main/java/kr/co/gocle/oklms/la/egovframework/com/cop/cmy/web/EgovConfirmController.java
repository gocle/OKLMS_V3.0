...
public class EgovConfirmController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/selectConfirmRequest.do")
	public String selectConfirmRequest(@ModelAttribute("searchVO") ConfirmHistoryVO historyVO, SessionStatus status,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/forUpdateConfirmRequest.do")
	public String forUpdateConfirmRequest(@ModelAttribute("searchVO") ConfirmHistoryVO historyVO, SessionStatus status,
			ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/com/EgovConfmInfUpdt";
	}
