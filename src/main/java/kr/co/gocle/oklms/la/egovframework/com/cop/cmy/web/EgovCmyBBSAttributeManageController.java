...
public class EgovCmyBBSAttributeManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/bbs/insertBdMstrByTrget.do")
	public String insertBdMstrByTrget(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO,
		...
		if (bindingResult.hasErrors()) {
			...
			return "oklms/la/egovframework/com/cop/bbs/EgovBdMstrRegistByTrget";
		}
		...
		return "forward:/la/cop/bbs/selectBdMstrListByTrget.do";
	}
	...
	@RequestMapping("/la/cop/bbs/SelectBBSMasterInfByTrget.do")
	public String selectBBSMasterInfByTrget(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO,
		...
		return "oklms/la/egovframework/com/cop/bbs/EgovBdMstrUpdtByTrget";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/bbs/selectBdMstrListByTrget.do")
	public String selectBdMstrListByTrget(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO, ModelMap model)
		...
		return "oklms/la/egovframework/com/cop/bbs/EgovBBSListByTrget";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/bbs/updateBBSMasterInfByTrget.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/bbs/addBBSMasterByTrget.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/bbs/deleteBBSMasterInfByTrget.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/bbs/selectAllBdMstrByTrget.do")
	public String selectAllBdMstrByTrget(@RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/bbs/EgovBdListPortlet";
	}
