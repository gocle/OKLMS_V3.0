...
public class EgovCmyConfirmController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/updateConfirmRequest.do")
	public String updateConfirmRequest(@ModelAttribute("history") ConfirmHistory history, SessionStatus status, ModelMap model)
			throws Exception {
		...
		if ("".equals(history.getTrgetId())) {
			return "forward:/la/cop/com/selectConfirmRequest.do";
		} else {
			return "forward:/la/cop/com/selectConfirmRequestByTrget.do";
		}
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/selectConfirmRequestByTrget.do")
	public String selectConfirmRequestByTrget(@ModelAttribute("searchVO") ConfirmHistoryVO historyVO, SessionStatus status,
		...
		return "oklms/la/egovframework/com/cop/com/EgovConfirmList";
	}
