...
public class EgovCmyClubManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/insertClubInfByTrget.do")
	public String insertClubInfByTrget(@ModelAttribute("searchVO") ClubVO clubVO, @ModelAttribute("club") Club club,
		...
		return "forward:/la/cop/clb/selectCmmntyClubList.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/selectCmmntyClubList.do")
	public String selectCmmntyClubList(@ModelAttribute("searchVO") ClubVO clubVO, @RequestParam Map<String, Object> commandMap,
		...
		return "oklms/la/egovframework/com/cop/clb/EgovClubListByTrget";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/clb/updateCmmntyClbInf.do")
	public String updateCmmntyClbInf(@ModelAttribute("searchVO") ClubVO clubVO, @ModelAttribute("club") Club club,
			BindingResult bindingResult, SessionStatus status, ModelMap model) throws Exception {
