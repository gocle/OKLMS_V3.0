 ...
 *  2016.8.30	AA			프로젝트에 맞게 호출 URL 및 tiles 적용 ( 커뮤니티 , 동호회 별 게시판 사용 여부 등록에 관련된 클레스 )
 * </pre>
 */
...
public class EgovBBSUseInfoManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/deleteBBSUseInf.do")
	public String deleteBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO,
		...
		return "forward:/la/cop/com/selectBBSUseInfs.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/addBBSUseInf.do")
	public String addBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/com/EgovBoardUseInfRegist";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/insertBBSUseInf.do")
	...
	@RequestMapping("/la/cop/com/selectBBSUseInfs.do")
	public String selectBBSUseInfs(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/com/EgovBoardUseInfList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/updateBBSUseInf.do")
	public String updateBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO,
			@ModelAttribute("boardUseInf") BoardUseInf boardUseInf, SessionStatus status, ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/com/selectBBSUseInf.do")
	public String selectBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model, HttpServletRequest request)
			throws Exception {
		...
		return "oklms/la/egovframework/com/cop/com/EgovBoardUseInfInqire";
	}
}
