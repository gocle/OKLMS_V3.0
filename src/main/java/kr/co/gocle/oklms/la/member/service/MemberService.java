 ...
 *
 *******************************************************************************/ 
package kr.co.gocle.oklms.la.member.service;
...
public interface MemberService {
	 ...
	 * String
	 */
	String insertCompMember(MemberVO memberVO,MultipartHttpServletRequest multiRequest) throws Exception;
	 ...
	 * String
	 */
	String insertExcelCompMember(ExcelMemberVO excelMemberVO, MultipartHttpServletRequest multiRequest) throws Exception;
	 ...
	 * String
	 */
	int updateCompMember(MemberVO memberVO, MultipartHttpServletRequest multiRequest) throws Exception;
	 ...
	 * int
	 */
	int saveStdMember(MemberVO memberVO) throws Exception;
