package kr.co.gocle.oklms.la.egovframework.com.uss.ion.pwm.web;
...
public class EgovPopupManageController {
	...
	@RequestMapping(value = "/la/uss/ion/pwm/listPopup.do")
	public String egovPopupManageList(@RequestParam Map<?, ?> commandMap, PopupManageVO popupManageVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/uss/ion/pwm/EgovPopupList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/ion/pwm/detailPopup.do")
	public String egovPopupManageDetail(PopupManageVO popupManageVO, @RequestParam Map<?, ?> commandMap, ModelMap model) throws Exception {
		...
		String sLocationUrl = "oklms/la/egovframework/com/uss/ion/pwm/EgovPopupDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String) commandMap.get("cmd");

		if (sCmd.equals("del")) {
			egovPopupManageService.deletePopup(popupManageVO);
			sLocationUrl = "forward:/la/uss/ion/pwm/listPopup.do";
		} else {
			//상세정보 불러오기
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/ion/pwm/updtPopup.do")
...
//		}
		...
		String sLocationUrl = "oklms/la/egovframework/com/uss/ion/pwm/EgovPopupUpdt";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/ion/pwm/registPopup.do")
...
//		}
		...
		String sLocationUrl = "oklms/la/egovframework/com/uss/ion/pwm/EgovPopupRegist";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/ion/pwm/ajaxPopupManageInfo.do")
...
//	/**
//	 * 팝업창을 오픈 한다. : kr.co.gocle.oklms.commbiz.popup.web.CommbizPopupController.egovPopupManagePopupOpen 에서 처리하도록 변경 (/commbiz/uss/ion/pwm/openPopupManage.do )
//	 * @param commandMap
//	 * @param popupManageVO
//	 * @return
//	 * @throws Exception
...
//	}
	...
	/**
	 * 팝업창관리 메인 테스트 목록을 조회한다.  : kr.co.gocle.oklms.commbiz.popup.web.CommbizPopupController.egovPopupManagePopupOpen 에서 처리하도록 변경 (/commbiz/uss/ion/pwm/openPopupManage.do )
	 * @param popupManageVO
	 * @param model
	 * @return "egovframework/com/uss/ion/pwm/listMainPopup"
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/ion/pwm/listMainPopup.do")
	public String egovPopupManageMainList(PopupManageVO popupManageVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/uss/ion/pwm/EgovPopupMainList";
	}
