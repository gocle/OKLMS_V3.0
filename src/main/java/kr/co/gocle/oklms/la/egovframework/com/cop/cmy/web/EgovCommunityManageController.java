package kr.co.gocle.oklms.la.egovframework.com.cop.cmy.web;
...
public class EgovCommunityManageController {
	...
	@RequestMapping("/la/cop/cmy/selectCmmntyInfs.do")
	public String selectCmmntyInfs(@ModelAttribute("searchVO") CommunityVO cmmntyVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/cmy/EgovCmmntyList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/insertCmmntyInf.do")
	public String insertCmmntyInf(@ModelAttribute("searchVO") CommunityVO cmmntyVO,
			@ModelAttribute("community") Community community, BindingResult bindingResult, SessionStatus status, ModelMap model)
			throws Exception {
		...
		return "forward:/la/cop/cmy/selectCmmntyInfs.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/selectCmmntyInf.do")
	public String selectCmmntyInf(@ModelAttribute("searchVO") CommunityVO cmmntyVO, ModelMap model, HttpServletRequest request)
			throws Exception {
		...
		return "oklms/la/egovframework/com/cop/cmy/EgovCmmntyInqire";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/forUpdateCmmntyInf.do")
	public String forUpdateCmmntyInf(@ModelAttribute("searchVO") CommunityVO cmmntyVO,
		...
		return "oklms/la/egovframework/com/cop/cmy/EgovCmmntyUpdt";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/updtCmmntyInf.do")
	public String updtCmmntyInf(@ModelAttribute("searchVO") CommunityVO cmmntyVO,
			@ModelAttribute("community") Community community, BindingResult bindingResult, SessionStatus status, ModelMap model)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cus/CmmntyListPortlet.do")
	public String selectCmmntyListPortlet(@ModelAttribute("searchVO") CommunityVO cmmntyVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/cmy/EgovCmmntyListPortlet";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/CmmntyMainPage.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/CmmntyMainContents.do")
	public String selectCmmntyMainContents(@ModelAttribute("searchVO") CommunityVO cmmntyVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/tpl/EgovCmmntyBaseTmplContents";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/insertCmmntyUserBySelf.do")
	public String insertCmmntyUserBySelf(@ModelAttribute("cmmntyUser") CommunityUser cmmntyUser, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/cmy/EgovCmmntyMsg";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/selectCmmntyInfsByPop.do")
	public String selectCmmntyInfsByPop(@ModelAttribute("searchVO") CommunityVO cmmntyVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/cmy/EgovCmmntyListPop";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/deleteCmmntyUserBySelf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/previewCmmntyMainPage.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/cmy/previewCmmntyMainContents.do")
