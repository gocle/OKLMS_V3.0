package kr.co.gocle.oklms.la.egovframework.com.cop.tpl.web;
...
public class EgovTemplateManageController {
	...
	@RequestMapping("/la/cop/tpl/selectTemplateInfs.do")
	public String selectTemplateInfs(@ModelAttribute("searchVO") TemplateInfVO tmplatInfVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/tpl/EgovTemplateList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/tpl/selectTemplateInf.do")
	public String selectTemplateInf(@ModelAttribute("searchVO") TemplateInfVO tmplatInfVO, ModelMap model) throws Exception {
		...
		return "oklms/la/egovframework/com/cop/tpl/EgovTemplateUpdt";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/tpl/insertTemplateInf.do")
	public String insertTemplateInf(@ModelAttribute("searchVO") TemplateInfVO searchVO,
		...
		if (bindingResult.hasErrors()) {
			...
			return "oklms/la/egovframework/com/cop/tpl/EgovTemplateRegist";
		}
		...
		return "forward:/la/cop/tpl/selectTemplateInfs.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/tpl/addTemplateInf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/tpl/updateTemplateInf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/bbs/deleteTemplateInf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/la/cop/tpl/selectTemplateInfsPop.do")
	public String selectTemplateInfsPop(@ModelAttribute("searchVO") TemplateInfVO tmplatInfVO,
		...
		return "oklms_popup/la/egovframework/com/cop/tpl/EgovTemplateInqirePopup";
	}
}
