package kr.co.gocle.oklms.la.egovframework.com.uss.olp.qri.web;
...
public class EgovQustnrRespondInfoController {
	 ...
	 * @param commandMap
	 * @param model
	 * @return "oklms/la/egovframework/com/uss/olp/template/template"
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/olp/qri/egovQustnrRespondInfoManageTemplate.do")
    ...
    throws Exception {
		 ...
		 String sTemplateUrl = "oklms/la/egovframework/com/uss/olp/qri/template/template";

		 LOGGER.debug("sTemplateUrl=>"+sTemplateUrl);
		 //LOGGER.debug("sTemplateUrl=> {}", commandMap.get("sTemplateUrl"));
	 ...
	 * @param commandMap
	 * @param model
	 * @return "oklms/la/egovframework/com/uss/olp/qnn/EgovQustnrRespondInfoManageStatistics"
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/olp/qnn/EgovQustnrRespondInfoManageStatistics.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "oklms/la/egovframework/com/uss/olp/qnn/EgovQustnrRespondInfoManageStatistics";
	 ...
	 * @param commandMap
	 * @param model
	 * @return "oklms/la/egovframework/com/uss/olp/qnn/EgovQustnrRespondInfoManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="설문조사", order = 600 ,gid = 50)
	@RequestMapping(value = "/la/uss/olp/qnn/listEgovQustnrRespondInfoManage.do")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "oklms/la/egovframework/com/uss/olp/qnn/EgovQustnrRespondInfoManageRegist"
	 * @throws Exception
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@RequestMapping(value = "/la/uss/olp/qnn/goInsertEgovQustnrRespondInfoManage.do")
    ...
    throws Exception {
    	...
    	if(!isAuthenticated) {
        	...
        	return "redirect:/la/uss/olp/qnn/listEgovQustnrRespondInfoManage.do";
    	}
		...
		String sLocationUrl = "oklms/la/egovframework/com/uss/olp/qnn/EgovQustnrRespondInfoManageRegist";
        ...
        if(sCmd.equals("save")){
        	...
        	sLocationUrl = "redirect:/la/uss/olp/qnn/listEgovQustnrRespondInfoManage.do";
        }else{
	 ...
	 * @param model
	 * @return "oklms/la/egovframework/com/uss/olp/qri/EgovQustnrRespondInfoList"
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/olp/qri/listEgovQustnrRespondInfo.do")
    ...
    throws Exception {
    	...
    	if(!isAuthenticated) {
    		model.addAttribute("message", egovMessageSource.getMessage("fail.common.login"));
        	return "redirect:/la/uss/olp/qri/listEgovQustnrRespondInfo.do";
    	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/olp/qri/getEgovQustnrRespondInfo.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "oklms/la/egovframework/com/uss/olp/qri/EgovQustnrRespondInfoDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if(sCmd.equals("del")){
			egovQustnrRespondInfoService.deleteQustnrRespondInfo(qustnrRespondInfoVO);
			sLocationUrl = "redirect:/la/uss/olp/qri/listEgovQustnrRespondInfo.do";
		}else{
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "oklms/la/egovframework/com/uss/olp/qri/EgovQustnrRespondInfoModify"
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/olp/qri/goUpdateEgovQustnrRespondInfo.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "oklms/la/egovframework/com/uss/olp/qri/EgovQustnrRespondInfoModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "oklms/la/egovframework/com/uss/olp/qri/EgovQustnrRespondInfoRegist"
	 * @throws Exception
	 */
	@RequestMapping(value = "/la/uss/olp/qri/goInsertEgovQustnrRespondInfo.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "oklms/la/egovframework/com/uss/olp/qri/EgovQustnrRespondInfoRegist";
