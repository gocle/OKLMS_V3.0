...
public class SendMail {
    ...
    String textEnc;
    String contEnc;
    private String user = EgovProperties.getProperty("mail.admin.id") ;
    private String password = EgovProperties.getProperty("mail.admin.pass");
    ...
    public SendMail(String smtpHost) throws Exception {
        ...
        sess = Session.getDefaultInstance(props, authenticator);
        sess.setDebug(debug);
    }
