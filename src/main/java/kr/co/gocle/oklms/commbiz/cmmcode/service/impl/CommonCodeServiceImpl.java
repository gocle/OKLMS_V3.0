...
public class CommonCodeServiceImpl extends EgovAbstractServiceImpl implements CommonCodeService {
    ...
    // LMS 관리자 > 강의코드 조회
 	...
 	// LMS 관리자 > 회원유형코드 조회
  	...
  	// LMS 관리자 > 학과 조회
   	@Override
   	public List<CommonCodeVO> selectDeptCodeList(CommonCodeVO commonCodeVO) throws Exception {
   		List<CommonCodeVO> resultList = commonCodeMapper.selectDeptCodeList(commonCodeVO);
   		return resultList;
   	}
	...
	@Override
	public int selectYearTermCnt(CommonCodeVO commonCodeVO) throws Exception {
		int result = commonCodeMapper.selectYearTermCnt(commonCodeVO);
		return result;
	}
	
	@Override
	public ArrayList<Map<String, Object>> getCotListName(
			Map<String, Object> commandMap) throws Exception {
		// TODO Auto-generated method stub
		return commonCodeMapper.getCotListName(commandMap);
	}

	@Override
	public ArrayList<Map<String, Object>> getCcmListName(
			Map<String, Object> commandMap) throws Exception {
		// TODO Auto-generated method stub
		return commonCodeMapper.getCcmListName(commandMap);
	}
}
