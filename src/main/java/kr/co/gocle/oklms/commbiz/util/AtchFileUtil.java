...
public class AtchFileUtil extends EgovFileMngUtil {
	...
	public static boolean checkIsFileName(String fileName) throws Exception {
		...
		if (fileName != null && !fileName.equals("")) {
			...
			if (temp.endsWith(".DOC") || temp.endsWith(".DOCX") || temp.endsWith(".GIF") || temp.endsWith(".HWP") || temp.endsWith(".JPEG") || temp.endsWith(".JPG") || temp.endsWith(".PNG")
					|| temp.endsWith(".PDF") || temp.endsWith(".PPT") || temp.endsWith(".PPTX") || temp.endsWith(".TXT") || temp.endsWith(".XLS") || temp.endsWith(".ZIP") || temp.endsWith(".XLSX")
					|| temp.endsWith(".MP3") || temp.endsWith(".MP4") || temp.endsWith(".M4A") || temp.endsWith(".WAV") || temp.endsWith(".WMA") || temp.endsWith(".FLAC") || temp.endsWith(".OGG")
					|| temp.endsWith(".AAC") || temp.endsWith(".EGG")  || temp.endsWith(".RTF"))  
			{
	...
	private AtchFileVO getUploadFileInfo(MultipartFile file, int fileKey, String keyStr , String storePathString, String atchFileIdString) throws IllegalStateException, IOException, Exception {
	    ...
	    LOG.debug("#### this.checkIsFileName(orginFileName) : " + this.checkIsFileName(orginFileName) );
