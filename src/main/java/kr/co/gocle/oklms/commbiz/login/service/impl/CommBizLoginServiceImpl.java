...
public class CommBizLoginServiceImpl extends EgovAbstractServiceImpl implements CommBizLoginService {
	...
	@Override
	public List<LoginVO> listAdminLoginVO(LoginVO loginVO) throws Exception {
		// TODO Auto-generated method stub
		// egovLogger.debug("        // 항목조회
		List<LoginVO> data = commBizLoginMapper.listAdminLoginVO(loginVO);
		return data;
	}
	...
	@Override
	public void updateLoginVOLoginLimit(LoginVO loginVO) throws Exception {
		// TODO Auto-generated method stub
		commBizLoginMapper.updateLoginVOLoginLimit(loginVO);
	}
