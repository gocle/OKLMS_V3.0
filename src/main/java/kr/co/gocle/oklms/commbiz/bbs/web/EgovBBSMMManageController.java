package kr.co.gocle.oklms.commbiz.bbs.web;
...
@Controller
public class EgovBBSMMManageController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/popupSelectBoardList.do")
	public String popupSelectBoardList(@RequestParam Map<String, Object> commandMap,@PathVariable("pathBbsId") String pathBbsId ,
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
		...
		if (master.getBbsTyCode().equals("BBST04")) {
			return "forward:/mm/cop/bbs/" + pathBbsId + "/selectGuestList.do";
		}
		// //-----------------------------
 
		boardVO.setPageUnit(boardVO.getRecordCountPerPage());
		boardVO.setPageSize(boardVO.getRecordCountPerPage());

		String selectRecordIndex = ""+boardVO.getRecordCountPerPage();
		...
		return "oklms/mm/egovframework/com/cop/bbs/SearchEgovNoticeListPopup"; 
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/popupSelectBoardArticle.do")
	public String popupSelectBoardArticle(@RequestParam Map<String, Object> commandMap, @PathVariable("pathBbsId") String pathBbsId ,
		...
		return "oklms/mm/egovframework/com/cop/bbs/EgovNoticeInqirePopup";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/popupSelectBoardArticleMain.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/selectBoardList.do")
//	@RequestMapping("/mm/cop/bbs/selectBoardList.do")
	public String selectBoardArticles(@RequestParam Map<String, Object> paramMap,@PathVariable("pathBbsId") String pathBbsId ,@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, RedirectAttributes redirectAttributes,HttpServletRequest request) throws Exception {

		/*====================================================================
    	* 초기화 영역
    	==============================================================r======*/
		String subjectDivCd = ""; 			//과목구분코드(01:ojt, 02:offjt)
		String yyyy	= ""; 					//학년도
	    String term	= ""; 					//학기
    	...
    	* 초기값 셋팅 영역
    	====================================================================*/
		if("BBSMSTR_000000000005".equals(pathBbsId) ||"BBSMSTR_000000000006".equals(pathBbsId) ||"BBSMSTR_000000000007".equals(pathBbsId)){
			lectureMenuMarkYn = "N";
		}else{
			lectureMenuMarkYn = "Y";
		}
		...
		if("Y".equals(lectureMenuMarkYn)){
			...
			yyyy = boardVO.getYyyy();
			term = boardVO.getTerm();
			subjectCode = boardVO.getSubjectCode();
			subjectName = boardVO.getSubjectName();
			classs = boardVO.getSubClass();
			weekCnt = boardVO.getWeekCnt();
    	...
    	* 업무화면에서 사용하는 List Vo 셋팅 영역
    	====================================================================*/
		logger.debug("################################# ");
		logger.debug("#### subjectDivCd : " + subjectDivCd );
		...
		selectRecordIndex = (String) paramMap.get("recordCountPerPage");
	...
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/selectBoardArticle.do") 
	public String selectBoardArticle(@RequestParam Map<String, Object> paramMap,  @PathVariable("pathBbsId") String pathBbsId ,
			@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/addBoardArticle.do")
	public String addBoardArticle(@RequestParam Map<String, Object> paramMap, @PathVariable("pathBbsId") String pathBbsId ,  @ModelAttribute("searchVO") BoardVO boardVO,
		...
		if("N".equals(lectureMenuMarkYn)){
			retrunUrl = "oklms/mm/egovframework/com/cop/bbs/EgovAllSubjectNoticeRegist";
		}else{
			retrunUrl = "oklms/mm/egovframework/com/cop/bbs/EgovSubjectNoticeRegist";
		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/insertBoardArticle.do")
	public String insertBoardArticle(@RequestParam Map<String, Object> paramMap,@PathVariable("pathBbsId") String pathBbsId ,
		...
		if (bindingResult.hasErrors()) {
			...
			return "oklms/mm/egovframework/com/cop/bbs/EgovNoticeRegist";
		}
...
//				<div id="__KO_DIC_LAYER__"
				if( -1 < (board.getNttCn()).indexOf( "_DIC_LAYER_") ){
					...
					if("N".equals(lectureMenuMarkYn)){
						...
						if("01".equals(categoryCd)){
							//OFF-JT 맞고 있는 개설강좌에 커뮤니티 데이타 생성
		...
		// status.setComplete();
		return "forward:/mm/cop/bbs/" + pathBbsId + "/selectBoardList.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/addReplyBoardArticle.do")
	public String addReplyBoardArticle(@RequestParam Map<String, Object> paramMap, @PathVariable("pathBbsId") String pathBbsId ,
			@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		String retrunUrl = "oklms/mm/egovframework/com/cop/bbs/EgovNoticeReply";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/addBoardArticleReply.do")
//	@RequestMapping("/mm/cop/bbs/addReplyBoardArticle.do")
	public String addBoardArticleReply(@RequestParam Map<String, Object> paramMap, @PathVariable("pathBbsId") String pathBbsId ,
			@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if("N".equals(lectureMenuMarkYn)){
			retrunUrl = "oklms/mm/egovframework/com/cop/bbs/EgovAllSubjectReply";
		}else{
			retrunUrl = "oklms/mm/egovframework/com/cop/bbs/EgovSubjectReply";
		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/replyBoardArticle.do")
	public String replyBoardArticle( @PathVariable("pathBbsId") String pathBbsId ,
			final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
			@ModelAttribute("bdMstr") BoardMaster bdMstr, @ModelAttribute("board") Board board, BindingResult bindingResult,
		...
		if (bindingResult.hasErrors()) {
			...
			return "oklms/mm/egovframework/com/cop/bbs/EgovNoticeReply";
		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/insertBoardArticleReply.do")
	public String insertBoardArticleReply(@RequestParam Map<String, Object> paramMap, @PathVariable("pathBbsId") String pathBbsId ,
			final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
			@ModelAttribute("bdMstr") BoardMaster bdMstr, @ModelAttribute("board") Board board, BindingResult bindingResult,
			ModelMap model, SessionStatus status) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/forUpdateBoardArticle.do")
	public String selectBoardArticleForUpdt(@RequestParam Map<String, Object> paramMap,@PathVariable("pathBbsId") String pathBbsId ,
    	...
    	* 초기화 영역
		...
		if("N".equals(lectureMenuMarkYn)){
			retrunUrl = "oklms/mm/egovframework/com/cop/bbs/EgovAllSubjectNoticeUpdt";
		} else {
			retrunUrl = "oklms/mm/egovframework/com/cop/bbs/EgovSubjectNoticeUpdt";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/updateBoardArticle.do")
	public String updateBoardArticle(@RequestParam Map<String, Object> paramMap, @PathVariable("pathBbsId") String pathBbsId ,
			final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
			@ModelAttribute("bdMstr") BoardMaster bdMstr, @ModelAttribute("board") Board board, BindingResult bindingResult,
			ModelMap model, SessionStatus status) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			return "oklms/mm/egovframework/com/cop/bbs/EgovNoticeUpdt";
		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/deleteBoardArticle.do")
	public String deleteBoardArticle(@PathVariable("pathBbsId") String pathBbsId ,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/selectGuestList.do")
	public String selectGuestList(@PathVariable("pathBbsId") String pathBbsId ,  @ModelAttribute("searchVO") BoardVO boardVO,
			ModelMap model) throws Exception {
		...
		return "oklms/mm/egovframework/com/cop/bbs/EgovGuestList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/selectSingleGuestList.do")
	public String selectSingleGuestList(  @PathVariable("pathBbsId") String pathBbsId ,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/deleteGuestList.do")
	public String deleteGuestList(  @PathVariable("pathBbsId") String pathBbsId ,  @ModelAttribute("searchVO") BoardVO boardVO,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/updateGuestList.do")
	public String updateGuestList(  @PathVariable("pathBbsId") String pathBbsId ,  @ModelAttribute("searchVO") BoardVO boardVO,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/insertGuestList.do")
	public String insertGuestList( @PathVariable("pathBbsId") String pathBbsId ,  @ModelAttribute("searchVO") BoardVO boardVO,
			@ModelAttribute("board") Board board, BindingResult bindingResult, ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/anonymous/{pathBbsId}/selectBoardList.do")
	public String selectAnonymousBoardArticles( @PathVariable("pathBbsId") String pathBbsId ,
			@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "oklms/mm/egovframework/com/cop/bbs/EgovNoticeList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/anonymous/{pathBbsId}/addBoardArticle.do")
	public String addAnonymousBoardArticle( @PathVariable("pathBbsId") String pathBbsId ,
			@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if (!bdMstr.getBbsTyCode().equals("BBST02")) {
			return "forward:/mm/cop/bbs/" + pathBbsId + "/addBoardArticle.do";
		}
		// //-----------------------------
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/anonymous/{pathBbsId}/insertBoardArticle.do")
//	@RequestMapping("/mm/cop/bbs/anonymous/insertBoardArticle.do")
	public String insertAnonymousBoardArticle( @PathVariable("pathBbsId") String pathBbsId ,
			final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
			@ModelAttribute("bdMstr") BoardMaster bdMstr, @ModelAttribute("board") Board board, BindingResult bindingResult,
			SessionStatus status, ModelMap model) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			// -------------------------------
			if (!bdMstr.getBbsTyCode().equals("BBST02")) {
				return "forward:/mm/cop/bbs/" + pathBbsId + "/insertBoardArticle.do";
			}
			// //-----------------------------
		...
		// status.setComplete();
		return "forward:/mm/cop/bbs/anonymous/" + pathBbsId + "/selectBoardList.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/anonymous/{pathBbsId}/selectBoardArticle.do")
//	@RequestMapping("/mm/cop/bbs/anonymous/selectBoardArticle.do")
	public String selectAnonymousBoardArticle( @PathVariable("pathBbsId") String pathBbsId ,
			@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if (!masterVo.getBbsTyCode().equals("BBST02")) {
			return "forward:/mm/cop/bbs/" + pathBbsId + "/selectBoardArticle.do";
		}
		// //-----------------------------
		...
		return "oklms/mm/egovframework/com/cop/bbs/EgovNoticeInqire";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/anonymous/{pathBbsId}/deleteBoardArticle.do")
	public String deleteAnonymousBoardArticle( @PathVariable("pathBbsId") String pathBbsId ,
			@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
			@ModelAttribute("bdMstr") BoardMaster bdMstr, ModelMap model) throws Exception {
		...
		// -------------------------------
		if (!masterVo.getBbsTyCode().equals("BBST02")) {
			return "forward:/mm/cop/bbs/" + pathBbsId + "/deleteBoardArticle.do";
		}
		// //-----------------------------
		...
		if (!dbpassword.equals(enpassword)) {
			...
			return "forward:/mm/cop/bbs/anonymous/" + pathBbsId + "/selectBoardArticle.do";
		}
		// //-----------------------------
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/anonymous/{pathBbsId}/forUpdateBoardArticle.do")
	public String selectAnonymousBoardArticleForUpdt( @PathVariable("pathBbsId") String pathBbsId ,
			@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, ModelMap model) throws Exception {
		...
		if (isAuthenticated) {
			...
			if (!bmvo.getBbsTyCode().equals("BBST02")) {
				return "forward:/mm/cop/bbs/" + pathBbsId + "/forUpdateBoardArticle.do";
			}
			// //-----------------------------
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/anonymous/{pathBbsId}/updateBoardArticle.do")
	public String updateAnonymousBoardArticle( @PathVariable("pathBbsId") String pathBbsId ,
			final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
			@ModelAttribute("bdMstr") BoardMaster bdMstr, @ModelAttribute("board") Board board, BindingResult bindingResult,
			ModelMap model, SessionStatus status) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			// -------------------------------
			if (!bdMstr.getBbsTyCode().equals("BBST02")) {
				return "forward:/mm/cop/bbs/" + pathBbsId + "/updateBoardArticle.do";
			}
			// //-----------------------------
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/anonymous/{pathBbsId}/addReplyBoardArticle.do")
	public String addAnonymousReplyBoardArticle( @PathVariable("pathBbsId") String pathBbsId ,
			@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		// -------------------------------
		if (!master.getBbsTyCode().equals("BBST02")) {
			return "forward:/mm/cop/bbs/" + pathBbsId + "/addReplyBoardArticle.do";
		}
		// //-----------------------------
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/anonymous/{pathBbsId}/replyBoardArticle.do")
	public String replyAnonymousBoardArticle( @PathVariable("pathBbsId") String pathBbsId ,
			final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
			@ModelAttribute("bdMstr") BoardMaster bdMstr, @ModelAttribute("board") Board board, BindingResult bindingResult,
			ModelMap model, SessionStatus status) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			// -------------------------------
			if (!master.getBbsTyCode().equals("BBST02")) {
				return "forward:/mm/cop/bbs/" + pathBbsId + "/replyBoardArticle.do";
			}
			// //-----------------------------
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/mm/cop/bbs/{pathBbsId}/previewBoardList.do")
	public String previewBoardArticles( @PathVariable("pathBbsId") String pathBbsId ,
			@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "oklms_body/mm/egovframework/com/cop/bbs/EgovNoticeList";
	}
}
