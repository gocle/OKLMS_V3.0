 ...
 *
 *******************************************************************************/
package kr.co.gocle.oklms.commbiz.popup.web;
...
import kr.co.gocle.oklms.lu.activitydesc.service.ActivityNoteDescService;
...
import kr.co.gocle.oklms.lu.qestnr.service.QestnrService;
import kr.co.gocle.oklms.lu.qestnr.vo.QestnrVO;
...
//
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/popup/goPopupSearchCcnCompany.do")
	public String goPopupSearchCompany(@ModelAttribute("frmCompany") CompanyVO companyVO, ModelMap model) throws Exception {
        ...
        List<CompanyVO> resultList = companyService.listCcnMappingCompany(companyVO);
		...
		// View호출
		return "oklms_popup/lu/popup/searchCcnCompany";
	}
...
/*		if("".equals(currProcVO.getSearchYyyyCd()) || currProcVO.getSearchYyyyCd() == null){
	...
	@RequestMapping(value = "/lu/popup/deleteCotMapping.json")
	public @ResponseBody Map<String, Object> popupOnlineTraningFileDelete(@ModelAttribute("frmMember") CurrProcVO currProcVO 
		...
		logger.debug("#### URL = /lu/popup/deleteCotMapping.json" );
		
		LoginInfo loginInfo = new LoginInfo();
		loginInfo.getLoginInfo();
		loginInfo.putSessionToVo(currProcVO); // session의 정보를 VO에 추가.
		
		int iResult = currProcService.deleteCotMapping(currProcVO);
	...
	/**
	 * 설문응답 학습자별 기타의견보기엑셀다운로드
	 * @param memId
	 * @param memName
	 * @return
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/qestnr/popupQestnrEtcAnswerCnExcelDownload.do")
	public String popupQestnrEtcAnswerCnExcelDownload(@RequestParam Map<String, Object> commandMap, @ModelAttribute("frmQestnr") QestnrVO qestnrVO, ModelMap model , HttpServletRequest request) throws Exception {
	    ...
	    request.setAttribute("ExcelName", URLEncoder.encode( "설문응답의견".replaceAll(" ", "_") ,"UTF-8") );
		// View호출
        return "oklms_excel/lu/popup/qestnrEtcAnswerCnExcel";
	}
	/**
	 * 설문응답 학습자별 결과보기 프린트
	 * @param memId
	 ...
	 * @throws Exception
	 */  
	@RequestMapping(value = "/lu/traning/popupNotSubjectWeekList.do")
	public String popupNotSubjectWeekList(@ModelAttribute("frmTraning") CurrProcVO currProcVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		// View호출
        return "oklms_popup/lu/popup/notSubjectWeekListPopup";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/popup/goPopupSearchTraning.do")
	public String goPopupSearchTraning(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmProcess") TraningProcessVO traningProcessVO, ModelMap model) throws Exception {

		List <TraningProcessVO> resultList = traningProcessService.listSearchTraningProcess(traningProcessVO);
		...
		// View호출
		return "oklms_popup/lu/popup/searchTraining";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/lu/popup/goPopupSearchCompany.do")
	public String goPopupSearchCompany(@RequestParam Map<String, Object> paramMap, @ModelAttribute("frmCompany") CompanyVO companyVO, ModelMap model) throws Exception {

		LoginInfo loginInfo = new LoginInfo();
		loginInfo.putSessionToVo(companyVO);
		
		List<CompanyVO> resultList = new ArrayList<CompanyVO>();
		resultList = companyService.listCompanySearch1(companyVO);
		Integer pageSize = companyVO.getPageSize();
		Integer page = companyVO.getPageIndex();
		...
		// View호출
		return "oklms_popup/lu/popup/searchCompany";
	}
