package kr.co.gocle.oklms.commbiz.cmt.web;
...
public class EgovBBSCommentController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/cmt/selectCommentList.do")
	public String selectCommentList(@RequestParam Map<String, Object> paramMap, @PathVariable("serviceArea") String serviceArea,
		...
		if (!commentVO.getCommentNo().equals("")) {
			return "forward:/" + serviceArea + "/cop/cmt/selectSingleComment.do";
		}
		...
		if (commentVO.getType().equals("head")) {
			return "oklms/" + serviceArea + "/egovframework/com/cop/cmt/EgovCommentList";
		}
		// //----------------------------------------
		...
		if("la".equals(serviceArea)){
			returnUrl = "/egovframework/com/cop/cmt/EgovCommentList";
		}else{
			/*if("N".equals(lectureMenuMarkYn)){
				returnUrl = "/egovframework/com/cop/cmt/EgovAllSubjectCommentList";
			}else{
				returnUrl = "/egovframework/com/cop/cmt/EgovSubjectCommentList";
			}*/
		...
		return "oklms_import/" + serviceArea + returnUrl;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/cmt/anonymous/selectCommentList.do")
	public String selectAnonymousCommentList(@PathVariable("serviceArea") String serviceArea,
			@ModelAttribute("searchVO") CommentVO commentVO, ModelMap model) throws Exception {
		...
		// 수정을 위한 처리
		if (!commentVO.getCommentNo().equals("")) {
			return "forward:/" + serviceArea + "/cop/cmt/anonymous/selectSingleComment.do";
		}
		...
		return "oklms_import/" + serviceArea + "/egovframework/com/cop/cmt/EgovCommentList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/cmt/insertComment.do")
	public String insertComment(@PathVariable("serviceArea") String serviceArea, @ModelAttribute("searchVO") CommentVO commentVO,
...
//		return "forward:/" + serviceArea + "/cop/bbs/selectBoardArticle.do";
			return "forward:/" + serviceArea + "/cop/bbs/" + bbsId + "/selectBoardArticle.do";
		}
...
//		return "forward:/" + serviceArea + "/cop/bbs/selectBoardArticle.do";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/bbs/{pathBbsId}/insertBoardComment.do")
	public String insertBoardComment(@RequestParam Map<String, Object> paramMap, @PathVariable("serviceArea") String serviceArea, @ModelAttribute("searchVO") CommentVO commentVO,
...
//		return "forward:/" + serviceArea + "/cop/bbs/selectBoardArticle.do";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/cmt/anonymous/insertComment.do")
	public String insertAnonymousComment(@PathVariable("serviceArea") String serviceArea,
		...
		if (bindingResult.hasErrors()) {
			...
			return "forward:/" + serviceArea + "/cop/bbs/anonymous/selectBoardArticle.do";
		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/cmt/deleteComment.do")
	public String deleteComment(@PathVariable("serviceArea") String serviceArea, @ModelAttribute("searchVO") CommentVO commentVO,
...
//		return "forward:/" + serviceArea + "/cop/bbs/selectBoardArticle.do";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/bbs/{pathBbsId}/deleteBoardComment.do")
	public String deleteBoardComment(@PathVariable("serviceArea") String serviceArea, @ModelAttribute("searchVO") CommentVO commentVO,
			@ModelAttribute("comment") Comment comment, ModelMap model) throws Exception {
		@SuppressWarnings("unused")
		LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
...
//		return "forward:/" + serviceArea + "/cop/bbs/selectBoardArticle.do";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/cmt/anonymous/deleteComment.do")
	public String deleteAnonymousComment(@PathVariable("serviceArea") String serviceArea,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/cmt/selectSingleComment.do")
	public String selectSingleComment(@RequestParam Map<String, Object> paramMap, @PathVariable("serviceArea") String serviceArea,
			@ModelAttribute("searchVO") CommentVO commentVO, ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/cmt/anonymous/selectSingleComment.do")
	public String selectAnonymousSingleComment(@PathVariable("serviceArea") String serviceArea,
			@ModelAttribute("searchVO") CommentVO commentVO, ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/cmt/updateComment.do")
	public String updateCommentList(@PathVariable("serviceArea") String serviceArea,
			@ModelAttribute("searchVO") CommentVO commentVO, @ModelAttribute("comment") Comment comment,
			BindingResult bindingResult, ModelMap model) throws Exception {
...
//		return "forward:/" + serviceArea + "/cop/bbs/selectBoardArticle.do";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/bbs/{pathBbsId}/updateBoardComment.do")
	public String updateBoardCommentList(@RequestParam Map<String, Object> paramMap, @PathVariable("serviceArea") String serviceArea,
			@ModelAttribute("searchVO") CommentVO commentVO, @ModelAttribute("comment") Comment comment,
...
//		return "forward:/" + serviceArea + "/cop/bbs/selectBoardArticle.do";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/{serviceArea}/cop/cmt/anonymous/updateComment.do")
	public String updateAnonymousCommentList(@PathVariable("serviceArea") String serviceArea,
			@ModelAttribute("searchVO") CommentVO commentVO, @ModelAttribute("comment") Comment comment,
			BindingResult bindingResult, ModelMap model) throws Exception {
