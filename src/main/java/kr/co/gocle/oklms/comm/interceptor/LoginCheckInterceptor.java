...
//		}
		...
		if(!requestUrlType.equals("mm")){
			...
			if(ssoYn.equals("Y")){
				...
				String sesssionCheckYn = (String) ssoSession.getAttribute("SSO_SESSION_CHECK_YN");
				...
				/*if(!"".equals(memId)){ // 인증정보가 있으며 로그아웃 상태
					if(null == sesssionSsoLoginYn && sesssionCheckYn == null ){
						// 등록 된 사용자일 경우
						ssoSession.setAttribute("SSO_SESSION_CHECK_YN", "Y");
