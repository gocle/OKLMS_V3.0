package kr.co.gocle.oklms.comm.view;
...
public abstract class ExcelAbstractView extends AbstractView {
	...
	protected final void renderMergedOutputModel(
		...
		workbook = buildExcelDocument(model, workbook, request, response);
	 ...
	 * @return 
	 */
	protected abstract HSSFWorkbook buildExcelDocument(
