package kr.co.gocle.oklms.comm.vo;
...
public class BaseVO implements Serializable {
	...
	private String baseSearchCompanyIds;
	private String baseCheckCompanyIds;
	...
	//protected String configgoclelearnTemp = 	Config.gocleLEARN_TEMP; // "gocleLEARNTEMP"	// 수강신청관련 변수
...
/*	public String getConfigDefaultAspId() {
	...
	/*public String getConfiggoclelearnTemp() {
		return configgoclelearnTemp;
	}

	public void setConfiggoclelearnTemp(String configgoclelearnTemp) {
		this.configgoclelearnTemp = configgoclelearnTemp;
	}*/
	...
	public String getBaseSearchCompanyIds() {
		return baseSearchCompanyIds;
	}

	public void setBaseSearchCompanyIds(String baseSearchCompanyIds) {
		this.baseSearchCompanyIds = baseSearchCompanyIds;
	}
	
	public String getBaseCheckCompanyIds() {
		return baseCheckCompanyIds;
	}

	public void setBaseCheckCompanyIds(String baseCheckCompanyIds) {
		this.baseCheckCompanyIds = baseCheckCompanyIds;
	}
