...
public interface IfxService {
	...
	/**
	 * DB에서 교수의 담당 OJT 과정 갯수를 조회하는 로직을 수행한다.
	 * @param aunuriMemberVO
	 * @return
	 * Integer
	 */
	int getOjtAunuriSubjectInsOjtCnt(AunuriMemberVO aunuriMemberVO) throws Exception;

	List<AunuriSubjectVO> getOjtAunuriSubjectApproValInsMappingList(
			AunuriMemberVO aunuriMemberVO) throws Exception;
