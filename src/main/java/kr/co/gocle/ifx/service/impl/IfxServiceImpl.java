...
import kr.co.gocle.oklms.commbiz.cmmcode.service.impl.CommonCodeMapper;
...
public class IfxServiceImpl extends EgovAbstractServiceImpl implements IfxService{
	...
	@Override
	public List<AunuriSubjectVO> getOjtAunuriSubjectApproValInsMappingList(AunuriMemberVO aunuriMemberVO) throws Exception {
		List<AunuriSubjectVO> resultList = ifxMapper.getOjtAunuriSubjectApproValInsMappingList(aunuriMemberVO);
		return resultList;
	}
	
	@Override
	public List<AunuriSubjectVO> getOjtAunuriSubjectInsClassMappingList(AunuriMemberVO aunuriMemberVO) throws Exception {
		List<AunuriSubjectVO> resultList = ifxMapper.getOjtAunuriSubjectInsClassMappingList(aunuriMemberVO);
		return resultList;
	}
	...
	/**
	 * DB에서 교수의 OJT 과정 갯수를 조회하는 로직을 수행한다.
	 * @param aunuriMemberVO
	 * @return
	 * Integer
	 */
	@Override
	public int getOjtAunuriSubjectInsOjtCnt(AunuriMemberVO aunuriMemberVO) throws Exception {
		int iResult = ifxMapper.getOjtAunuriSubjectInsOjtCnt(aunuriMemberVO);
		return iResult;
	}
